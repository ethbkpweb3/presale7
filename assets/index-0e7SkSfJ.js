  ...
  j = {
    ...
    transaction: V({
      format(t) {
        ...
        return (
          t.type === "0x7e" &&
            ((a.isSystemTx = t.isSystemTx),
            (a.mint = t.mint ? i(t.mint) : void 0),
            (a.sourceHash = t.sourceHash),
            (a.type = "deposit")),
          a
        );
      },
    }),
    transactionReceipt: ee({
      format(t) {
        return {
...
function Ue(t) {
  const { from: a, to: s } = t;
  if (a && !k(a)) throw new E({ address: a });
  if (s && !k(s)) throw new E({ address: s });
}
const l = { contracts: Ee, formatters: j, serializers: we },
  T = 1,
  tt = e({
    ...l,
    id: 888888888,
  ...
  lt = e({
    ...
    rpcUrls: { default: { http: ["https://goerli-rollup.arbitrum.io/rpc"] } },
    blockExplorers: {
  ...
  ct = e({
    ...
    rpcUrls: { default: { http: ["https://astar.api.onfinality.io/public"] } },
    blockExplorers: {
  ...
  it = e({
    ...
    network: "AstarZkEVM",
    nativeCurrency: { name: "Ether", symbol: "ETH", decimals: 18 },
    rpcUrls: { default: { http: ["https://rpc.startale.com/astar-zkevm"] } },
    blockExplorers: {
      default: {
  ...
  kt = e({
    ...
    rpcUrls: { default: { http: ["https://auroria.rpc.stratisevm.com"] } },
    blockExplorers: {
      default: {
  ...
  Ct = e({
    ...
    contracts: {
      ...l.contracts,
      l2OutputOracle: {
        [S]: { address: "0x2A35891ff30313CcFa6CE88dcf3858bb075A2298" },
      },
      multicall3: {
        address: "0xca11bde05977b3631167028862be2a173976ca11",
      ...
      portal: {
        [S]: { address: "0xe93c8cD0D409341205A592f8c4Ac1A5fe5585cfA" },
      },
      l1StandardBridge: {
        [S]: { address: "0xfA6D8Ee5BE770F84FC001D098C4bD604Fe01284a" },
      },
    },
    testnet: !0,
    sourceId: S,
  ...
  wt = e({
    ...
    contracts: {
      ...l.contracts,
      l2OutputOracle: {
        [A]: { address: "0x84457ca9D0163FbC4bbfe4Dfbb20ba46e48DF254" },
      },
      portal: {
        [A]: {
  ...
  Ut = e({
    ...
    rpcUrls: { default: { http: ["https://brnkc-mainnet.bearnetwork.net"] } },
    blockExplorers: {
      default: {
        name: "BrnkScan",
  ...
  gt = e({
    ...
    rpcUrls: { default: { http: ["https://brnkc-test.bearnetwork.net"] } },
    blockExplorers: {
      default: {
        name: "BrnkTestScan",
  ...
  Dt = e({
    ...
    blockExplorers: {
      default: { name: "Blockscout", url: "https://explorer.gobob.xyz" },
    },
    contracts: {
      multicall3: {
  ...
  Lt = e({
    ...
    nativeCurrency: { decimals: 18, name: "BNB", symbol: "BNB" },
    rpcUrls: { default: { http: ["https://greenfield-chain.bnbchain.org"] } },
    blockExplorers: {
      default: {
  ...
  Kt = e({
    ...
    rpcUrls: { default: { http: ["https://mainnet.blackfort.network/rpc"] } },
    blockExplorers: {
      default: {
        name: "Blockscout",
  ...
  Gt = e({
    ...
    rpcUrls: { default: { http: ["https://testnet.blackfort.network/rpc"] } },
    blockExplorers: {
      default: {
        name: "Blockscout",
  ...
  Ae = {
    estimateFeesPerGas: async (t) => {
      var r;
      if (!((r = t.request) != null && r.feeCurrency)) return null;
      const [a, s] = await Promise.all([
        Be(t.client, t.request.feeCurrency),
        Fe(t.client, t.request.feeCurrency),
      ]);
      return { maxFeePerGas: a, maxPriorityFeePerGas: s };
    },
  };
async function Be(t, a) {
  const s = await t.request({ method: "eth_gasPrice", params: [a] });
  return BigInt(s);
}
...
function re(t) {
  return (
    ...
    t === "" ||
    (typeof t == "string" &&
      (W(t).toLowerCase() === "0x" || W(t).toLowerCase() === "0x00"))
  );
}
function w(t) {
  return !re(t);
...
const ze = {
  block: G({
    ...
    format(t) {
      ...
      return { randomness: t.randomness, transactions: a };
    },
  }),
  transaction: V({
    format(t) {
      ...
      return (
        t.type === "0x7b"
          ? (a.type = "cip64")
          : (t.type === "0x7c" && (a.type = "cip42"),
            (a.gatewayFee = t.gatewayFee ? i(t.gatewayFee) : null),
            (a.gatewayFeeRecipient = t.gatewayFeeRecipient)),
        a
      );
    },
  }),
  transactionRequest: te({
    format(t) {
      const a = { feeCurrency: t.feeCurrency };
...
function Pe(t) {
  ...
  if (a <= 0) throw new ae({ chainId: a });
  if (c && !k(c)) throw new E({ address: c });
  if (r) throw new u("`gasPrice` is not a valid CIP-64 Transaction attribute.");
  if (w(n) && n > He) throw new ue({ maxFeePerGas: n });
  if (w(s) && w(n) && s > n)
...
const ne = { formatters: ze, serializers: Ie, fees: Ae },
  Xt = e({
    ...ne,
    id: 42220,
    name: "Celo",
  ...
  aa = e({
    ...
    name: "Cyber Testnet",
    nativeCurrency: { name: "Ether", symbol: "ETH", decimals: 18 },
    rpcUrls: { default: { http: ["https://cyber-testnet.alt.technology"] } },
    blockExplorers: {
      default: {
        name: "Blockscout",
  ...
  sa = e({
    ...
    nativeCurrency: { name: "DeFiChain", symbol: "DFI", decimals: 8 },
    rpcUrls: {
  ...
  ua = e({
    ...
    rpcUrls: { default: { http: ["https://edgeware-evm.jelliedowl.net"] } },
    blockExplorers: {
      default: {
  ...
  ba = e({
    ...
    rpcUrls: { default: { http: ["https://beresheet-evm.jelliedowl.net"] } },
    blockExplorers: {
      default: {
        name: "Edgscan by Bharathcoorg",
  ...
  xa = e({
    ...
    nativeCurrency: { decimals: 18, name: "EOS", symbol: "EOS" },
    rpcUrls: { default: { http: ["https://api.testnet.evm.eosnetwork.com"] } },
    blockExplorers: {
      default: {
  ...
  Ta = e({
    ...
    nativeCurrency: { decimals: 18, name: "Fantom", symbol: "FTM" },
    rpcUrls: { default: { http: ["https://rpcapi.sonic.fantom.network"] } },
    blockExplorers: {
      default: {
  ...
  za = e({
    ...
    rpcUrls: { default: { http: ["https://previewnet.evm.nodes.onflow.org"] } },
    blockExplorers: {
      default: {
  ...
  Da = e({
    ...
    blockExplorers: {
      default: { name: "Mainnet Explorer", url: "https://flowdiver.io" },
    },
  }),
  Ia = e({
    id: 545,
  ...
  Pa = e({
    ...
    contracts: {
      ...l.contracts,
      l2OutputOracle: {
        [F]: { address: "0x715EA64DA13F4d0831ece4Ad3E8c1aa013167F32" },
      },
      multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
      portal: {
        [F]: {
  ...
  Za = e({
    ...
    name: "Goerli",
    nativeCurrency: { name: "Goerli Ether", symbol: "ETH", decimals: 18 },
    rpcUrls: { default: { http: ["https://rpc.ankr.com/eth_goerli"] } },
    blockExplorers: {
      default: {
        name: "Etherscan",
  ...
  Qa = e({
    ...
    rpcUrls: { default: { http: ["https://rpc.ankr.com/harmony"] } },
    blockExplorers: {
      default: {
  ...
  Ja = e({
    ...
    rpcUrls: { default: { http: ["https://rpc.eth.testedge2.haqq.network"] } },
    blockExplorers: {
      default: {
        name: "HAQQ Explorer",
  ...
  or = e({
    ...
    blockExplorers: {
      default: { name: "Kakarot Scan", url: "https://sepolia.kakarotscan.org" },
    },
    testnet: !0,
  }),
  cr = e({
  ...
  pr = e({
    ...
    rpcUrls: {
      default: { http: ["https://kcc-rpc.com"] },
      public: { http: ["https://kcc-rpc.com"] },
    },
    blockExplorers: {
  ...
  mr = e({
    ...
    rpcUrls: { default: { http: ["https://public-en-baobab.klaytn.net"] } },
    blockExplorers: {
          ...
          (s = t.transactions) == null
            ...
            : s.map((r) => {
                ...
                return (
                  n.typeHex === "0x71"
                    ? (n.type = "eip712")
                    : n.typeHex === "0xff" && (n.type = "priority"),
                  n
                );
              });
        return {
      ...
      format(t) {
        return t.gasPerPubdata ||
          ...
          ? {
              eip712Meta: {
                ...(t.gasPerPubdata
                  ? { gasPerPubdata: o(t.gasPerPubdata) }
                  : { gasPerPubdata: o($) }),
                ...(t.paymaster && t.paymasterInput
                  ? {
                      paymasterParams: {
...
function oe(t) {
  return !!(
    ...
    ("gasPerPubdata" in t && typeof t.gasPerPubdata == "bigint") ||
    ("factoryDeps" in t && t.factoryDeps)
  );
}
function ce(t) {
  const { chainId: a, to: s, from: r, paymaster: n, paymasterInput: c } = t;
  if (!oe(t)) throw new Le();
  if (!a || a <= 0) throw new ae({ chainId: a });
  if (s && !k(s)) throw new E({ address: s });
  if (r && !k(r)) throw new E({ address: r });
  if (n && !k(n)) throw new E({ address: n });
  if (n && !c)
    throw new u(
...
class Ge extends u {
  constructor({ givenLength: a, maxBytecodeSize: s }) {
    super(`Bytecode cannot be longer than ${s} bytes. Given length: ${a}`),
      Object.defineProperty(this, "name", {
        enumerable: !0,
        configurable: !0,
        writable: !0,
...
class Ve extends u {
  constructor({ givenLengthInWords: a }) {
    super(
      `Bytecode length in 32-byte words must be odd. Given length in words: ${a}`
    ),
      Object.defineProperty(this, "name", {
        enumerable: !0,
        configurable: !0,
...
class Xe extends u {
  constructor({ givenLength: a }) {
    super(
      `The bytecode length in bytes must be divisible by 32. Given length: ${a}`
    ),
      Object.defineProperty(this, "name", {
        enumerable: !0,
        configurable: !0,
...
function qe(t) {
  const a = K(t);
  if (a.length % 32 !== 0) throw new Xe({ givenLength: a.length });
  if (a.length > Q) throw new Ge({ givenLength: a.length, maxBytecodeSize: Q });
  const s = xe(a),
    r = K(s),
    n = a.length / 32;
  if (n % 2 === 0) throw new Ve({ givenLengthInWords: n });
  const c = K(n),
    p = ye(c, { size: 2 }),
...
const x = { formatters: le, serializers: Re, custom: { getEip712Domain: Ze } },
  vr = e({
    ...x,
    id: 1135,
    name: "Lisk",
    ...
    contracts: {
      multicall3: { address: "0xA9d71E1dd7ca26F26e656E66d6AA81ed7f745bf0" },
    },
  }),
  M = 11155111,
  Tr = e({
    ...
    contracts: {
      ...l.contracts,
      l2OutputOracle: {
        [M]: { address: "0xA0E35F56C318DE1bD5D9ca6A94Fe7e37C5663348" },
      },
      multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
      portal: {
        [M]: { address: "0xe3d90F21490686Ec7eF37BE788E02dfC12787264" },
      },
      l1StandardBridge: {
        [M]: { address: "0x1Fb30e446eA791cd1f011675E5F3f5311b70faF5" },
      },
    },
    testnet: !0,
    sourceId: M,
  ...
  Sr = e({
    id: 4201,
    name: "LUKSO Testnet",
    nativeCurrency: { decimals: 18, name: "LUKSO Testnet", symbol: "LYXt" },
    rpcUrls: {
      default: {
  ...
  Pr = e({
    ...
    blockExplorers: {
      default: { name: "MetaExplorer", url: "https://explorer.metatime.com" },
    },
    contracts: {
      multicall3: {
  ...
  Or = e({
    ...
    nativeCurrency: { name: "Metatime Coin", symbol: "MTC", decimals: 18 },
    rpcUrls: { default: { http: ["https://istanbul-rpc.metachain.dev"] } },
    blockExplorers: {
      default: {
        name: "MetaExplorer",
  ...
  Lr = e({
    ...
    contracts: {
      ...
      portal: {
        [z]: { address: "0x3F37aBdE2C6b5B2ed6F8045787Df1ED1E3753956" },
      },
      l1StandardBridge: {
        [z]: { address: "0x6d0f65D59b55B0FEC5d2d15365154DcADC140BF3" },
      },
    },
    sourceId: z,
  }),
  ...
  Gr = e({
    ...
    rpcUrls: { default: { http: ["https://goerli.gateway.metisdevops.link"] } },
    blockExplorers: {
      default: {
  ...
  es = e({
    ...
    rpcUrls: { default: { http: ["https://api.nautilus.nautchain.xyz"] } },
    blockExplorers: {
  ...
  cs = e({
    ...
    contracts: {
      ...l.contracts,
      l2OutputOracle: {
        [D]: { address: "0xdfe97868233d1aa22e815a266982f2cf17685a27" },
      },
      multicall3: {
        address: "0xca11bde05977b3631167028862be2a173976ca11",
      ...
      portal: {
        [D]: { address: "0xbEb5Fc579115071764c7423A4f12eDde41f106Ed" },
      },
      l1StandardBridge: {
        [D]: { address: "0x99C9fc46f92E8a1c0deC1b1747d010903E884bE1" },
      },
    },
    sourceId: D,
  }),
  ...
  is = e({
    ...
    contracts: {
      ...l.contracts,
      l2OutputOracle: {
        [I]: { address: "0xE6Dfba0953616Bacab0c9A8ecb3a9BBa77FC15c0" },
      },
      multicall3: {
        address: "0xca11bde05977b3631167028862be2a173976ca11",
        blockCreated: 49461,
      ...
      portal: {
        [I]: { address: "0x5b47E1A08Ea6d985D6649300584e6722Ec4B1383" },
      },
      l1StandardBridge: {
        [I]: { address: "0x636Af16bf2f682dD3109e60102b8E1A089FedAa8" },
      },
    },
    testnet: !0,
    sourceId: I,
  ...
  ps = e({
    ...
    contracts: {
      ...l.contracts,
      disputeGameFactory: {
        [C]: { address: "0x05F9613aDB30026FFd634f38e5C4dFd30a197Fa1" },
      },
      l2OutputOracle: {
        [C]: { address: "0x90E9c4f8a994a250F6aEfd61CAFb4F2e895D458F" },
      },
      multicall3: {
        address: "0xca11bde05977b3631167028862be2a173976ca11",
        blockCreated: 1620204,
      ...
      portal: {
        [C]: { address: "0x16Fc5058F25648194471939df75CF27A2fdC48BC" },
      },
      l1StandardBridge: {
        [C]: { address: "0xFBb0621E0B23b5478B630BD55a5f21f67730B0F1" },
      },
    },
    testnet: !0,
    sourceId: C,
  ...
  bs = e({
    ...
    contracts: {
      batchInvoker: { address: "0x5FbDB2315678afecb367f032d93F642f64180aa3" },
    },
  }),
  hs = e({
    id: 11297108109,
  ...
  fs = e({
    ...
    contracts: {
      l2OutputOracle: {
        [_]: { address: "0x9E6204F750cD866b299594e2aC9eA824E2e5f95c" },
      },
      multicall3: {
        address: "0xcA11bde05977b3631167028862bE2a173976CA11",
      ...
      portal: {
        [_]: { address: "0xb26Fd985c5959bBB382BAFdD0b879E149e48116c" },
      },
      l1StandardBridge: {
  ...
  ys = e({
    ...
    name: "PGN ",
    nativeCurrency: { name: "Ether", symbol: "ETH", decimals: 18 },
    rpcUrls: { default: { http: ["https://sepolia.publicgoods.network"] } },
    blockExplorers: {
      default: {
    ...
    contracts: {
      l2OutputOracle: {
        [H]: { address: "0xD5bAc3152ffC25318F848B3DD5dA6C85171BaEEe" },
      },
      portal: {
        [H]: { address: "0xF04BdD5353Bb0EFF6CA60CfcC78594278eBfE179" },
      },
      l1StandardBridge: {
        [H]: { address: "0xFaE6abCAF30D23e233AC7faF747F2fC3a5a6Bfa3" },
      },
      multicall3: {
        address: "0xcA11bde05977b3631167028862bE2a173976CA11",
  ...
  Cs = e({
    ...
    rpcUrls: { default: { http: ["https://rpcurl.mainnet.plgchain.com"] } },
    blockExplorers: {
  ...
  Ls = e({
    ...
    contracts: {
      ...l.contracts,
      l2OutputOracle: {
        [P]: { address: "0xE6f24d2C32B3109B18ed33cF08eFb490b1e09C10" },
      },
      multicall3: {
        address: "0xca11bde05977b3631167028862be2a173976ca11",
        blockCreated: 14193,
      ...
      l1StandardBridge: {
        [P]: { address: "0x4cbab69108Aa72151EDa5A3c164eA86845f18438" },
      },
    },
    sourceId: P,
  }),
  ...
  Ns = e({
    ...
    contracts: {
      ...l.contracts,
      l2OutputOracle: {
        [O]: { address: "0xDb5c46C3Eaa6Ed6aE8b2379785DF7dd029C0dC81" },
      },
      multicall3: {
        address: "0xca11bde05977b3631167028862be2a173976ca11",
        blockCreated: 55697,
      ...
      l1StandardBridge: {
        [O]: { address: "0xdDD29bb63B0839FB1cE0eE439Ff027738595D07B" },
      },
    },
    testnet: !0,
    sourceId: O,
  ...
  $s = e({
    ...
    rpcUrls: { default: { http: ["https://json-rpc.evm.shimmer.network"] } },
    blockExplorers: {
      default: {
  ...
  vn = e({
    ...
    rpcUrls: {
      ...
      public: { http: ["https://rpc.katla.taiko.xyz"] },
    },
    blockExplorers: {
      default: { name: "blockscout", url: "https://explorer.katla.taiko.xyz" },
    },
  }),
  Tn = e({
    id: 167005,
  ...
  gn = e({
    ...
    blockExplorers: { default: { name: "telscan", url: "https://telscan.io" } },
    testnet: !0,
  }),
  Sn = e({
    id: 40,
  ...
  An = e({
    ...
    name: "Telos",
    nativeCurrency: { decimals: 18, name: "Telos", symbol: "TLOS" },
    rpcUrls: { default: { http: ["https://testnet.telos.net/evm"] } },
    blockExplorers: {
      default: {
  ...
  Fn = e({
    ...
    rpcUrls: { default: { http: ["hhttps://rpc.thaichain.org"] } },
    blockExplorers: {
      default: {
        name: "Blockscout",
  ...
  In = e({
    ...
    rpcUrls: { default: { http: ["https://gwan-ssl.wandevs.org:46891"] } },
    blockExplorers: {
  ...
  Pn = e({
    ...
    rpcUrls: { default: { http: ["https://x1testrpc.okx.com"] } },
    blockExplorers: {
  ...
  Kn = e({
    ...
    nativeCurrency: { name: "OAS", symbol: "OAS", decimals: 18 },
    rpcUrls: { default: { http: ["https://rpc.testnet.yooldo-verse.xyz"] } },
    blockExplorers: {
      default: {
  ...
  Xn = e({
    ...
    rpcUrls: { default: { http: ["https://rpc.zhejiang.ethpandaops.io"] } },
    blockExplorers: {
  ...
  el = e({
    ...
    blockExplorers: {
      default: { name: "zkExplorer", url: "https://goerli.explorer.zksync.io" },
    },
    contracts: {
      multicall3: { address: "0xF9cda624FBC7e059355ce98a31693d299FACd963" },
    },
  ...
  tl = e({
    ...
    contracts: {
      ...l.contracts,
      l2OutputOracle: {
        [L]: { address: "0x9E6204F750cD866b299594e2aC9eA824E2e5f95c" },
      },
      multicall3: {
        address: "0xcA11bde05977b3631167028862bE2a173976CA11",
        blockCreated: 5882,
      ...
      portal: {
        [L]: { address: "0x1a0ad011913A150f69f6A19DF447A0CfD9551054" },
      },
      l1StandardBridge: {
        [L]: { address: "0x3e2Ea9B92B7E48A52296fD261dc26fd995284631" },
      },
    },
    sourceId: L,
  }),
  ...
  al = e({
    ...
    contracts: {
      ...l.contracts,
      l2OutputOracle: {
        [N]: { address: "0x2615B481Bd3E5A1C0C7Ca3Da1bdc663E8615Ade9" },
      },
      multicall3: {
        address: "0xcA11bde05977b3631167028862bE2a173976CA11",
        blockCreated: 83160,
      ...
      portal: {
        [N]: { address: "0xeffE2C6cA9Ab797D418f0D91eA60807713f3536f" },
      },
      l1StandardBridge: {
        [N]: { address: "0x5376f1D543dcbB5BD416c56C189e4cB7399fCcCB" },
      },
    },
    sourceId: N,
    testnet: !0,
  ...
  rl = e({
    ...
    contracts: {
      ...
      portal: {
        [Y]: { address: "0xDb9F51790365e7dc196e7D072728df39Be958ACe" },
      },
    },
    sourceId: Y,
    testnet: !0,
