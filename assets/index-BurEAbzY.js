const __vite__mapDeps = (i, m=__vite__mapDeps, d=(m.f || (m.f = ["assets/index-_e8zziK-.js", "assets/index-CpP-AC1q.js", "assets/index-CFpBmM1l.css"]))) => i.map(i => d[i]);
import {ap as pe, aq as me} from "./index-CpP-AC1q.js";
const he = Symbol()
  , ee = Object.getPrototypeOf
  , Y = new WeakMap
  , ge = e => e && (Y.has(e) ? Y.get(e) : ee(e) === Object.prototype || ee(e) === Array.prototype)
  , ye = e => ge(e) && e[he] || null
  , te = (e, t=!0) => {
    Y.set(e, t)
}
  ...
  , F = e => typeof e == "object" && e !== null
  , C = new WeakMap
  , x = new WeakSet
  , ve = (e=Object.is, t= (o, g) => new Proxy(o,g), s=o => F(o) && !x.has(o) && (Array.isArray(o) || !(Symbol.iterator in o)) && !(o instanceof WeakMap) && !(o instanceof WeakSet) && !(o instanceof Error) && !(o instanceof Number) && !(o instanceof Date) && !(o instanceof String) && !(o instanceof RegExp) && !(o instanceof ArrayBuffer), n=o => {
    switch (o.status) {
    case "fulfilled":
        return o.value;
    case "rejected":
...
, l=new WeakMap, c= (o, g, I=n) => {
    ...
    Reflect.ownKeys(o).forEach(j => {
        if (Object.getOwnPropertyDescriptor(w, j))
            return;
        ...
        Object.defineProperty(w, j, A)
    }
    ),
    Object.preventExtensions(w)
}
, d=new WeakMap, f=[1, 1], W=o => {
    if (!F(o))
      ...
      , R = t(H, {
        ...
        set(i, a, r, h) {
            ...
            if (r instanceof Promise)
                ...
                !C.has(r) && s(r) && (V = W(r));
                const L = !x.has(V) && C.get(V);
                L && q(a, L)
            }
            return Reflect.set(i, a, V, h),
            w(["set", [a], r, k]),
            !0
        }
    });
...
const u = P({
  ...
  , de = {
    ...
    replace(e) {
        u.history.length > 1 && (u.history[u.history.length - 1] = e,
        u.view = e)
    },
    goBack() {
  ...
  , m = {
    ...
    formatUniversalUrl(e, t, s) {
        ...
        if (n.startsWith("https://t.me")) {
            ...
            this.setWalletConnectDeepLink(n, s);
            const d = new URL(n);
            return d.searchParams.set("startapp", c),
            d.toString()
        }
        n.endsWith("/") || (n = `${n}/`),
        this.setWalletConnectDeepLink(n, s);
  ...
  , _e = {
    state: p,
    subscribe(e) {
        return D(p.events, () => e(be(p.events[p.events.length - 1])))
    },
    initialize() {
...
async function K(e, t) {
    const s = Le({
      ...
      , n = new URL(e,G);
    return n.searchParams.append("projectId", $.state.projectId),
...
const ae = m.isMobile()
  ...
  , Re = {
    ...
    async getRecomendedWallets() {
        ...
        if (m.isArray(e)) {
            const n = {
              ...
              , {listings: l} = await M.getAllListings(n)
              , c = Object.values(l);
            c.sort( (d, f) => {
            ...
            const {chains: s, isAuth: n} = b.state
    ...
    async getWallets(e) {
        const t = Me({}, e)
          , {explorerRecommendedWalletIds: s, explorerExcludedWalletIds: n} = $.state
          , {recomendedWallets: l} = E;
        if (n === "ALL")
            return E.wallets;
        l.length ? t.excludedIds = l.map(I => I.id).join(",") : m.isArray(s) && (t.excludedIds = s.join(",")),
        m.isArray(n) && (t.excludedIds = [t.excludedIds, n].filter(Boolean).join(",")),
        b.state.isAuth && (t.sdks = "auth_v1");
        const {page: c, search: d} = e
          , {listings: f, total: W} = ae ? await M.getMobileListings(t) : await M.getDesktopListings(t)
          , o = Object.values(f)
          , g = d ? "search" : "wallets";
        return E[g] = {
    ...
    async open(e) {
        return new Promise(t => {
            ...
            s && n)
                ...
                const l = setInterval( () => {
                    const c = b.state;
                    c.isUiLoaded && c.isDataLoaded && (clearInterval(l),
                    T.open = !0,
                    t())
                }
                , 200)
...
class $e {
    ...
    async initUi() {
        if (typeof window < "u") {
            await me( () => import("./index-_e8zziK-.js"), __vite__mapDeps([0, 1, 2]));
...
export {m as C, Re as E, J as M, b as O, de as R, ce as T, Ve as a, _e as b, $ as c, xe as i};
