 ...
 */ const oe = window,
  ur =
    oe.ShadowRoot &&
    (oe.ShadyCSS === void 0 || oe.ShadyCSS.nativeShadow) &&
...
let wt = class extends HTMLElement {
  ...
  requestUpdate(t, r, n) {
    let o = !0;
    t !== void 0 &&
      (((n = n || this.constructor.getPropertyOptions(t)).hasChanged || Jr)(
        this[t],
        r
      )
...
(wt[He] = !0),
  ...
  ((_e = ne.reactiveElementVersions) !== null && _e !== void 0
    ? _e
...
const ie = window,
  $t = ie.trustedTypes,
  Ir = $t ? $t.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
  ze = "$lit$",
  ...
  to = Array.isArray,
  Fo = (e) =>
    to(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function",
  Ae = `[ 	
\f\r]`,
...
const Vo = (e, t) => {
  ...
  for (let l = 0; l < r; l++) {
    ...
    let c,
      ...
      b = -1,
      h = 0;
    for (; h < a.length && ((s.lastIndex = h), (d = s.exec(a)), d !== null); )
      (h = s.lastIndex),
        s === Dt
          ? d[1] === "!--"
            ? (s = Tr)
            ...
            ? (s = Mr)
            : d[2] !== void 0
            ? (eo.test(d[2]) && (o = RegExp("</" + d[2], "g")), (s = at))
            : d[3] !== void 0 && (s = at)
          : s === at
          ? d[0] === ">"
            ? ((s = o ?? Dt), (b = -1))
            : d[1] === void 0
            ? (b = -2)
            : ((b = s.lastIndex - d[2].length),
              (c = d[1]),
              (s = d[3] === void 0 ? at : d[3] === '"' ? Rr : Sr))
          : s === Rr || s === Sr
          ? (s = at)
          : s === Tr || s === Mr
          ? (s = Dt)
    ...
    i +=
      s === Dt
        ? a + zo
        : b >= 0
        ? (n.push(c), a.slice(0, b) + ze + a.slice(b) + J + p)
        : a + J + (b === -2 ? (n.push(void 0), l) : p);
  }
  ...
  constructor({ strings: t, _$litType$: r }, n) {
    ...
    for (; (o = ct.nextNode()) !== null && a.length < l; ) {
      if (o.nodeType === 1) {
        ...
        if (o.data === Xr) a.push({ type: 2, index: i });
        else {
          let b = -1;
          for (; (b = o.data.indexOf(J, b + 1)) !== -1; )
            a.push({ type: 7, index: i }), (b += J.length - 1);
        }
      i++;
    }
  }
  ...
  return (
    (a == null ? void 0 : a.constructor) !== c &&
      ((i = a == null ? void 0 : a._$AO) === null ||
        i === void 0 ||
        i.call(a, !1),
      c === void 0 ? (a = void 0) : ((a = new c(e)), a._$AT(e, r, n)),
      n !== void 0
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (l === c.index) {
        let d;
        c.type === 2
          ? (d = new qt(s, s.nextSibling, this, t))
          : c.type === 1
          ? (d = new c.ctor(s, c.name, c.strings, this, t))
          : c.type === 6 && (d = new Go(s, this, t)),
          this._$AV.push(d),
          (c = o[++a]);
      }
...
class qt {
    ...
    const { values: n, _$litType$: o } = t,
      i =
        typeof o == "number"
          ? this._$AC(t)
          : (o.el === void 0 &&
              (o.el = jt.createElement(oo(o.h, o.h[0]), this.options)),
            o);
  ...
  _$AC(t) {
    ...
    return r === void 0 && Dr.set(t.strings, (r = new jt(t))), r;
  }
  T(t) {
    ...
    for (const i of t)
      o === r.length
        ? r.push((n = new qt(this.k(Wt()), this.k(Wt()), this, this.options)))
        : (n = r[o]),
        n._$AI(i),
        o++;
...
Lr == null || Lr(jt, qt),
  ((Ee = ie.litHtmlVersions) !== null && Ee !== void 0
    ? Ee
    : (ie.litHtmlVersions = [])
  ).push("2.8.0");
const Jo = (e, t, r) => {
...
(E.finalized = !0),
  ...
  (Oe = globalThis.litElementHydrateSupport) === null ||
    Oe === void 0 ||
    Oe.call(globalThis, { LitElement: E });
const Nr = globalThis.litElementPolyfillSupport;
Nr == null || Nr({ LitElement: E });
((Pe = globalThis.litElementVersions) !== null && Pe !== void 0
  ? Pe
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ var Ie;
((Ie = window.HTMLSlotElement) === null || Ie === void 0
  ? void 0
  : Ie.prototype.assignedElements) != null;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
    ...
    update(e, [t]) {
      ...
      for (const i in t) {
        ...
        s === this.it.has(i) ||
          ...
          (s ? (o.add(i), this.it.add(i)) : (o.remove(i), this.it.delete(i)));
      }
      return mt;
    }
  }
...
function mn(e, t, r, n, o) {
  let i,
    s,
    l = 0;
  do (s = t + (r - t) / 2), (i = co(s, n, o) - e), i > 0 ? (r = s) : (t = s);
    ...
    (this.tick = (h) => {
      ...
      t(v),
        ...
        (this.playState === "finished" || g >= this.totalDuration + s)
          ? ((this.playState = "finished"),
            (p = this.resolve) === null || p === void 0 || p.call(this, v))
          : this.playState !== "idle" &&
...
function uo(e) {
  return (
    Te.has(e) || Te.set(e, { transforms: [], values: new Map() }), Te.get(e)
  );
}
function vn(e, t) {
...
const bn = ["", "X", "Y", "Z"],
  ...
  le = { x: "translateX", y: "translateY", z: "translateZ" },
  Wr = {
    syntax: "<angle>",
    initialValue: "0deg",
...
yn.forEach((e) => {
  bn.forEach((t) => {
    ae.push(e + t), kt.set(pr(e + t), xn[e]);
  });
});
...
const Me = (e, t) => document.createElement("div").animate(e, t),
  jr = {
    ...
    finished: () => !!Me({ opacity: [0, 1] }, { duration: 0.001 }).finished,
    linearEasing: () => {
      try {
  ...
  vt = {};
for (const e in jr)
  vt[e] = () => (Se[e] === void 0 && (Se[e] = jr[e]()), Se[e]);
const Pn = 0.015,
  In = (e, t) => {
    let r = "";
...
function Ze(e) {
  return le[e] && (e = le[e]), mo(e) ? pr(e) : e;
}
const Xt = {
  get: (e, t) => {
    t = Ze(t);
...
function Ln(e, t, r, n = {}, o) {
  ...
  const C = Ze(t),
    ...
    R = kt.get(C);
  return (
    fo(S.animation, !(Fe(h) && S.generator) && n.record !== !1),
    () => {
      const U = () => {
        var D, Y;
        return (Y =
          (D = Xt.get(e, C)) !== null && D !== void 0
            ? D
            : R == null
            ? void 0
            : R.initialValue) !== null && Y !== void 0
          ? Y
          : 0;
      };
      let M = Mn(Sn(r), U);
      ...
      if (
        (Ve(C) && (vt.cssRegisterProperty() ? On(C) : (v = !1)),
        ...
        (l = e.animate(
          ...
          l.finished ||
            (l.finished = new Promise((W, Bo) => {
              (l.onfinish = W), (l.oncancel = Bo);
            }));
        ...
        (M = M.map((D) => (typeof D == "string" ? parseFloat(D) : D))),
          ...
          (l = new o(
            ...
            M,
            Object.assign(Object.assign({}, n), { duration: a, easing: h })
          ));
      else {
      ...
      return (
        s &&
          i(
            ...
            t,
            M,
            { duration: a, delay: c, easing: h, repeat: b, offset: f },
            "motion-one"
          ),
        S.setAnimation(l),
        l && !u && l.pause(),
...
const Wn = (e) => e(),
  po = (e, t, r = V.duration) =>
    new Proxy(
      { animations: e.map(Wn).filter(Boolean), duration: r, options: t },
      jn
    ),
  Un = (e) => e.animations[0],
  jn = {
    get: (e, t) => {
      ...
      switch (t) {
        ...
        case "finished":
          return (
            e.finished ||
              (e.finished = Promise.all(e.animations.map(kn)).catch(so)),
            e.finished
          );
        case "stop":
          return () => {
...
(function (e) {
  ...
  (e.isValid = function (o) {
    ...
    (e.getPenaltyN1 = function (o) {
      ...
      for (let b = 0; b < i; b++) {
        ...
        for (let h = 0; h < i; h++) {
          let p = o.get(b, h);
          p === c ? l++ : (l >= 5 && (s += t.N1 + (l - 5)), (c = p), (l = 1)),
            (p = o.get(h, b)),
            p === d ? a++ : (a >= 5 && (s += t.N1 + (a - 5)), (d = p), (a = 1));
        }
  ...
  (e.applyMask = function (o, i) {
    const s = i.size;
    for (let l = 0; l < s; l++)
      for (let a = 0; a < s; a++) i.isReserved(a, l) || i.xor(a, l, r(o, a, l));
  }),
...
(function (e) {
  ...
  (e.mul = function (n, o) {
    ...
    for (let s = 0; s < n.length; s++)
      for (let l = 0; l < o.length; l++) i[s + l] ^= t.mul(n[s], o[l]);
    return i;
  }),
    (e.mod = function (n, o) {
...
(function (e) {
  const t = F,
    ...
    l = t.getBCHDigit(s);
  function a(h, p, g) {
    for (let f = 1; f <= 40; f++) if (p <= e.getCapacity(f, g, h)) return f;
  }
  function c(h, p) {
  ...
  function b(h, p) {
    for (let g = 1; g <= 40; g++)
      if (d(h, g) <= e.getCapacity(g, p, o.MIXED)) return g;
  }
  (e.from = function (p, g) {
    ...
    (e.getEncodedBits = function (p) {
      ...
      let g = p << 12;
      for (; t.getBCHDigit(g) - l >= 0; ) g ^= s << (t.getBCHDigit(g) - l);
      return (p << 12) | g;
    });
})(_o);
var Eo = {};
...
Eo.getEncodedBits = function (t, r) {
  const n = (t.bit << 3) | r;
  let o = n << 10;
  for (; qe.getBCHDigit(o) - zr >= 0; ) o ^= Ao << (qe.getBCHDigit(o) - zr);
  return ((n << 10) | o) ^ oi;
};
var Oo = {};
const ni = st;
  ...
  ai = function (t) {
    for (var r = [], n = t.length, o = 0; o < n; o++) {
      ...
      if (i >= 55296 && i <= 56319 && n > o + 1) {
        ...
        s >= 56320 &&
          s <= 57343 &&
          ((i = (i - 55296) * 1024 + s - 56320 + 65536), (o += 1));
      }
      if (i < 128) {
        r.push(i);
        continue;
...
(function (e) {
  ...
  function d(u, y, w) {
    ...
    let C;
    for (; (C = u.exec(w)) !== null; )
      v.push({ data: C[0], index: C.index, mode: y, length: C[0].length });
    return v;
  }
  function b(u) {
    ...
    return (
      l.isKanjiModeEnabled()
        ? ((v = d(s.BYTE, t.BYTE, u)), (C = d(s.KANJI, t.KANJI, u)))
        : ((v = d(s.BYTE_KANJI, t.BYTE, u)), (C = [])),
      y
        .concat(w, v, C)
        .sort(function (R, U) {
    ...
    for (let w = 0; w < u.length; w++) {
      ...
      switch (v.mode) {
        case t.NUMERIC:
          ...
          break;
        case t.ALPHANUMERIC:
          y.push([v, { data: v.data, mode: t.BYTE, length: v.length }]);
          break;
        case t.KANJI:
          y.push([v, { data: v.data, mode: t.BYTE, length: c(v.data) }]);
          break;
        case t.BYTE:
          y.push([{ data: v.data, mode: t.BYTE, length: c(v.data) }]);
      }
    }
    return y;
  }
    ...
    for (let S = 0; S < u.length; S++) {
      ...
      for (let M = 0; M < R.length; M++) {
        ...
        for (let Y = 0; Y < C.length; Y++) {
          const W = C[Y];
          w[W] && w[W].node.mode === z.mode
            ? ((v[W][D] =
                h(w[W].lastCount + z.length, z.mode) -
                h(w[W].lastCount, z.mode)),
              (w[W].lastCount += z.length))
            : (w[W] && (w[W].lastCount = z.length),
              (v[W][D] =
                h(z.length, z.mode) + 4 + t.getCharCountIndicator(z.mode, y)));
        }
      }
      C = U;
    }
    for (let S = 0; S < C.length; S++) v[C[S]].end = 0;
  ...
  (e.fromArray = function (y) {
    ...
    (e.fromString = function (y, w) {
      const v = b(y, l.isKanjiModeEnabled()),
        ...
        U = [];
      for (let M = 1; M < R.length - 1; M++) U.push(S.table[R[M]].node);
...
function Pi(e, t, r) {
  ...
  let v = 0,
    ...
    S;
  for (C = 0; C < u; C++)
    for (S = 0; S < s; S++) C < f[S].length && (w[v++] = f[S][C]);
  for (C = 0; C < h; C++) for (S = 0; S < s; S++) w[v++] = A[S][C];
  return w;
}
function Ii(e, t, r, n) {
  let o;
...
go.create = function (t, r) {
  ...
  return (
    typeof r < "u" &&
      ((n = De.from(r.errorCorrectionLevel, De.M)),
      (o = de.from(r.version)),
...
(function (e) {
  ...
  (e.render = function (i, s, l) {
    ...
    return (
      t.qrToImageData(h.data, i, a), r(b, c, d), b.putImageData(h, 0, 0), c
    );
  }),
  ...
  for (let l = 0; l < e.length; l++) {
    ...
    !a && !i && (i = !0),
      e[l]
        ? (s++,
          (l > 0 && a > 0 && e[l - 1]) ||
            ((n += i ? Be("M", a + r, 0.5 + c + r) : Be("m", o, 0)),
            (o = 0),
            (i = !1)),
          (a + 1 < t && e[l + 1]) || ((n += Be("h", s)), (s = 0)))
        : o++;
  }
  return n;
}
...
function yr(e, t, r, n, o) {
  ...
  if (!l && !Si()) throw new Error("Callback required as last argument");
  if (l) {
    ...
    return (
      s === 1
        ? ((r = t), (t = n = void 0))
        : s === 2 && !t.getContext && ((n = r), (r = t), (t = void 0)),
...
var Di = Object.defineProperty,
  ...
  Zr = (e, t, r) =>
    t in e
      ? Di(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
      : (e[t] = r),
  We = (e, t) => {
    for (var r in t || (t = {})) Li.call(t, r) && Zr(e, r, t[r]);
    if (Vr) for (var r of Vr(t)) Ni.call(t, r) && Zr(e, r, t[r]);
    return e;
  };
function Bi() {
  var e;
...
var Ui = Object.defineProperty,
  ...
  Mt = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? ji(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
...
let ot = class extends E {
  ...
  render() {
    ...
    return (
      ...
      m`<button class="${G(e)}" ?disabled="${this.disabled}" @click="${
        this.onClick
      }">${
        this.iconLeft
...
Mt([_({ type: Boolean })], ot.prototype, "disabled", 2);
...
var Hi = Object.defineProperty,
  ...
  xr = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? zi(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let zt = class extends E {
  ...
  render() {
    ...
    return m`<button ?disabled="${this.disabled}" class="${G(
      e
    )}"><slot></slot></button>`;
  }
};
zt.styles = [O.globalCss, ki];
xr([_({ type: Boolean })], zt.prototype, "disabled", 2);
...
var Yi = Object.defineProperty,
  ...
  Gi = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? Qi(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
var Xi = Object.defineProperty,
  ...
  es = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? ts(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
var os = Object.defineProperty,
  ...
  is = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? ns(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
var ls = Object.defineProperty,
  ...
  Qt = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? as(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
Qt([_({ type: Boolean })], ft.prototype, "border", 2);
...
const $ = {
    ...
    handleAndroidLinking() {
      ...
      e &&
        (x.setWalletConnectAndroidDeepLink(e),
...
var ds = Object.defineProperty,
  ...
  $r = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? hs(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let Ft = class extends E {
  ...
  firstUpdated() {
    (this.resizeObserver = new ResizeObserver(([e]) => {
      ...
      this.oldHeight !== "0px" &&
        dt(this.routerEl, { height: [this.oldHeight, t] }, { duration: 0.2 }),
        (this.oldHeight = t);
    })),
...
var ms = Object.defineProperty,
  ...
  Mo = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? fs(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let he = class extends E {
  constructor() {
    super(),
      ...
      (this.unsubscribe = X.subscribe((e) => {
        e.open
          ? ((this.open = !0),
            (this.timeout = setTimeout(() => X.closeToast(), 2200)))
  ...
  render() {
    ...
    return this.open
      ? m`<div class="${G(r)}">${t === "success" ? T.CHECKMARK_ICON : null} ${
          t === "error" ? T.CROSS_ICON : null
    ...
    generate(e, t, r) {
      ...
      a.forEach(({ x: g, y: f }) => {
        ...
        for (let w = 0; w < a.length; w += 1) {
          const v = l * (Q - w * 2);
          i.push(
            L`<rect fill="${w % 2 === 0 ? n : o}" height="${v}" rx="${
              v * y
            }" ry="${v * y}" width="${v}" x="${A + l * w}" y="${u + l * w}">`
          );
        }
      });
      ...
      return (
        ...
        Object.entries(p)
          ...
          .forEach(([g, f]) => {
            f.forEach(([A, u]) => {
              i.push(
                L`<line x1="${g}" x2="${g}" y1="${A}" y2="${u}" stroke="${n}" stroke-width="${
                  l / (Kr / 2)
...
var bs = Object.defineProperty,
  ...
  St = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? ys(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let nt = class extends E {
  ...
  svgTemplate() {
    ...
    return L`<svg height="${t}" width="${t}">${ws.generate(
      this.uri,
      t,
      t / 4
    )}</svg>`;
  ...
  render() {
    const e = { "wcm-dark": xt.state.themeMode === "dark" };
    return m`<div style="${`width: ${this.size}px`}" class="${G(e)}">${
      this.walletId || this.imageUrl
        ? m`<wcm-wallet-image walletId="${j(this.walletId)}" imageId="${j(
            this.imageId
          )}" imageUrl="${j(this.imageUrl)}"></wcm-wallet-image>`
        : T.WALLET_CONNECT_ICON_COLORED
    } ${this.svgTemplate()}</div>`;
  }
};
nt.styles = [O.globalCss, vs];
St([_()], nt.prototype, "uri", 2);
St([_({ type: Number })], nt.prototype, "size", 2);
...
var $s = Object.defineProperty,
  ...
  So = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? _s(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
var Ss = Object.defineProperty,
  ...
  lt = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? Rs(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let q = class extends E {
  ...
  handleClick() {
    Wo.click({ name: "WALLET_BUTTON", walletId: this.walletId }),
      this.onClick();
  }
  render() {
    var e;
    return m`<button @click="${this.handleClick.bind(
      this
    )}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${j(
      this.imageId
    )}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${
      (e = this.label) != null ? e : $.getWalletName(this.name, !0)
...
lt([_({ type: Boolean })], q.prototype, "installed", 2);
lt([_({ type: Boolean })], q.prototype, "recent", 2);
  ...
  render() {
    ...
    const t =
      (e = this.imageUrl) != null && e.length
        ? this.imageUrl
        : $.getWalletIcon({ id: this.walletId, image_id: this.imageId });
    return m`${
      t.length
        ? m`<div><img crossorigin="anonymous" src="${t}" alt="${this.id}"></div>`
        : T.WALLET_PLACEHOLDER
    }`;
  }
};
...
var Bs = Object.defineProperty,
  ...
  Ro = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? Ws(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let rr = class extends E {
  ...
  async loadImages(e) {
    try {
      e != null &&
        e.length &&
        (await Promise.all(e.map(async (t) => $.preloadImage(t))));
    } catch {
...
var Us = Object.defineProperty,
  ...
  ks = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? js(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let or = class extends E {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="Connect your wallet" .onAction="${
      this.onGoToQrcode
    }" .actionIcon="${
      T.QRCODE_ICON
...
var qs = Object.defineProperty,
  ...
  Rt = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? Ks(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let it = class extends E {
  ...
  svgLoaderTemplate() {
    ...
    const i =
      (t =
        (e = xt.state.themeVariables) == null
          ? void 0
          : e["--wcm-wallet-icon-large-border-radius"]) != null
        ? t
        : O.getPreset("--wcm-wallet-icon-large-border-radius");
    let s = 0;
    i.includes("%")
  ...
  render() {
    ...
    return m`<div class="${G(
      e
    )}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${j(
      this.walletId
    )}" imageId="${j(
      this.imageId
...
Rt([_({ type: Boolean })], it.prototype, "isError", 2);
Rt([_({ type: Boolean })], it.prototype, "isStale", 2);
  ...
  rt = {
    ...
    manualWalletsTemplate() {
      return yt
        ...
        .map(
          (t) =>
            m`<wcm-wallet-button walletId="${t.id}" name="${
              t.name
    ...
    recomendedWalletsTemplate(e = !1) {
      return yt
        ...
        .map(
          (r) =>
            m`<wcm-wallet-button name="${r.name}" walletId="${r.id}" imageId="${
              r.image_id
            }" .onClick="${() => this.onConnecting(r)}"></wcm-wallet-button>`
        );
    },
    recentWalletTemplate() {
      const e = yt.recentWallet();
      if (e)
        return m`<wcm-wallet-button name="${e.name}" walletId="${
          e.id
        }" imageId="${j(e.image_id)}" .recent="${!0}" .onClick="${() =>
...
var Qs = Object.defineProperty,
  ...
  Js = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? Gs(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let nr = class extends E {
  render() {
    ...
    l ? (a = s.slice(0, 3)) : (a = s);
    const c = !!a.length;
    return m`<wcm-modal-header .border="${!0}" title="Connect your wallet" .onAction="${
      $.handleUriCopy
    }" .actionIcon="${
      T.COPY_ICON
      ...
      c
        ? m`<wcm-modal-footer><div class="wcm-desktop-title">${
            T.DESKTOP_ICON
          }<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${a} ${
            l
              ? m`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>`
              : null
...
var tl = Object.defineProperty,
  ...
  rl = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? el(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let ir = class extends E {
  render() {
    ...
    return e ?? t
      ? m`<div><wcm-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app's ${
          e
            ? m`<a href="${e}" target="_blank" rel="noopener noreferrer">Terms of Service</a>`
            : null
        } ${e && t ? "and" : null} ${
          t
            ? m`<a href="${t}" target="_blank" rel="noopener noreferrer">Privacy Policy</a>`
            : null
        }</wcm-text></div>`
      : null;
  }
...
var nl = Object.defineProperty,
  ...
  sl = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? il(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let sr = class extends E {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="Connect your wallet" .onAction="${
      this.onQrcode
    }" .actionIcon="${T.QRCODE_ICON}"></wcm-modal-header>${
      c
        ? m`<wcm-modal-content><div>${a} ${
            l
              ? m`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>`
              : null
...
var al = Object.defineProperty,
  ...
  Cr = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? cl(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
    return n && o && al(t, r, o), o;
  };
let Zt = class extends E {
  constructor() {
    super(),
    ...
    this.toggleBodyScroll(!1),
      ...
      setTimeout(async () => {
        const e = $.isMobileAnimation()
          ...
          r = 0.2;
        await Promise.all([
          dt(this.overlayEl, { opacity: [0, 1] }, { delay: t, duration: r })
            .finished,
  ...
  render() {
    ...
    return m`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${G(
      e
    )}" @click="${
      this.onCloseModal
    }" role="alertdialog" aria-modal="true"><div class="wcm-container" tabindex="0">${
      this.open
        ? m`<wcm-modal-backcard></wcm-modal-backcard><div class="wcm-card"><wcm-modal-router></wcm-modal-router><wcm-modal-toast></wcm-modal-toast></div>`
        : null
    }</div></div>`;
  }
};
...
var hl = Object.defineProperty,
  ...
  Gt = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? ul(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let pt = class extends E {
  ...
  render() {
    return m`<div>${this.isRetry ? m`<slot></slot>` : null} ${
      this.isMobile
        ? m`<wcm-button .onClick="${this.onMobile}" .iconLeft="${T.MOBILE_ICON}" variant="outline">Mobile</wcm-button>`
        : null
    } ${
      this.isDesktop
        ? m`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${T.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>`
        : null
    } ${
      this.isWeb
        ? m`<wcm-button .onClick="${this.onWeb}" .iconLeft="${T.GLOBE_ICON}" variant="outline">Web</wcm-button>`
        : null
    }</div>`;
  }
};
pt.styles = [O.globalCss, dl];
Gt([_({ type: Boolean })], pt.prototype, "isMobile", 2);
Gt([_({ type: Boolean })], pt.prototype, "isDesktop", 2);
Gt([_({ type: Boolean })], pt.prototype, "isWeb", 2);
Gt([_({ type: Boolean })], pt.prototype, "isRetry", 2);
...
var fl = Object.defineProperty,
  ...
  gl = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? pl(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
    return n && o && fl(t, r, o), o;
  };
  ...
  render() {
    ...
    return m`<button @click="${this.onClick}"><div class="wcm-icons">${r.map(
      (n) => {
        ...
        if (o) return m`<img crossorigin="anonymous" src="${o}">`;
...
var vl = Object.defineProperty,
  ...
  $e = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? bl(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
let Tt = class extends E {
  ...
  render() {
    return m`<div class="wcm-qr-container">${
      this.uri
        ? m`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${
            this.uri
          }" walletId="${j(this.walletId)}" imageId="${j(
            this.imageId
          )}"></wcm-qrcode>`
        : m`<wcm-spinner></wcm-spinner>`
    }</div>`;
  }
};
...
var yl = Object.defineProperty,
  ...
  $l = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? xl(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
    return n && o && yl(t, r, o), o;
  };
let ar = class extends E {
  viewTemplate() {
    return x.isAndroid() && !x.isTelegram()
...
let me = class extends E {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="${e}" .onAction="${
      $.handleUriCopy
    }" .actionIcon="${
      T.COPY_ICON
    }"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${j(
      r
...
let cr = class extends E {
  ...
  render() {
    const {
      ...
      image_id: r,
      homepage: n,
    } = x.getWalletRouterData();
    return m`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${j(
      r
...
var Ml = Object.defineProperty,
  ...
  Lo = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? Sl(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
    return n && o && Ml(t, r, o), o;
  };
let fe = class extends E {
  ...
  onFormatAndRedirect(e, t = !1) {
    ...
    if (
      ((e = x.isTelegram() && x.isAndroid() ? encodeURIComponent(e) : e),
      o && !t)
    ) {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${j(
      ...
      l
        ? m`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() =>
            this.openMobileApp(!0)}">Try this alternate link</span></wcm-text>`
        : null
    }</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${t}" imageId="${j(
      r
...
var Dl = Object.defineProperty,
  ...
  Nl = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? Ll(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
    return n && o && Dl(t, r, o), o;
  };
let dr = class extends E {
  render() {
    ...
    return m`<wcm-modal-header title="${e}" .onAction="${
      ...
      T.COPY_ICON
    }"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="${t}" imageId="${j(
      r
...
var Bl = Object.defineProperty,
  ...
  Ul = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? Wl(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
var kl = Object.defineProperty,
  ...
  Jt = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? Hl(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
    return n && o && kl(t, r, o), o;
  };
const je = 40;
let gt = class extends E {
  ...
  render() {
    ...
    o &&
      ((i = i.filter(({ values: c }) => $.caseSafeIncludes(c[0], this.search))),
    ...
    return m`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(
      this
    )}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${G(
      a
    )}"><div class="wcm-grid">${n ? null : i} ${n ? null : s} ${
      n
        ? null
        : r.map(
            (c) =>
              m`${
                c
                  ? m`<wcm-wallet-button imageId="${c.image_id}" name="${
                      c.name
      ...
      l
        ? m`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>`
        : null
    } ${
      !l && this.loading ? m`<wcm-spinner></wcm-spinner>` : null
    }</div></wcm-modal-content>`;
  }
};
...
var Fl = Object.defineProperty,
  ...
  No = (e, t, r, n) => {
    for (
      var o = n > 1 ? void 0 : n ? Vl(t, r) : t, i = e.length - 1, s;
      i >= 0;
      i--
    )
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
