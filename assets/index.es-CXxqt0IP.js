const __vite__mapDeps = (i, m=__vite__mapDeps, d=(m.f || (m.f = ["assets/index-BurEAbzY.js", "assets/index-CpP-AC1q.js", "assets/index-CFpBmM1l.css"]))) => i.map(i => d[i]);
import {bY as Pn, bZ as Cu, b_ as Tu, bB as rr, bA as mh, bC as wh, bk as Ru, by as Ht, b$ as _h, c0 as Sa, c1 as Ia, c2 as Re, ap as Kt, c3 as $u, ak as xa, c4 as Nu, aq as Fu} from "./index-CpP-AC1q.js";
...
var co = function(r, e, t) {
  ...
  , Hu = /alexa|bot|crawl(er|ing)|facebookexternalhit|feedburner|google web preview|nagios|postrank|pingdom|slurp|spider|yahoo!|yandex/
  , Ku = /(nuhk|curl|Googlebot|Yammybot|Openbot|Slurp|MSNBot|Ask\ Jeeves\/Teoma|ia_archiver)/
  , ho = 3
  , Vu = [["aol", /AOLShield\/([0-9\._]+)/], ["edge", /Edge\/([0-9\._]+)/], ["edge-ios", /EdgiOS\/([0-9\._]+)/], ["yandexbrowser", /YaBrowser\/([0-9\._]+)/], ["kakaotalk", /KAKAOTALK\s([0-9\.]+)/], ["samsung", /SamsungBrowser\/([0-9\.]+)/], ["silk", /\bSilk\/([0-9._-]+)\b/], ["miui", /MiuiBrowser\/([0-9\.]+)$/], ["beaker", /BeakerBrowser\/([0-9\.]+)/], ["edge-chromium", /EdgA?\/([0-9\.]+)/], ["chromium-webview", /(?!Chrom.*OPR)wv\).*Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/], ["chrome", /(?!Chrom.*OPR)Chrom(?:e|ium)\/([0-9\.]+)(:?\s|$)/], ["phantomjs", /PhantomJS\/([0-9\.]+)(:?\s|$)/], ["crios", /CriOS\/([0-9\.]+)(:?\s|$)/], ["firefox", /Firefox\/([0-9\.]+)(?:\s|$)/], ["fxios", /FxiOS\/([0-9\.]+)/], ["opera-mini", /Opera Mini.*Version\/([0-9\.]+)/], ["opera", /Opera\/([0-9\.]+)(?:\s|$)/], ["opera", /OPR\/([0-9\.]+)(:?\s|$)/], ["pie", /^Microsoft Pocket Internet Explorer\/(\d+\.\d+)$/], ["pie", /^Mozilla\/\d\.\d+\s\(compatible;\s(?:MSP?IE|MSInternet Explorer) (\d+\.\d+);.*Windows CE.*\)$/], ["netfront", /^Mozilla\/\d\.\d+.*NetFront\/(\d.\d)/], ["ie", /Trident\/7\.0.*rv\:([0-9\.]+).*\).*Gecko$/], ["ie", /MSIE\s([0-9\.]+);.*Trident\/[4-7].0/], ["ie", /MSIE\s(7\.0)/], ["bb10", /BB10;\sTouch.*Version\/([0-9\.]+)/], ["android", /Android\s([0-9\.]+)/], ["ios", /Version\/([0-9\._]+).*Mobile.*Safari.*/], ["safari", /Version\/([0-9\._]+).*Safari/], ["facebook", /FB[AS]V\/([0-9\.]+)/], ["instagram", /Instagram\s([0-9\.]+)/], ["ios-webview", /AppleWebKit\/([0-9\.]+).*Mobile/], ["ios-webview", /AppleWebKit\/([0-9\.]+).*Gecko\)$/], ["curl", /^curl\/([0-9\.]+)$/], ["searchbot", Hu]]
  , fo = [["iOS", /iP(hone|od|ad)/], ["Android OS", /Android/], ["BlackBerry OS", /BlackBerry|BB10/], ["Windows Mobile", /IEMobile/], ["Amazon OS", /Kindle/], ["Windows 3.11", /Win16/], ["Windows 95", /(Windows 95)|(Win95)|(Windows_95)/], ["Windows 98", /(Windows 98)|(Win98)/], ["Windows 2000", /(Windows NT 5.0)|(Windows 2000)/], ["Windows XP", /(Windows NT 5.1)|(Windows XP)/], ["Windows Server 2003", /(Windows NT 5.2)/], ["Windows Vista", /(Windows NT 6.0)/], ["Windows 7", /(Windows NT 6.1)/], ["Windows 8", /(Windows NT 6.2)/], ["Windows 8.1", /(Windows NT 6.3)/], ["Windows 10", /(Windows NT 10.0)/], ["Windows ME", /Windows ME/], ["Windows CE", /Windows CE|WinCE|Microsoft Pocket Internet Explorer/], ["Open BSD", /OpenBSD/], ["Sun OS", /SunOS/], ["Chrome OS", /CrOS/], ["Linux", /(Linux)|(X11)/], ["Mac OS", /(Mac_PowerPC)|(Macintosh)/], ["QNX", /QNX/], ["BeOS", /BeOS/], ["OS/2", /OS\/2/]];
function Gu(r) {
    return typeof document > "u" && typeof navigator < "u" && navigator.product === "ReactNative" ? new ku : typeof navigator < "u" ? Ju(navigator.userAgent) : Xu()
}
function Wu(r) {
    return r !== "" && Vu.reduce(function(e, t) {
        var i = t[0]
          , s = t[1];
        if (e)
            return e;
...
function Ju(r) {
    ...
    s ? s.length < ho && (s = co(co([], s, !0), Qu(ho - s.length), !0)) : s = [];
    var n = s.join(".")
      , a = Yu(r)
      , o = Ku.exec(r);
...
function td(r, e, t, i) {
    ...
    return s > 3 && n && Object.defineProperty(e, t, n),
    n
}
function rd(r, e) {
    return function(t, i) {
...
function nd(r, e) {
    ...
    function f(h) {
        ...
        for (; t; )
            try {
                if (i = 1,
                s && (n = h[0] & 2 ? s.return : h[0] ? s.throw || ((n = s.return) && n.call(s),
                0) : s.next) && !(n = n.call(s, h[1])).done)
                    return n;
                switch (s = 0,
                n && (h = [h[0] & 2, n.value]),
                h[0]) {
                ...
                default:
                    if (n = t.trys,
                    !(n = n.length > 0 && n[n.length - 1]) && (h[0] === 6 || h[0] === 2)) {
                        t = 0;
                        continue
                    }
...
function ts(r) {
    return this instanceof ts ? (this.v = r,
    this) : new ts(r)
}
function fd(r, e, t) {
    ...
    function f(E) {
        E.value instanceof ts ? Promise.resolve(E.value.v).then(h, g) : y(n[0][2], E)
    }
    function h(E) {
        o("next", E)
    }
...
function dd(r) {
    ...
    return e ? e.call(r) : (r = typeof ea == "function" ? ea(r) : r[Symbol.iterator](),
    t = {},
    i("next"),
    i("throw"),
    i("return"),
...
Ge.getLocalStorage = Ge.getLocalStorageOrThrow = Ge.getCrypto = Ge.getCryptoOrThrow = xh = Ge.getLocation = Ge.getLocationOrThrow = Pa = Ge.getNavigator = Ge.getNavigatorOrThrow = sn = Ge.getDocument = Ge.getDocumentOrThrow = Ge.getFromWindowOrThrow = Ge.getFromWindow = void 0;
function Qr(r) {
    let e;
    return typeof window < "u" && typeof window[r] < "u" && (e = window[r]),
    e
}
Ge.getFromWindow = Qr;
function vi(r) {
...
function qd() {
    let r, e;
    try {
        r = _o.getDocumentOrThrow(),
        e = _o.getLocationOrThrow()
    } catch {
        return null
    }
    function t() {
    ...
    function i(...y) {
        ...
        for (let w = 0; w < E.length; w++) {
            const S = E[w]
              , $ = ["itemprop", "property", "name"].map(q => S.getAttribute(q)).filter(q => q ? y.includes(q) : !1);
            if ($.length && $) {
...
var rs = {}
  , Ld = r => encodeURIComponent(r).replace(/[!'()*]/g, e => `%${e.charCodeAt(0).toString(16).toUpperCase()}`)
  , Ph = "%[a-f0-9]{2}"
  , Eo = new RegExp("(" + Ph + ")|([^%]+?)","gi")
  , So = new RegExp("(" + Ph + ")+","gi");
function ta(r, e) {
...
var zd = function(r) {
  ...
  , kd = function(r, e) {
    for (var t = {}, i = Object.keys(r), s = Array.isArray(e), n = 0; n < i.length; n++) {
        var a = i[n]
          , o = r[a];
...
(function(r) {
    ...
    function o(C) {
        ...
        case "index":
            return L => (A, T) => {
                const R = A.length;
                return T === void 0 || C.skipNull && T === null || C.skipEmptyString && T === "" ? A : T === null ? [...A, [g(L, C), "[", R, "]"].join("")] : [...A, [g(L, C), "[", g(R, C), "]=", g(T, C)].join("")]
            }
            ;
        case "bracket":
            return L => (A, T) => T === void 0 || C.skipNull && T === null || C.skipEmptyString && T === "" ? A : T === null ? [...A, [g(L, C), "[]"].join("")] : [...A, [g(L, C), "[]=", g(T, C)].join("")];
        case "colon-list-separator":
            return L => (A, T) => T === void 0 || C.skipNull && T === null || C.skipEmptyString && T === "" ? A : T === null ? [...A, [g(L, C), ":list="].join("")] : [...A, [g(L, C), ":list=", g(T, C)].join("")];
        case "comma":
        case "separator":
        case "bracket-separator":
            {
                const L = C.arrayFormat === "bracket-separator" ? "[]=" : "=";
                return A => (T, R) => R === void 0 || C.skipNull && R === null || C.skipEmptyString && R === "" ? T : (R = R === null ? "" : R,
                T.length === 0 ? [[g(A, C), L, g(R, C)].join("")] : [[T, g(R, C)].join(C.arrayFormatSeparator)])
            }
        default:
            return L => (A, T) => T === void 0 || C.skipNull && T === null || C.skipEmptyString && T === "" ? A : T === null ? [...A, g(L, C)] : [...A, [g(L, C), "=", g(T, C)].join("")]
        }
    }
    function f(C) {
        let L;
        ...
        case "separator":
            return (A, T, R) => {
                const l = typeof T == "string" && T.includes(C.arrayFormatSeparator)
                  , P = typeof T == "string" && !l && y(T, C).includes(C.arrayFormatSeparator);
                T = P ? y(T, C) : T;
                const H = l || P ? T.split(C.arrayFormatSeparator).map(Y => y(Y, C)) : T === null ? T : y(T, C);
                R[A] = H
            }
            ;
        case "bracket-separator":
            return (A, T, R) => {
                ...
                const P = T === null ? [] : T.split(C.arrayFormatSeparator).map(H => y(H, C));
                if (R[A] === void 0) {
                    R[A] = P;
                    return
                }
    ...
    function E(C) {
        return Array.isArray(C) ? C.sort() : typeof C == "object" ? E(Object.keys(C)).sort( (L, A) => Number(L) - Number(A)).map(L => C[L]) : C
    }
    function w(C) {
        const L = C.indexOf("#");
    ...
    function q(C, L) {
        return L.parseNumbers && !Number.isNaN(Number(C)) && typeof C == "string" && C.trim() !== "" ? C = Number(C) : L.parseBooleans && C !== null && (C.toLowerCase() === "true" || C.toLowerCase() === "false") && (C = C.toLowerCase() === "true"),
        C
    }
    function z(C, L) {
        L = Object.assign({
        ...
        for (const R of C.split("&")) {
            ...
            P = P === void 0 ? null : ["comma", "separator", "bracket-separator"].includes(L.arrayFormat) ? P : y(P, L),
            A(y(l, L), P, T)
        }
        ...
        return L.sort === !1 ? T : (L.sort === !0 ? Object.keys(T).sort() : Object.keys(T).sort(L.sort)).reduce( (R, l) => {
            const P = T[l];
            return P && typeof P == "object" && !Array.isArray(P) ? R[l] = E(P) : R[l] = P,
            R
        }
        , Object.create(null))
    }
    ...
    r.stringify = (C, L) => {
        ...
        h(L.arrayFormatSeparator);
        const A = P => L.skipNull && n(C[P]) || L.skipEmptyString && C[P] === ""
          , T = o(L)
          , R = {};
        for (const P of Object.keys(C))
            A(P) || (R[P] = C[P]);
        const l = Object.keys(R);
        return L.sort !== !1 && l.sort(L.sort),
        l.map(P => {
            const H = C[P];
            return H === void 0 ? "" : H === null ? g(P, L) : Array.isArray(H) ? H.length === 0 && L.arrayFormat === "bracket-separator" ? g(P, L) + "[]" : H.reduce(T(P), []).join("&") : g(P, L) + "=" + g(H, L)
        }
    ...
    r.stringifyUrl = (C, L) => {
        ...
        P && (P = `?${P}`);
        let H = S(C.url);
        return C.fragmentIdentifier && (H = `#${L[a] ? g(C.fragmentIdentifier, L) : C.fragmentIdentifier}`),
        `${A}${P}${H}`
    }
    ,
    r.pick = (C, L, A) => {
...
(function(r) {
    ...
    r.isSafeInteger = function(o) {
        return r.isInteger(o) && o >= -r.MAX_SAFE_INTEGER && o <= r.MAX_SAFE_INTEGER
    }
}
)(Mh);
...
ye.readUintLE = Zd;
function el(r, e, t, i) {
    if (t === void 0 && (t = new Uint8Array(r / 8)),
    i === void 0 && (i = 0),
    r % 8 !== 0)
...
var St = ye
  ...
  , ul = 20;
function dl(r, e, t) {
    for (var i = 1634760805, s = 857760878, n = 2036477234, a = 1797285236, o = t[3] << 24 | t[2] << 16 | t[1] << 8 | t[0], f = t[7] << 24 | t[6] << 16 | t[5] << 8 | t[4], h = t[11] << 24 | t[10] << 16 | t[9] << 8 | t[8], g = t[15] << 24 | t[14] << 16 | t[13] << 8 | t[12], y = t[19] << 24 | t[18] << 16 | t[17] << 8 | t[16], E = t[23] << 24 | t[22] << 16 | t[21] << 8 | t[20], w = t[27] << 24 | t[26] << 16 | t[25] << 8 | t[24], S = t[31] << 24 | t[30] << 16 | t[29] << 8 | t[28], $ = e[3] << 24 | e[2] << 16 | e[1] << 8 | e[0], q = e[7] << 24 | e[6] << 16 | e[5] << 8 | e[4], z = e[11] << 24 | e[10] << 16 | e[9] << 8 | e[8], C = e[15] << 24 | e[14] << 16 | e[13] << 8 | e[12], L = i, A = s, T = n, R = a, l = o, P = f, H = h, Y = g, M = y, c = E, v = w, d = S, b = $, _ = q, D = z, x = C, m = 0; m < ul; m += 2)
        L = L + l | 0,
        b ^= L,
        b = b >>> 16 | b << 16,
        M = M + b | 0,
...
function $h(r, e, t, i, s) {
    ...
    for (var o = new Uint8Array(64), f = 0; f < t.length; f += 64) {
        dl(o, n, r);
        for (var h = f; h < f + 64 && h < t.length; h++)
            i[h] = t[h] ^ o[h - f];
        pl(n, 0, a)
    }
    return aa.wipe(o),
...
(function(r) {
    ...
    var i = function() {
        ...
        return a.prototype._blocks = function(o, f, h) {
            for (var g = this._fin ? 0 : 2048, y = this._h[0], E = this._h[1], w = this._h[2], S = this._h[3], $ = this._h[4], q = this._h[5], z = this._h[6], C = this._h[7], L = this._h[8], A = this._h[9], T = this._r[0], R = this._r[1], l = this._r[2], P = this._r[3], H = this._r[4], Y = this._r[5], M = this._r[6], c = this._r[7], v = this._r[8], d = this._r[9]; h >= 16; ) {
                var b = o[f + 0] | o[f + 1] << 8;
                y += b & 8191;
                var _ = o[f + 2] | o[f + 3] << 8;
                E += (b >>> 13 | _ << 3) & 8191;
        ...
        a.prototype.finish = function(o, f) {
            f === void 0 && (f = 0);
            var h = new Uint16Array(10), g, y, E, w;
            if (this._leftover) {
                for (w = this._leftover,
                this._buffer[w++] = 1; w < 16; w++)
                    this._buffer[w] = 0;
                this._fin = 1,
    ...
    r.oneTimeAuth = s;
    function n(a, o) {
        return a.length !== r.DIGEST_LENGTH || o.length !== r.DIGEST_LENGTH ? !1 : e.equal(a, o)
    }
    r.equal = n
}
)(Nh);
      ...
      , o = function() {
        ...
        return f.prototype.seal = function(h, g, y, E) {
            ...
            if (E) {
                ...
                q = new Uint8Array($);
            return e.streamXOR(this._key, w, g, q, 4),
            this._authenticate(q.subarray(q.length - this.tagLength, q.length), S, q.subarray(0, q.length - this.tagLength), y),
            i.wipe(w),
            q
        }
        ,
        f.prototype.open = function(h, g, y, E) {
            ...
            if (this._authenticate($, S, g.subarray(0, g.length - this.tagLength), y),
            !n.equal($, g.subarray(g.length - this.tagLength, g.length)))
                return null;
            var q = g.length - this.tagLength, z;
            if (E) {
                if (E.length !== q)
                    throw new Error("ChaCha20Poly1305: incorrect destination length");
                z = E
                ...
                z = new Uint8Array(q);
            return e.streamXOR(this._key, w, g.subarray(0, g.length - this.tagLength), z, 4),
            i.wipe(w),
            z
        }
        ,
        f.prototype.clean = function() {
            return i.wipe(this._key),
            this
        }
        ,
        f.prototype._authenticate = function(h, g, y, E) {
            ...
            w.update(S);
            for (var $ = w.digest(), q = 0; q < $.length; q++)
                h[q] = $[q];
            w.clean(),
            i.wipe($),
            i.wipe(S)
...
var ar = Oa
  ...
  , Lh = function() {
    function r(e, t) {
        ...
        ar.isSerializableHash(this._inner) && ar.isSerializableHash(this._outer) && (this._innerKeyedState = this._inner.saveState(),
    ...
    r.prototype.clean = function() {
        ar.isSerializableHash(this._inner) && this._inner.cleanSavedState(this._innerKeyedState),
        ar.isSerializableHash(this._outer) && this._outer.cleanSavedState(this._outerKeyedState),
        this._inner.clean(),
        this._outer.clean()
    }
    ,
...
class Il {
    ...
    randomBytes(e) {
        ...
        for (let i = 0; i < t.length; i += Do)
            this._crypto.getRandomValues(t.subarray(i, i + Math.min(t.length - i, Do)));
        return t
    }
}
...
class Al {
    constructor() {
        ...
        if (this._source = new Ml.NodeRandomSource,
        this._source.isAvailable) {
            this.isAvailable = !0,
            this.name = "Node";
            return
...
(function(r) {
    ...
    var i = function() {
        ...
        o.prototype.update = function(f, h) {
            if (h === void 0 && (h = f.length),
            this._finished)
                throw new Error("SHA256: can't update because hash was finished.");
            var g = 0;
            if (this._bytesHashed += h,
            this._bufferLength > 0) {
                for (; this._bufferLength < this.blockSize && h > 0; )
                    this._buffer[this._bufferLength++] = f[g++],
                    h--;
                this._bufferLength === this.blockSize && (n(this._temp, this._state, this._buffer, 0, this.blockSize),
                this._bufferLength = 0)
            }
            for (h >= this.blockSize && (g = n(this._temp, this._state, f, g, h),
            h %= this.blockSize); h > 0; )
                this._buffer[this._bufferLength++] = f[g++],
                h--;
            return this
        }
        ...
        o.prototype.restoreState = function(f) {
            return this._state.set(f.state),
    ...
    function n(o, f, h, g, y) {
        for (; y >= 64; ) {
            for (var E = f[0], w = f[1], S = f[2], $ = f[3], q = f[4], z = f[5], C = f[6], L = f[7], A = 0; A < 16; A++) {
                var T = g + A * 4;
            ...
            for (var A = 0; A < 64; A++) {
                var l = (((q >>> 6 | q << 26) ^ (q >>> 11 | q << 21) ^ (q >>> 25 | q << 7)) + (q & z ^ ~q & C) | 0) + (L + (s[A] + o[A] | 0) | 0) | 0
                  , P = ((E >>> 2 | E << 30) ^ (E >>> 13 | E << 19) ^ (E >>> 22 | E << 10)) + (E & w ^ E & S ^ w & S) | 0;
                L = C,
                C = z,
                z = q,
                q = $ + l | 0,
...
(function(r) {
    ...
    function E(A, T, R) {
        let l, P, H = 0, Y = 0, M = 0, c = 0, v = 0, d = 0, b = 0, _ = 0, D = 0, x = 0, m = 0, u = 0, I = 0, K = 0, k = 0, W = 0, V = 0, ee = 0, U = 0, B = 0, F = 0, p = 0, N = 0, J = 0, X = 0, me = 0, fe = 0, ce = 0, qe = 0, ve = 0, pe = 0, $e = R[0], he = R[1], oe = R[2], xe = R[3], ne = R[4], se = R[5], ge = R[6], re = R[7], ae = R[8], Te = R[9], ie = R[10], ue = R[11], Fe = R[12], de = R[13], le = R[14], Le = R[15];
        l = T[0],
        H += l * $e,
        Y += l * he,
        M += l * oe,
...
function Ol(r, e) {
    ...
    function y(S) {
        if (S instanceof Uint8Array || (ArrayBuffer.isView(S) ? S = new Uint8Array(S.buffer,S.byteOffset,S.byteLength) : Array.isArray(S) && (S = Uint8Array.from(S))),
        ...
        for (var L = (C - z) * g + 1 >>> 0, A = new Uint8Array(L); z !== C; ) {
            for (var T = S[z], R = 0, l = L - 1; (T !== 0 || R < q) && l !== -1; l--,
            R++)
                T += 256 * A[l] >>> 0,
                A[l] = T % o >>> 0,
                T = T / o >>> 0;
        ...
        for (var P = L - q; P !== L && A[P] === 0; )
            P++;
        for (var H = f.repeat($); P < L; ++P)
            H += r.charAt(A[P]);
        return H
    }
    function E(S) {
        ...
        if (S[$] !== " ") {
            for (var q = 0, z = 0; S[$] === f; )
                q++,
                $++;
            for (var C = (S.length - $) * h + 1 >>> 0, L = new Uint8Array(C); S[$]; ) {
                var A = t[S.charCodeAt($)];
                if (A === 255)
                    return;
                for (var T = 0, R = C - 1; (A !== 0 || T < z) && R !== -1; R--,
                T++)
                    A += o * L[R] >>> 0,
                    L[R] = A % 256 >>> 0,
                    A = A / 256 >>> 0;
...
const hn = ({name: r, prefix: e, encode: t, decode: i}) => new Ul(r,e,t,i)
  ...
  , mt = ({name: r, prefix: e, bitsPerChar: t, alphabet: i}) => hn({
    prefix: e,
    name: r,
    encode(s) {
        return zl(s, i, t)
  ...
  , zh = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂")
  , w0 = zh.reduce( (r, e, t) => (r[t] = e,
r), [])
  , _0 = zh.reduce( (r, e, t) => (r[e.codePointAt(0)] = t,
r), []);
function E0(r) {
    return r.reduce( (e, t) => (e += w0[t],
    e), "")
}
function S0(r) {
    const e = [];
...
const Mo = Bh("utf8", "u", r => "u" + new TextDecoder("utf8").decode(r), r => new TextEncoder().encode(r.substring(1)))
  , Tn = Bh("ascii", "a", r => {
    let e = "a";
...
(function(r) {
    (function(e, t) {
        ...
        var a;
        try {
            typeof window < "u" && typeof window.Buffer < "u" ? a = window.Buffer : a = Ru.Buffer
        } catch {}
        n.isBN = function(c) {
        ...
        n.prototype._init = function(c, v, d) {
            if (typeof c == "number")
                return this._initNumber(c, v, d);
            if (typeof c == "object")
                return this._initArray(c, v, d);
            v === "hex" && (v = 16),
            i(v === (v | 0) && v >= 2 && v <= 36),
            ...
            c[0] === "-" && (b++,
            this.negative = 1),
            b < c.length && (v === 16 ? this._parseHex(c, b, d) : (this._parseBase(c, v, b),
        ...
        n.prototype._initNumber = function(c, v, d) {
            ...
            this.length = 2) : (i(c < 9007199254740992),
        ...
        n.prototype._parseBase = function(c, v, d) {
            this.words = [0],
            this.length = 1;
            for (var b = 0, _ = 1; _ <= 67108863; _ *= v)
                b++;
            b--,
            _ = _ / v | 0;
            for (var D = c.length - d, x = D % b, m = Math.min(D, D - x) + d, u = 0, I = d; I < m; I += b)
                u = h(c, I, I + b, v),
                this.imuln(_),
                this.words[0] + u < 67108864 ? this.words[0] += u : this._iaddn(u);
            if (x !== 0) {
                var K = 1;
                for (u = h(c, I, c.length, v),
                I = 0; I < x; I++)
                    K *= v;
                this.imuln(K),
                this.words[0] + u < 67108864 ? this.words[0] += u : this._iaddn(u)
        ...
        n.prototype.toString = function(c, v) {
            ...
            if (c === 16 || c === "hex") {
                ...
                for (var b = 0, _ = 0, D = 0; D < this.length; D++) {
                    ...
                    _ = x >>> 24 - b & 16777215,
                    _ !== 0 || D !== this.length - 1 ? d = g[6 - m.length] + m + d : d = m + d,
                    b += 2,
                    b >= 26 && (b -= 26,
                    D--)
                }
            ...
            if (c === (c | 0) && c >= 2 && c <= 36) {
                ...
                for (this.isZero() && (d = "0" + d); d.length % v !== 0; )
                    d = "0" + d;
                return this.negative !== 0 && (d = "-" + d),
                d
            }
        ...
        n.prototype.toNumber = function() {
            var c = this.words[0];
            return this.length === 2 ? c += this.words[1] * 67108864 : this.length === 3 && this.words[2] === 1 ? c += 4503599627370496 + this.words[1] * 67108864 : this.length > 2 && i(!1, "Number can only safely store up to 53 bits"),
            this.negative !== 0 ? -c : c
        }
        ,
        ...
        n.prototype.toArrayLike = function(c, v, d) {
            ...
            this.strip();
            var D = v === "le", x = new c(_), m, u, I = this.clone();
            if (D) {
                for (u = 0; !I.isZero(); u++)
                    m = I.andln(255),
                    I.iushrn(8),
        ...
        n.prototype.ior = function(c) {
            return i((this.negative | c.negative) === 0),
            this.iuor(c)
        }
        ,
        ...
        n.prototype.inotn = function(c) {
            ...
            return d > 0 && (this.words[b] = ~this.words[b] & 67108863 >> 26 - d),
            this.strip()
        }
        ,
        ...
        n.prototype.setn = function(c, v) {
            ...
            v ? this.words[d] = this.words[d] | 1 << b : this.words[d] = this.words[d] & ~(1 << b),
            this.strip()
        }
        ,
        ...
        n.prototype.add = function(c) {
            ...
            v = this.sub(c),
            c.negative ^= 1,
            v) : c.negative === 0 && this.negative !== 0 ? (this.negative = 0,
            v = c.sub(this),
            this.negative = 1,
            v) : this.length > c.length ? this.clone().iadd(c) : c.clone().iadd(this)
        }
        ,
        ...
        function S(M, c, v) {
            ...
            v.words[0] = x;
            for (var u = 1; u < d; u++) {
                for (var I = m >>> 26, K = m & 67108863, k = Math.min(u, c.length - 1), W = Math.max(0, u - M.length + 1); W <= k; W++) {
                    var V = u - W | 0;
                    b = M.words[V] | 0,
                    _ = c.words[W] | 0,
                    D = b * _ + K,
            ...
            return m !== 0 ? v.words[u] = m | 0 : v.length--,
            v.strip()
        }
        var $ = function(c, v, d) {
            var b = c.words, _ = v.words, D = d.words, x = 0, m, u, I, K = b[0] | 0, k = K & 8191, W = K >>> 13, V = b[1] | 0, ee = V & 8191, U = V >>> 13, B = b[2] | 0, F = B & 8191, p = B >>> 13, N = b[3] | 0, J = N & 8191, X = N >>> 13, me = b[4] | 0, fe = me & 8191, ce = me >>> 13, qe = b[5] | 0, ve = qe & 8191, pe = qe >>> 13, $e = b[6] | 0, he = $e & 8191, oe = $e >>> 13, xe = b[7] | 0, ne = xe & 8191, se = xe >>> 13, ge = b[8] | 0, re = ge & 8191, ae = ge >>> 13, Te = b[9] | 0, ie = Te & 8191, ue = Te >>> 13, Fe = _[0] | 0, de = Fe & 8191, le = Fe >>> 13, Le = _[1] | 0, je = Le & 8191, ze = Le >>> 13, Yt = _[2] | 0, Ue = Yt & 8191, He = Yt >>> 13, Ir = _[3] | 0, Je = Ir & 8191, we = Ir >>> 13, Ye = _[4] | 0, _e = Ye & 8191, Ee = Ye >>> 13, Ze = _[5] | 0, be = Ze & 8191, Pe = Ze >>> 13, at = _[6] | 0, Me = at & 8191, Ae = at >>> 13, ot = _[7] | 0, De = ot & 8191, Se = ot >>> 13, Ke = _[8] | 0, Oe = Ke & 8191, Ce = Ke >>> 13, Es = _[9] | 0, tt = Es & 8191, rt = Es >>> 13;
        ...
        function q(M, c, v) {
            v.negative = c.negative ^ M.negative,
            v.length = M.length + c.length;
            for (var d = 0, b = 0, _ = 0; _ < v.length - 1; _++) {
                var D = b;
                b = 0;
                for (var x = d & 67108863, m = Math.min(_, c.length - 1), u = Math.max(0, _ - M.length + 1); u <= m; u++) {
                    var I = _ - u
                      , K = M.words[I] | 0
                      , k = c.words[u] | 0
                      , W = K * k
            ...
            return d !== 0 ? v.words[_] = d : v.length--,
            v.strip()
        }
        function z(M, c, v) {
            var d = new C;
        ...
        n.prototype.mulTo = function(c, v) {
            var d, b = this.length + c.length;
            return this.length === 10 && c.length === 10 ? d = $(this, c, v) : b < 63 ? d = S(this, c, v) : b < 1024 ? d = q(this, c, v) : d = z(this, c, v),
            d
        }
        ;
        function C(M, c) {
        ...
        C.prototype.makeRBT = function(c) {
            for (var v = new Array(c), d = n.prototype._countBits(c) - 1, b = 0; b < c; b++)
        ...
        C.prototype.transform = function(c, v, d, b, _, D) {
            ...
            for (var x = 1; x < _; x <<= 1)
                for (var m = x << 1, u = Math.cos(2 * Math.PI / m), I = Math.sin(2 * Math.PI / m), K = 0; K < _; K += m)
        ...
        C.prototype.normalize13b = function(c, v) {
            for (var d = 0, b = 0; b < v / 2; b++) {
                var _ = Math.round(c[2 * b + 1] / v) * 8192 + Math.round(c[2 * b] / v) + d;
                c[b] = _ & 67108863,
        ...
        C.prototype.stub = function(c) {
            for (var v = new Array(c), d = 0; d < c; d++)
                v[d] = 0;
            return v
        }
        ,
        ...
        n.prototype.mul = function(c) {
            var v = new n(null);
            return v.words = new Array(this.length + c.length),
            this.mulTo(c, v)
        }
        ,
        ...
        n.prototype.pow = function(c) {
            ...
            if (v.length === 0)
                return new n(1);
            for (var d = this, b = 0; b < v.length && v[b] === 0; b++,
            d = d.sqr())
                ;
            if (++b < v.length)
                for (var _ = d.sqr(); b < v.length; b++,
                _ = _.sqr())
                    v[b] !== 0 && (d = d.mul(_));
            return d
        }
        ...
        n.prototype.iushln = function(c) {
            i(typeof c == "number" && c >= 0);
            var v = c % 26, d = (c - v) / 26, b = 67108863 >>> 26 - v << 26 - v, _;
            if (v !== 0) {
                var D = 0;
        ...
        n.prototype.iushrn = function(c, v, d) {
            ...
            for (u = this.length - 1; u >= 0 && (I !== 0 || u >= b); u--) {
                ...
                this.words[u] = I << 26 - _ | K >>> _,
                I = K & x
            }
            return m && I !== 0 && (m.words[m.length++] = I),
        ...
        n.prototype._iaddn = function(c) {
            ...
            return this.length = Math.max(this.length, v + 1),
            this
        }
        ,
        n.prototype.isubn = function(c) {
            if (i(typeof c == "number"),
            i(c < 67108864),
            c < 0)
                return this.iaddn(-c);
            if (this.negative !== 0)
        ...
        n.prototype._wordDiv = function(c, v) {
            ...
            u && (u.words[m] = 1));
            for (var k = m - 1; k >= 0; k--) {
                var W = (b.words[_.length + k] | 0) * 67108864 + (b.words[_.length + k - 1] | 0);
                for (W = Math.min(W / D | 0, 67108863),
                b._ishlnsubmul(_, W, k); b.negative !== 0; )
                    W--,
                    b.negative = 0,
        ...
        n.prototype.divmod = function(c, v, d) {
            ...
            var b, _, D;
            return this.negative !== 0 && c.negative === 0 ? (D = this.neg().divmod(c, v),
            v !== "mod" && (b = D.div.neg()),
            v !== "div" && (_ = D.mod.neg(),
            d && _.negative !== 0 && _.iadd(c)),
            {
                div: b,
                mod: _
            }) : this.negative === 0 && c.negative !== 0 ? (D = this.divmod(c.neg(), v),
            v !== "mod" && (b = D.div.neg()),
            {
                div: b,
                mod: D.mod
            }) : this.negative & c.negative ? (D = this.neg().divmod(c.neg(), v),
            v !== "div" && (_ = D.mod.neg(),
            d && _.negative !== 0 && _.isub(c)),
            {
                div: D.div,
                mod: _
        ...
        n.prototype.divRound = function(c) {
            ...
            var d = v.div.negative !== 0 ? v.mod.isub(c) : v.mod
              ...
              , _ = c.andln(1)
              , D = d.cmp(b);
            return D < 0 || _ === 1 && D === 0 ? v.div : v.div.negative !== 0 ? v.div.isubn(1) : v.div.iaddn(1)
        }
        ,
        ...
        n.prototype.egcd = function(c) {
            ...
            for (var b = new n(1), _ = new n(0), D = new n(0), x = new n(1), m = 0; v.isEven() && d.isEven(); )
                v.iushrn(1),
                d.iushrn(1),
                ++m;
            for (var u = d.clone(), I = v.clone(); !v.isZero(); ) {
                for (var K = 0, k = 1; !(v.words[0] & k) && K < 26; ++K,
                k <<= 1)
                    ;
                if (K > 0)
                    for (v.iushrn(K); K-- > 0; )
                        (b.isOdd() || _.isOdd()) && (b.iadd(u),
                        _.isub(I)),
                        b.iushrn(1),
                        _.iushrn(1);
                for (var W = 0, V = 1; !(d.words[0] & V) && W < 26; ++W,
                V <<= 1)
                    ;
                if (W > 0)
                    for (d.iushrn(W); W-- > 0; )
                        (D.isOdd() || x.isOdd()) && (D.iadd(u),
                        x.isub(I)),
                        D.iushrn(1),
                        x.iushrn(1);
                v.cmp(d) >= 0 ? (v.isub(d),
        ...
        n.prototype._invmp = function(c) {
            ...
            var v = this
              , d = c.clone();
            v.negative !== 0 ? v = v.umod(c) : v = v.clone();
            for (var b = new n(1), _ = new n(0), D = d.clone(); v.cmpn(1) > 0 && d.cmpn(1) > 0; ) {
                for (var x = 0, m = 1; !(v.words[0] & m) && x < 26; ++x,
                m <<= 1)
                    ;
                if (x > 0)
                    for (v.iushrn(x); x-- > 0; )
                        b.isOdd() && b.iadd(D),
                        b.iushrn(1);
                for (var u = 0, I = 1; !(d.words[0] & I) && u < 26; ++u,
                I <<= 1)
                    ;
                if (u > 0)
                    for (d.iushrn(u); u-- > 0; )
        ...
        n.prototype.gcd = function(c) {
            ...
            v.negative = 0,
            d.negative = 0;
            for (var b = 0; v.isEven() && d.isEven(); b++)
                v.iushrn(1),
                d.iushrn(1);
            do {
                for (; v.isEven(); )
        ...
        n.prototype.cmpn = function(c) {
            ...
            if (this.length > 1)
                ...
                v && (c = -c),
                i(c <= 67108863, "Number is too big");
        ...
        n.prototype.redPow = function(c) {
            return i(this.red && !c.red, "redPow(normalNum)"),
            this.red._verify1(this),
            this.red.pow(this, c)
        }
        ;
        ...
        A.prototype.ireduce = function(c) {
            ...
            return b === 0 ? (v.words[0] = 0,
            v.length = 1) : b > 0 ? v.isub(this.p) : v.strip !== void 0 ? v.strip() : v._strip(),
            v
        }
        ,
        ...
        T.prototype.split = function(c, v) {
            ...
            var D = c.words[9];
            for (v.words[v.length++] = D & d,
            _ = 10; _ < c.length; _++) {
                var x = c.words[_] | 0;
                c.words[_ - 10] = (x & d) << 4 | D >>> 22,
                D = x
            }
            D >>>= 22,
            c.words[_ - 10] = D,
        ...
        H.prototype.sqrt = function(c) {
            ...
            for (u = new n(2 * u * u).toRed(this); this.pow(u, m).cmp(x) !== 0; )
                u.redIAdd(x);
            for (var I = this.pow(u, b), K = this.pow(c, b.addn(1).iushrn(1)), k = this.pow(c, b), W = _; k.cmp(D) !== 0; ) {
                for (var V = k, ee = 0; V.cmp(D) !== 0; ee++)
                    V = V.redSqr();
                i(ee < W);
        ...
        H.prototype.invm = function(c) {
            ...
            return v.negative !== 0 ? (v.negative = 0,
            this.imod(v).redNeg()) : this.imod(v)
        }
        ,
        H.prototype.pow = function(c, v) {
            ...
            var d = 4
              , b = new Array(1 << d);
            b[0] = new n(1).toRed(this),
            b[1] = c;
            for (var _ = 2; _ < b.length; _++)
                b[_] = this.mul(b[_ - 1], c);
            var D = b[0]
              , x = 0
              , m = 0
              , u = v.bitLength() % 26;
        ...
        Y.prototype.imul = function(c, v) {
            ...
            var d = c.imul(v)
              ...
              , D = _;
            return _.cmp(this.m) >= 0 ? D = _.isub(this.m) : _.cmpn(0) < 0 && (D = _.iadd(this.m)),
            D._forceRed(this)
        }
        ,
...
(function(r) {
    ...
    e.encode = s.encode;
    function n(g, y, E) {
        var w = new Array(Math.max(g.bitLength(), E) + 1), S;
...
if (typeof self == "object")
    self.crypto && self.crypto.getRandomValues ? Or.prototype._rand = function(e) {
        var t = new Uint8Array(e);
        return self.crypto.getRandomValues(t),
        t
    }
    : self.msCrypto && self.msCrypto.getRandomValues ? Or.prototype._rand = function(e) {
        var t = new Uint8Array(e);
        return self.msCrypto.getRandomValues(t),
        t
    }
    : typeof window == "object" && (Or.prototype._rand = function() {
    ...
    try {
        var Ao = wh;
        if (typeof Ao.randomBytes != "function")
...
Fr.prototype._fixedNafMul = function(e, t) {
    ...
    for (o = 0; o < s.length; o += i.step) {
        f = 0;
        for (var h = o + i.step - 1; h >= o; h--)
            f = (f << 1) + s[h];
        a.push(f)
    }
    for (var g = this.jpoint(null, null, null), y = this.jpoint(null, null, null), E = n; E > 0; E--) {
        for (o = 0; o < a.length; o++)
            f = a[o],
            f === E ? y = y.mixedAdd(i.points[o]) : f === -E && (y = y.mixedAdd(i.points[o].neg()));
        g = g.add(y)
    }
    return g.toP()
}
...
Fr.prototype._wnafMul = function(e, t) {
    var i = 4
      , s = e._getNAFPoints(i);
    i = s.wnd;
    for (var n = s.points, a = Hs(t, i, this._bitLength), o = this.jpoint(null, null, null), f = a.length - 1; f >= 0; f--) {
        for (var h = 0; f >= 0 && a[f] === 0; f--)
            h++;
        if (f >= 0 && h++,
        o = o.dblp(h),
        f < 0)
        ...
        var g = a[f];
        Ks(g !== 0),
        e.type === "affine" ? g > 0 ? o = o.mixedAdd(n[g - 1 >> 1]) : o = o.mixedAdd(n[-g - 1 >> 1].neg()) : g > 0 ? o = o.add(n[g - 1 >> 1]) : o = o.add(n[-g - 1 >> 1].neg())
    }
    return e.type === "affine" ? o.toP() : o
}
;
Fr.prototype._wnafMulAdd = function(e, t, i, s, n) {
    var a = this._wnafT1, o = this._wnafT2, f = this._wnafT3, h = 0, g, y, E;
    for (g = 0; g < s; g++) {
        E = t[g];
    ...
    for (g = s - 1; g >= 1; g -= 2) {
        ...
        t[S].y.cmp(t[$].y) === 0 ? (q[1] = t[S].add(t[$]),
        q[2] = t[S].toJ().mixedAdd(t[$].neg())) : t[S].y.cmp(t[$].y.redNeg()) === 0 ? (q[1] = t[S].toJ().mixedAdd(t[$]),
        q[2] = t[S].add(t[$].neg())) : (q[1] = t[S].toJ().mixedAdd(t[$]),
        q[2] = t[S].toJ().mixedAdd(t[$].neg()));
        var z = [-3, -1, -5, -7, 0, 7, 5, 1, 3]
          , C = z0(i[S], i[$]);
        for (h = Math.max(C[0].length, h),
        f[S] = new Array(h),
        f[$] = new Array(h),
        y = 0; y < h; y++) {
            var L = C[0][y] | 0
    ...
    for (g = h; g >= 0; g--) {
        ...
        for (y = 0; y < s; y++) {
            var H = R[y];
            H !== 0 && (H > 0 ? E = o[y][H - 1 >> 1] : H < 0 && (E = o[y][-H - 1 >> 1].neg()),
...
Wt.prototype._getNAFPoints = function(e) {
    ...
    for (var t = [this], i = (1 << e) - 1, s = i === 1 ? null : this.dbl(), n = 1; n < i; n++)
        t[n] = t[n - 1].add(s);
    return {
        wnd: e,
        points: t
...
Jt.prototype._getEndomorphism = function(e) {
    if (!(!this.zeroA || !this.g || !this.n || this.p.modn(3) !== 1)) {
        var t, i;
        if (e.beta)
            t = new nt(e.beta,16).toRed(this.red);
        else {
            var s = this._getEndoRoots(this.p);
            t = s[0].cmp(s[1]) < 0 ? s[0] : s[1],
            t = t.toRed(this.red)
        }
        if (e.lambda)
            i = new nt(e.lambda,16);
        else {
            var n = this._getEndoRoots(this.n);
            this.g.mul(n[0]).x.cmp(this.g.x.redMul(t)) === 0 ? i = n[0] : (i = n[1],
            k0(this.g.mul(i).x.cmp(this.g.x.redMul(t)) === 0))
        }
        var a;
...
Jt.prototype._getEndoBasis = function(e) {
    for (var t = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), i = e, s = this.n.clone(), n = new nt(1), a = new nt(0), o = new nt(0), f = new nt(1), h, g, y, E, w, S, $, q = 0, z, C; i.cmpn(0) !== 0; ) {
        var L = s.div(i);
        z = s.sub(L.mul(i)),
        C = o.sub(L.mul(n));
        var A = f.sub(L.mul(a));
...
Jt.prototype._endoWnafMulAdd = function(e, t, i) {
    for (var s = this._endoWnafT1, n = this._endoWnafT2, a = 0; a < e.length; a++) {
...
vt.fromJSON = function(e, t, i) {
    ...
    return s.precomputed = {
        ...
        naf: a.naf && {
            wnd: a.naf.wnd,
            points: [s].concat(a.naf.points.map(n))
        }
    },
    s
}
...
function wt(r, e, t, i) {
    ...
    e === null && t === null && i === null ? (this.x = this.curve.one,
    this.y = this.curve.one,
    this.z = new nt(0)) : (this.x = new nt(e,16),
    this.y = new nt(t,16),
    this.z = new nt(i,16)),
    this.x.red || (this.x = this.x.toRed(this.curve.red)),
    this.y.red || (this.y = this.y.toRed(this.curve.red)),
...
wt.prototype.eqXToP = function(e) {
    ...
    for (var s = e.clone(), n = this.curve.redN.redMul(t); ; ) {
        if (s.iadd(this.curve.n),
        s.cmp(this.curve.p) >= 0)
            return !1;
        if (i.redIAdd(n),
        this.x.cmp(i) === 0)
            return !0
...
function bt(r, e, t) {
    ...
    e === null && t === null ? (this.x = this.curve.one,
    this.z = this.curve.zero) : (this.x = new li(e,16),
    this.z = new li(t,16),
    this.x.red || (this.x = this.x.toRed(this.curve.red)),
    this.z.red || (this.z = this.z.toRed(this.curve.red)))
}
...
bt.prototype.mul = function(e) {
    for (var t = e.clone(), i = this, s = this.curve.point(null, null), n = this, a = []; t.cmpn(0) !== 0; t.iushrn(1))
        a.push(t.andln(1));
    for (var o = a.length - 1; o >= 0; o--)
        a[o] === 0 ? (i = i.diffAdd(s, n),
        s = s.dbl()) : (s = i.diffAdd(s, n),
        i = i.dbl());
    return s
}
;
...
function We(r, e, t, i, s) {
    ...
    e === null && t === null && i === null ? (this.x = this.curve.zero,
    this.y = this.curve.one,
    this.z = this.curve.one,
    this.t = this.curve.zero,
    this.zOne = !0) : (this.x = new _r(e,16),
    this.y = new _r(t,16),
...
We.prototype._projDbl = function() {
    var e = this.x.redAdd(this.y).redSqr(), t = this.x.redSqr(), i = this.y.redSqr(), s, n, a, o, f, h;
    if (this.curve.twisted) {
        o = this.curve._mulA(t);
        var g = o.redAdd(i);
        this.zOne ? (s = e.redSub(t).redSub(i).redMul(g.redSub(this.curve.two)),
        n = g.redMul(o.redSub(i)),
        a = g.redSqr().redSub(g).redSub(g)) : (f = this.z.redSqr(),
...
We.prototype._projAdd = function(e) {
    var t = this.z.redMul(e.z), i = t.redSqr(), s = this.x.redMul(e.x), n = this.y.redMul(e.y), a = this.curve.d.redMul(s).redMul(n), o = i.redSub(a), f = i.redAdd(a), h = this.x.redAdd(this.y).redMul(e.x.redAdd(e.y)).redISub(s).redISub(n), g = t.redMul(o).redMul(h), y, E;
    return this.curve.twisted ? (y = t.redMul(f).redMul(n.redSub(this.curve._mulA(s))),
    E = o.redMul(f)) : (y = t.redMul(f).redMul(n.redSub(s)),
...
(function(r) {
    var e = r
      ...
      , n = s.assert;
    function a(h) {
        h.type === "short" ? this.curve = new i.short(h) : h.type === "edwards" ? this.curve = new i.edwards(h) : this.curve = new i.mont(h),
        this.g = this.curve.g,
        this.n = this.curve.n,
        this.hash = h.hash,
...
function Rr(r) {
    ...
    Wh(e.length >= this.minEntropy / 8, "Not enough entropy. Minimum is: " + this.minEntropy + " bits"),
    this._init(e, t, i)
}
var Q0 = Rr;
...
It.fromPublic = function(e, t, i) {
    return t instanceof It ? t : new It(e,{
        pub: t,
        pubEnc: i
    })
}
...
It.prototype._importPublic = function(e, t) {
    if (e.x || e.y) {
        this.ec.curve.type === "mont" ? oa(e.x, "Need x coordinate") : (this.ec.curve.type === "short" || this.ec.curve.type === "edwards") && oa(e.x && e.y, "Need both x and y coordinate"),
...
It.prototype.derive = function(e) {
    return e.validate() || oa(e.validate(), "public point not validated"),
...
function pn(r, e) {
    if (r instanceof pn)
        return r;
    this._importDER(r, e) || (rp(r.r && r.s, "Signature without r or s"),
    this.r = new Vs(r.r,16),
    this.s = new Vs(r.s,16),
    r.recoveryParam === void 0 ? this.recoveryParam = null : this.recoveryParam = r.recoveryParam)
}
var ip = pn;
function sp() {
    this.place = 0
...
function Nn(r, e) {
    ...
    if (i === 0 || i > 4 || r[e.place] === 0)
        return !1;
    for (var s = 0, n = 0, a = e.place; n < i; n++,
    a++)
        s <<= 8,
        s |= r[a],
        s >>>= 0;
    return s <= 127 ? !1 : (e.place = a,
    s)
}
function Co(r) {
...
pn.prototype._importDER = function(e, t) {
    ...
    e[i.place++] !== 2)
        return !1;
    var o = Nn(e, i);
    if (o === !1 || e.length !== o + i.place || e[i.place] & 128)
        return !1;
...
function Vt(r) {
    if (!(this instanceof Vt))
        return new Vt(r);
    typeof r == "string" && (Yh(Object.prototype.hasOwnProperty.call(qn, r), "Unknown curve " + r),
    r = qn[r]),
    r instanceof qn.PresetCurve && (r = {
        curve: r
    }),
...
Vt.prototype.genKeyPair = function(e) {
    ...
    }), i = this.n.byteLength(), s = this.n.sub(new Jr(2)); ; ) {
...
Vt.prototype.sign = function(e, t, i, s) {
    ...
    for (var n = this.n.byteLength(), a = t.getPrivate().toArray("be", n), o = e.toArray("be", n), f = new Jh({
        hash: this.hash,
        entropy: a,
        nonce: o,
        pers: s.pers,
        persEnc: s.persEnc || "utf8"
    }), h = this.n.sub(new Jr(1)), g = 0; ; g++) {
        var y = s.k ? s.k(g) : new Jr(f.generate(this.n.byteLength()));
        if (y = this._truncateToN(y, !0),
        !(y.cmpn(1) <= 0 || y.cmp(h) >= 0)) {
            var E = this.g.mul(y);
            if (!E.isInfinity()) {
                var w = E.getX()
                  , S = w.umod(this.n);
                if (S.cmpn(0) !== 0) {
                    ...
                    $.cmpn(0) !== 0) {
                        ...
                        return s.canonical && $.cmp(this.nh) > 0 && ($ = this.n.sub($),
                        q ^= 1),
                        new gn({
                            r: S,
                            s: $,
...
Vt.prototype.verify = function(e, t, i, s) {
    ...
    var n = t.r
      , a = t.s;
    if (n.cmpn(1) < 0 || n.cmp(this.n) >= 0 || a.cmpn(1) < 0 || a.cmp(this.n) >= 0)
        return !1;
    var o = a.invm(this.n), f = o.mul(e).umod(this.n), h = o.mul(n).umod(this.n), g;
    return this.curve._maxwellTrick ? (g = this.g.jmulAdd(f, i.getPublic(), h),
    g.isInfinity() ? !1 : g.eqXToP(n)) : (g = this.g.mulAdd(f, i.getPublic(), h),
...
Vt.prototype.recoverPubKey = function(r, e, t, i) {
    ...
    h ? a = this.curve.pointFromX(a.add(this.curve.n), f) : a = this.curve.pointFromX(a, f);
    var g = e.r.invm(s)
...
gt.fromPublic = function(e, t) {
    return t instanceof gt ? t : new gt(e,{
        pub: t
    })
}
;
...
gt.prototype.sign = function(e) {
    return Xh(this._secret, "KeyPair can only verify"),
...
gt.prototype.getSecret = function(e) {
    return Xh(this._secret, "KeyPair is public only"),
    ls.encode(this.secret(), e)
}
;
...
function Zr(r, e) {
    ...
    Array.isArray(e) && (Ro(e.length === r.encodingLength * 2, "Signature has invalid size"),
    e = {
...
var up = Zr
  ...
  , $o = up;
function Ct(r) {
    if (pp(r === "ed25519", "only tested with ed25519 so far"),
    !(this instanceof Ct))
        return new Ct(r);
    r = lp[r].curve,
    this.curve = r,
...
(function(r) {
    ...
    var i = function() {
        ...
        o.prototype.update = function(f, h) {
            ...
            this._bufferLength > 0) {
                for (; this._bufferLength < r.BLOCK_SIZE && h > 0; )
                    this._buffer[this._bufferLength++] = f[g++],
                    h--;
                this._bufferLength === this.blockSize && (n(this._tempHi, this._tempLo, this._stateHi, this._stateLo, this._buffer, 0, this.blockSize),
                this._bufferLength = 0)
            }
            for (h >= this.blockSize && (g = n(this._tempHi, this._tempLo, this._stateHi, this._stateLo, f, g, h),
            h %= this.blockSize); h > 0; )
                this._buffer[this._bufferLength++] = f[g++],
                h--;
            return this
        ...
        o.prototype.finish = function(f) {
            if (!this._finished) {
                ...
                e.writeUint32BE(y, this._buffer, w - 8),
                e.writeUint32BE(E, this._buffer, w - 4),
                n(this._tempHi, this._tempLo, this._stateHi, this._stateLo, this._buffer, 0, w),
                this._finished = !0
            }
        ...
        ,
        o.prototype.restoreState = function(f) {
            return this._stateHi.set(f.stateHi),
    ...
    function n(o, f, h, g, y, E, w) {
        for (var S = h[0], $ = h[1], q = h[2], z = h[3], C = h[4], L = h[5], A = h[6], T = h[7], R = g[0], l = g[1], P = g[2], H = g[3], Y = g[4], M = g[5], c = g[6], v = g[7], d, b, _, D, x, m, u, I; w >= 128; ) {
            for (var K = 0; K < 16; K++) {
                var k = 8 * K + E;
                o[K] = e.readUint32BE(y, k),
                f[K] = e.readUint32BE(y, k + 4)
            }
            for (var K = 0; K < 80; K++) {
                var W = S
                  , V = $
                ...
                u = d & 65535,
                I = d >>> 16,
                d = (C >>> 14 | Y << 18) ^ (C >>> 18 | Y << 14) ^ (Y >>> 9 | C << 23),
                b = (Y >>> 14 | C << 18) ^ (Y >>> 18 | C << 14) ^ (C >>> 9 | Y << 23),
                x += b & 65535,
                m += b >>> 16,
                u += d & 65535,
                I += d >>> 16,
                ...
                u = d & 65535,
                I = d >>> 16,
                d = (S >>> 28 | R << 4) ^ (R >>> 2 | S << 30) ^ (R >>> 7 | S << 25),
                b = (R >>> 28 | S << 4) ^ (S >>> 2 | R << 30) ^ (S >>> 7 | R << 25),
                x += b & 65535,
                m += b >>> 16,
                u += d & 65535,
                I += d >>> 16,
                ...
                K % 16 === 15)
                    for (var k = 0; k < 16; k++)
                        ...
                        _ = o[(k + 1) % 16],
                        D = f[(k + 1) % 16],
                        d = (_ >>> 1 | D << 31) ^ (_ >>> 8 | D << 24) ^ _ >>> 7,
                        b = (D >>> 1 | _ << 31) ^ (D >>> 8 | _ << 24) ^ (D >>> 7 | _ << 25),
                        x += b & 65535,
                        m += b >>> 16,
                        u += d & 65535,
                        I += d >>> 16,
                        _ = o[(k + 14) % 16],
                        D = f[(k + 14) % 16],
                        d = (_ >>> 19 | D << 13) ^ (D >>> 29 | _ << 3) ^ _ >>> 6,
                        b = (D >>> 19 | _ << 13) ^ (_ >>> 29 | D << 3) ^ (D >>> 6 | _ << 26),
                        x += b & 65535,
                        m += b >>> 16,
                        u += d & 65535,
                        I += d >>> 16,
...
(function(r) {
    ...
    const a = s()
      , o = s([1])
      , f = s([30883, 4953, 19914, 30187, 55467, 16705, 2637, 112, 59544, 30585, 16505, 36039, 65139, 11119, 27886, 20995])
      , h = s([61785, 9906, 39828, 60374, 45398, 33411, 5274, 224, 53552, 61171, 33010, 6542, 64743, 22239, 55772, 9222])
      , g = s([54554, 36645, 11616, 51542, 42930, 38181, 51040, 26924, 56412, 64982, 57905, 49316, 21502, 52590, 14035, 8553])
      , y = s([26200, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214, 26214])
      , E = s([41136, 18958, 6951, 50414, 58488, 44335, 6150, 12099, 55207, 15867, 153, 11085, 57099, 20417, 9344, 11139]);
    function w(U, B) {
        for (let F = 0; F < 16; F++)
            U[F] = B[F] | 0
    }
    ...
    function l(U, B, F) {
        let p, N, J = 0, X = 0, me = 0, fe = 0, ce = 0, qe = 0, ve = 0, pe = 0, $e = 0, he = 0, oe = 0, xe = 0, ne = 0, se = 0, ge = 0, re = 0, ae = 0, Te = 0, ie = 0, ue = 0, Fe = 0, de = 0, le = 0, Le = 0, je = 0, ze = 0, Yt = 0, Ue = 0, He = 0, Ir = 0, Je = 0, we = F[0], Ye = F[1], _e = F[2], Ee = F[3], Ze = F[4], be = F[5], Pe = F[6], at = F[7], Me = F[8], Ae = F[9], ot = F[10], De = F[11], Se = F[12], Ke = F[13], Oe = F[14], Ce = F[15];
        p = B[0],
        J += p * we,
        X += p * Ye,
        me += p * _e,
    ...
    function k(U, B) {
        ...
        P(p, U[0]),
        l(p, p, J),
        C(p, N) ? -1 : (L(U[0]) === B[31] >> 7 && R(U[0], a, U[0]),
        l(U[3], U[0], U[1]),
        0)
    }
    function W(U, B, F) {
...
const bp = "EdDSA"
  ...
  , Ep = "K36"
  , Sp = 32
  , Ip = r => JSON.stringify(r, (e, t) => typeof t == "bigint" ? t.toString() + "n" : t)
  , xp = r => {
...
var Fp = Object.defineProperty
  ...
  , zo = (r, e) => {
    for (var t in e || (e = {}))
        qp.call(e, t) && jo(r, t, e[t]);
    if (Uo)
        for (var t of Uo(e))
            Lp.call(e, t) && jo(r, t, e[t]);
    return r
}
;
const Up = "ReactNative"
  ...
  , jp = "js";
function Js() {
    return typeof rr < "u" && typeof rr.versions < "u" && typeof rr.versions.node < "u"
}
function _i() {
...
function gs() {
    return _i() ? Nt.reactNative : Js() ? Nt.node : ps() ? Nt.browser : Nt.unknown
}
function zp() {
    var r;
    try {
        return _i() && typeof Re < "u" && typeof (Re == null ? void 0 : Re.Application) < "u" ? (r = Re.Application) == null ? void 0 : r.applicationId : void 0
    } catch {
        return
    }
}
...
function kp() {
    if (gs() === Nt.reactNative && typeof Re < "u" && typeof (Re == null ? void 0 : Re.Platform) < "u") {
...
function Hp() {
    var r;
    const e = gs();
    return e === Nt.browser ? [e, ((r = xh()) == null ? void 0 : r.host) || "unknown"].join(":") : e
}
function of(r, e, t) {
    const i = kp()
      , s = Hp();
...
function Kp({protocol: r, version: e, relayUrl: t, sdkVersion: i, auth: s, projectId: n, useOnCloseEvent: a, bundleId: o}) {
    const f = t.split("?")
      , h = of(r, e, i)
      , g = {
        auth: s,
...
async function Wp({id: r, topic: e, wcDeepLink: t}) {
    ...
    try {
        ...
        if (o === Nt.browser) {
            ...
            a.startsWith("https://") || a.startsWith("http://") ? window.open(a, "_blank", "noreferrer noopener") : window.open(a, Xp() ? "_blank" : "_self", "noreferrer noopener")
        } else
            o === Nt.reactNative && typeof (Re == null ? void 0 : Re.Linking) < "u" && await Re.Linking.openURL(a)
    } catch (s) {
        console.error(s)
    }
}
...
async function r1(r, e, t, i, s, n) {
    ...
    try {
        ...
        return console.error("isValidEip1271Signature: ", o),
        !1
    }
}
function i1() {
...
var s1 = Object.defineProperty
  ...
  , h1 = (r, e) => {
    for (var t in e || (e = {}))
        o1.call(e, t) && Ko(r, t, e[t]);
    if (Ho)
        for (var t of Ho(e))
            c1.call(e, t) && Ko(r, t, e[t]);
    return r
}
  , f1 = (r, e) => n1(r, a1(e));
const u1 = "did:pkh:"
...
const lf = (r, e) => {
    ...
    const n = `URI: ${r.aud || r.uri}`
      ...
      , w = r.resources ? `Resources:${r.resources.map($ => `
- ${$}`).join("")}` : void 0
      , S = qs(r.resources);
    if (S) {
        const $ = is(S);
    ...
    return [t, i, "", s, "", n, a, o, f, h, g, y, E, w].filter($ => $ != null).join(`
`)
}
;
function l1(r) {
...
function Yr(r) {
    ...
    e.forEach(t => {
        ...
        Object.keys(i).forEach(s => {
            ...
            n.forEach(a => {
                if (typeof a != "object")
                    throw new Error(`Ability limits (${s}) must be an array of objects, found: ${a}`)
            }
            )
        }
        )
...
function g1(r, e, t, i={}) {
    return t == null || t.sort( (s, n) => s.localeCompare(n)),
    {
        att: {
            [r]: b1(e, t, i)
        }
...
function w1(r, e) {
    Yr(r),
    Yr(e);
    const t = Object.keys(r.att).concat(Object.keys(e.att)).sort( (s, n) => s.localeCompare(n))
      , i = {
        att: {}
    };
    return t.forEach(s => {
        var n, a;
        Object.keys(((n = r.att) == null ? void 0 : n[s]) || {}).concat(Object.keys(((a = e.att) == null ? void 0 : a[s]) || {})).sort( (o, f) => o.localeCompare(f)).forEach(o => {
            var f, h;
            i.att[s] = f1(h1({}, i.att[s]), {
                [o]: ((f = r.att[s]) == null ? void 0 : f[o]) || ((h = e.att[s]) == null ? void 0 : h[o])
            })
        }
        )
    }
...
function _1(r="", e) {
    ...
    Object.keys(e.att).forEach(o => {
        ...
        const h = {};
        f.forEach(y => {
            h[y.ability] || (h[y.ability] = []),
            h[y.ability].push(y.action)
        }
        );
        const g = Object.keys(h).map(y => (s++,
        `(${s}) '${y}': '${h[y].join("', '")}' for '${o}'.`));
...
function S1() {
    ...
    return {
        privateKey: pt(r.secretKey, Dt),
        publicKey: pt(r.publicKey, Dt)
    }
}
function fa() {
...
function yf(r) {
    ...
    if (Xr(r.type) === vs)
        return pt(Ns([r.type, r.sealed]), e);
    if (Xr(r.type) === Er) {
...
function A1(r, e) {
    ...
    return mf({
        type: Xr(t.type),
        senderPublicKey: typeof t.senderPublicKey < "u" ? pt(t.senderPublicKey, Dt) : void 0,
...
function Yo(r) {
    return r.type === Er && typeof r.senderPublicKey == "string" && typeof r.receiverPublicKey == "string"
}
function Xo(r) {
    return r.type === vs
}
...
var N1 = Object.defineProperty
  ...
  , ec = (r, e) => {
    for (var t in e || (e = {}))
        L1.call(e, t) && Zo(r, t, e[t]);
    if (Qo)
        for (var t of Qo(e))
            U1.call(e, t) && Zo(r, t, e[t]);
    return r
}
  , j1 = (r, e) => F1(r, q1(e));
function z1(r, e="-") {
...
function rc(r) {
    return `${r.protocol}:${r.topic}@${r.version}?` + rs.stringify(ec(j1(ec({
        symKey: r.symKey
    }, k1(r.relay)), {
...
function tg(r, e) {
    let t = null;
    return ct(r == null ? void 0 : r.publicKey, !1) || (t = Q("MISSING_OR_INVALID", `${e} controller public key should be a string`)),
    t
}
function sc(r) {
    let e = !0;
    return dr(r) ? r.length && (e = r.every(t => ct(t, !1))) : e = !1,
    e
}
function rg(r, e, t) {
    let i = null;
    return dr(e) && e.length ? e.forEach(s => {
        i || Xs(s) || (i = ke("UNSUPPORTED_CHAINS", `${t}, chain ${s} should be a string and conform to "namespace:chainId" format`))
    }
    ) : Xs(r) || (i = ke("UNSUPPORTED_CHAINS", `${t}, chains must be defined as "namespace:chainId" e.g. "eip155:1": {...} in the namespace key OR as an array of CAIP-2 chainIds e.g. eip155: { chains: ["eip155:1", "eip155:5"] }`)),
    i
}
function ig(r, e, t) {
    let i = null;
...
function sg(r, e) {
    let t = null;
    return dr(r) ? r.forEach(i => {
        t || X1(i) || (t = ke("UNSUPPORTED_ACCOUNTS", `${e}, account ${i} should be a string and conform to "namespace:chainId:address" format`))
    }
    ) : t = ke("UNSUPPORTED_ACCOUNTS", `${e}, accounts should be an array of strings conforming to "namespace:chainId:address" format`),
    t
}
function ng(r, e) {
    let t = null;
...
function ag(r, e) {
    let t = null;
    return sc(r == null ? void 0 : r.methods) ? sc(r == null ? void 0 : r.events) || (t = ke("UNSUPPORTED_EVENTS", `${e}, events should be an array of strings or empty array for no events`)) : t = ke("UNSUPPORTED_METHODS", `${e}, methods should be an array of strings or empty array for no methods`),
    t
}
function wf(r, e) {
    let t = null;
...
function Ln(r, e) {
    ...
    if (r && ns(r)) {
        ...
        t = Q("MISSING_OR_INVALID", `${e}, namespaces should be an object with data`);
    return t
}
function _f(r) {
...
function cg(r, e) {
    let t = !1;
    return r ? r && dr(r) && r.length && r.forEach(i => {
        t = _f(i)
    }
    ) : t = !0,
    t
...
function fg(r) {
    return !(!r || typeof r != "object" || !r.code || !Ha(r.code) || !r.message || !ct(r.message, !1))
}
function ug(r) {
    return !(Ot(r) || !ct(r.method, !1))
}
function dg(r) {
    return !(Ot(r) || Ot(r.result) && Ot(r.error) || !Ha(r.id) || !ct(r.jsonrpc, !1))
}
function lg(r) {
...
function ac(r, e, t) {
    ...
    return g.length && (i = Q("NON_CONFORMING_NAMESPACES", `${t} namespaces keys don't satisfy requiredNamespaces.
      Required: ${g.toString()}
      Received: ${Object.keys(e).toString()}`)),
    Vr(a, o) || (i = Q("NON_CONFORMING_NAMESPACES", `${t} namespaces chains don't satisfy required namespaces.
      Required: ${a.toString()}
      Approved: ${o.toString()}`)),
    Object.keys(e).forEach(y => {
        ...
        E.includes(y) || (i = Q("NON_CONFORMING_NAMESPACES", `${t} namespaces accounts don't satisfy namespace accounts for ${y}
        Required: ${y}
        Approved: ${E.toString()}`))
    }
    ),
    a.forEach(y => {
        i || (Vr(s[y].methods, n[y].methods) ? Vr(s[y].events, n[y].events) || (i = Q("NON_CONFORMING_NAMESPACES", `${t} namespaces events don't satisfy namespace events for ${y}`)) : i = Q("NON_CONFORMING_NAMESPACES", `${t} namespaces methods don't satisfy namespace methods for ${y}`))
    }
    ),
    i
}
...
function Sg(r) {
    !_i() && ps() && (window.addEventListener("online", () => r(!0)),
    window.addEventListener("offline", () => r(!1)))
}
function Ig(r) {
    var e;
    _i() && typeof Re < "u" && Re != null && Re.NetInfo && ((e = Re) == null || e.NetInfo.addEventListener(t => r(t == null ? void 0 : t.isConnected)))
}
const Un = {};
class Ki {
    static get(e) {
...
;
const Pg = /"(?:_|\\u0{2}5[Ff]){2}(?:p|\\u0{2}70)(?:r|\\u0{2}72)(?:o|\\u0{2}6[Ff])(?:t|\\u0{2}74)(?:o|\\u0{2}6[Ff])(?:_|\\u0{2}5[Ff]){2}"\s*:/
  , Mg = /"(?:c|\\u0063)(?:o|\\u006[Ff])(?:n|\\u006[Ee])(?:s|\\u0073)(?:t|\\u0074)(?:r|\\u0072)(?:u|\\u0075)(?:c|\\u0063)(?:t|\\u0074)(?:o|\\u006[Ff])(?:r|\\u0072)"\s*:/
...
function Fg(r) {
    return typeof r != "string" || !r.startsWith(da) ? r : (Sf(),
    Kt.from(r.slice(da.length), "base64"))
}
function Mt(r) {
...
function jg(r={}) {
    const e = {
      ...
      , i = (h, g) => e.mountpoints.filter(y => y.startsWith(h) || g && h.startsWith(y)).map(y => ({
      ...
      , n = async () => {
        if (!e.watching) {
            ...
            for (const h in e.mounts)
                e.unwatch[h] = await fc(e.mounts[h], s, h)
        }
    }
      , a = async () => {
        if (e.watching) {
      ...
      , o = (h, g, y) => {
        ...
        return Promise.all([...E.values()].map(S => y(S))).then(S => S.flat())
    }
      , f = {
        hasItem(h, g={}) {
            h = Mt(h);
        ...
        getItems(h, g) {
            return o(h, g, y => y.driver.getItems ? dt(y.driver.getItems, y.items.map(E => ({
                key: E.relativeKey,
                options: E.options
            })), g).then(E => E.map(w => ({
                key: qg(y.base, w.key),
                value: As(w.value)
            }))) : Promise.all(y.items.map(E => dt(y.driver.getItem, E.relativeKey, E.options).then(w => ({
                key: E.key,
                value: As(w)
            })))))
        },
        getItemRaw(h, g={}) {
            h = Mt(h);
            const {relativeKey: y, driver: E} = t(h);
            return E.getItemRaw ? dt(E.getItemRaw, y, g) : dt(E.getItem, y, g).then(w => Fg(w))
        },
        async setItem(h, g, y={}) {
            if (g === void 0)
            ...
            w.setItem && (await dt(w.setItem, E, Us(g), y),
            w.watch || s("update", h))
        },
        async setItems(h, g) {
            await o(h, g, async y => {
                if (y.driver.setItems)
                    return dt(y.driver.setItems, y.items.map(E => ({
                        key: E.relativeKey,
                        value: Us(E.value),
                        options: E.options
                    })), g);
                y.driver.setItem && await Promise.all(y.items.map(E => dt(y.driver.setItem, E.relativeKey, Us(E.value), E.options)))
            }
            )
        },
        async setItemRaw(h, g, y={}) {
            if (g === void 0)
                return f.removeItem(h, y);
            h = Mt(h);
            const {relativeKey: E, driver: w} = t(h);
            if (w.setItemRaw)
                await dt(w.setItemRaw, E, g, y);
            else if (w.setItem)
                await dt(w.setItem, E, Ng(g), y);
            else
                return;
            w.watch || s("update", h)
        },
        async removeItem(h, g={}) {
            ...
            h = Mt(h);
            const {relativeKey: y, driver: E} = t(h);
            E.removeItem && (await dt(E.removeItem, y, g),
            (g.removeMeta || g.removeMata) && await dt(E.removeItem, y + "$", g),
            E.watch || s("remove", h))
        },
        async getMeta(h, g={}) {
            typeof g == "boolean" && (g = {
            ...
            if (E.getMeta && Object.assign(w, await dt(E.getMeta, y, g)),
            !g.nativeOnly) {
                const S = await dt(E.getItem, y + "$", g).then($ => As($));
                S && typeof S == "object" && (typeof S.atime == "string" && (S.atime = new Date(S.atime)),
        ...
        async getKeys(h, g={}) {
            ...
            return h ? w.filter(S => S.startsWith(h) && S[S.length - 1] !== "$") : w.filter(S => S[S.length - 1] !== "$")
        },
        async clear(h, g={}) {
            h = Os(h),
            await Promise.all(i(h, !1).map(async y => {
                if (y.driver.clear)
                    return dt(y.driver.clear, y.relativeBase, g);
        ...
        mount(h, g) {
            ...
            e.mounts[h] = g,
            e.watching && Promise.resolve(fc(g, s, h)).then(y => {
                e.unwatch[h] = y
            }
            ).catch(console.error),
            f
...
let jn;
function ys() {
    return jn || (jn = If("keyval-store", "keyval")),
    jn
}
function dc(r, e=ys()) {
...
function zg(r, e, t=ys()) {
    return t("readwrite", i => (i.put(e, r),
    ti(i.transaction)))
}
function Bg(r, e=ys()) {
...
function Kg(r=ys()) {
    return r("readonly", e => {
        if (e.getAllKeys)
            return ti(e.getAllKeys());
        const t = [];
        return Hg(e, i => t.push(i.key)).then( () => t)
    }
    )
}
const Vg = r => JSON.stringify(r, (e, t) => typeof t == "bigint" ? t.toString() + "n" : t)
  , Gg = r => {
    const e = /([\[:])?(\d{17,}|(?:[9](?:[1-9]07199254740991|0[1-9]7199254740991|00[8-9]199254740991|007[2-9]99254740991|007199[3-9]54740991|0071992[6-9]4740991|00719925[5-9]740991|007199254[8-9]40991|0071992547[5-9]0991|00719925474[1-9]991|00719925474099[2-9])))([,\}\]])/g
      , t = r.replace(e, '$1"$2n"$3');
    return JSON.parse(t, (i, s) => typeof s == "string" && s.match(/^\d+n$/) ? BigInt(s.substring(0, s.length - 1)) : s)
...
var Jg = (r={}) => {
    const e = r.base && r.base.length > 0 ? `${r.base}:` : ""
      , t = s => e + s;
    let i;
    return r.dbName && r.storeName && (i = If(r.dbName, r.storeName)),
    {
        name: Wg,
        options: r,
        async hasItem(s) {
...
;
var zn = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof Re < "u" ? Re : typeof self < "u" ? self : {}
  , js = {
    exports: {}
};
(function() {
    ...
    typeof zn < "u" && zn.localStorage ? js.exports = zn.localStorage : typeof window < "u" && window.localStorage ? js.exports = window.localStorage : js.exports = new e
}
)();
function Zg(r) {
    var e;
...
function ob(r, e, t) {
    ...
    if (f === 0)
        return r;
    for (var h = "", g = 1 - s, y = -1, E = r && r.length || 0, w = 0; w < E; ) {
...
function ur(r) {
    ...
    Array.isArray(r.browser.serialize) && r.browser.serialize.indexOf("!stdSerializers.err") > -1 && (n = !1);
    ...
    f.levels = ur.levels,
    f.level = o,
    f.setMaxListeners = f.getMaxListeners = f.emit = f.addListener = f.on = f.prependListener = f.once = f.prependOnceListener = f.removeListener = f.removeAllListeners = f.listeners = f.listenerCount = f.eventNames = f.write = f.flush = os,
    f.serializers = i,
    f._serialize = s,
    ...
    function w(S, $) {
        ...
        if (s && q) {
            ...
            delete S.serializers,
            mn([S], C, z, this._stdErrSerialize)
        }
        function L(A) {
...
function oi(r, e, t, i) {
    ...
    e[t] = e.levelVal > e.levels.values[t] ? os : s[t] ? s[t] : as[t] || as[i] || os,
    fb(r, e, t)
}
function fb(r, e, t) {
    !r.transmit && e[t] === os || (e[t] = function(i) {
        return function() {
            const n = r.timestamp()
              , a = new Array(arguments.length)
              , o = Object.getPrototypeOf && Object.getPrototypeOf(this) === as ? as : this;
            for (var f = 0; f < a.length; f++)
                a[f] = arguments[f];
            if (r.serialize && !r.asObject && mn(a, this._serialize, this.serializers, this._stdErrSerialize),
...
function ub(r, e, t, i) {
    ...
    const a = {};
    i && (a.time = i),
    a.level = ur.levels.values[e];
    let o = (r._childLevel | 0) + 1;
    if (o < 1 && (o = 1),
    n !== null && typeof n == "object") {
        for (; o-- && typeof s[0] == "object"; )
            Object.assign(a, s.shift());
        n = s.length ? pc(s.shift(), s) : void 0
    } else
        typeof n == "string" && (n = pc(s.shift(), s));
    return n !== void 0 && (a.msg = n),
    a
}
function mn(r, e, t, i) {
    for (const s in r)
        if (i && r[s]instanceof Error)
            r[s] = ur.stdSerializers.err(r[s]);
...
function db(r, e, t) {
    ...
    mn(t, r._serialize || Object.keys(r.serializers), r.serializers, r._stdErrSerialize === void 0 ? !0 : r._stdErrSerialize),
    r._logEvent.ts = s,
...
function pb(r) {
    return typeof r.timestamp == "function" ? r.timestamp : r.timestamp === !1 ? Pf : Mf
}
function Cs() {
    return {}
}
...
const ms = xa(fi)
  , yb = r => JSON.stringify(r, (e, t) => typeof t == "bigint" ? t.toString() + "n" : t);
function gc(r) {
...
let wb = class {
  ...
  , Af = class {
    ...
    forwardToConsole(e, t) {
        t === fi.levels.values.error ? console.error(e) : t === fi.levels.values.warn ? console.warn(e) : t === fi.levels.values.debug ? console.debug(e) : t === fi.levels.values.trace ? console.trace(e) : console.log(e)
    }
    appendToLogs(e) {
        this.logs.append(gc({
...
var Sb = Object.defineProperty
  ...
  , Qs = (r, e) => {
    for (var t in e || (e = {}))
        Db.call(e, t) && yc(r, t, e[t]);
    if (vc)
        for (var t of vc(e))
            Pb.call(e, t) && yc(r, t, e[t]);
    return r
}
  , Zs = (r, e) => Ib(r, xb(e));
function wn(r) {
    return Zs(Qs({}, r), {
        level: (r == null ? void 0 : r.level) || mb.level
    })
}
function Mb(r, e=ws) {
    return r[e] || ""
...
function Tt(r, e=ws) {
    let t = "";
    return typeof r.bindings > "u" ? t = Mb(r, e) : t = r.bindings().context || "",
    t
}
...
;
const Kb = r => JSON.stringify(r, (e, t) => typeof t == "bigint" ? t.toString() + "n" : t)
  , Vb = r => {
    const e = /([\[:])?(\d{17,}|(?:[9](?:[1-9]07199254740991|0[1-9]7199254740991|00[8-9]199254740991|007[2-9]99254740991|007199[3-9]54740991|0071992[6-9]4740991|00719925[5-9]740991|007199254[8-9]40991|0071992547[5-9]0991|00719925474[1-9]991|00719925474099[2-9])))([,\}\]])/g
      , t = r.replace(e, '$1"$2n"$3');
    return JSON.parse(t, (i, s) => typeof s == "string" && s.match(/^\d+n$/) ? BigInt(s.substring(0, s.length - 1)) : s)
...
function cs(r) {
    return this instanceof cs ? (this.v = r,
    this) : new cs(r)
}
function dv(r, e, t) {
    if (!Symbol.asyncIterator)
    ...
    function f(E) {
        E.value instanceof cs ? Promise.resolve(E.value.v).then(h, g) : y(n[0][2], E)
    }
    function h(E) {
        o("next", E)
    }
...
function pv(r) {
    if (!Symbol.asyncIterator)
        throw new TypeError("Symbol.asyncIterator is not defined.");
    var e = r[Symbol.asyncIterator], t;
    return e ? e.call(r) : (r = typeof ba == "function" ? ba(r) : r[Symbol.iterator](),
    t = {},
    i("next"),
    i("throw"),
    i("return"),
...
const wv = Object.freeze(Object.defineProperty({
    __proto__: null,
    get __assign() {
        return ga
    },
...
function Ev() {
    ...
    vr.isBrowserCryptoAvailable = vr.getSubtleCrypto = vr.getBrowerCrypto = void 0;
    function r() {
        return (Ht === null || Ht === void 0 ? void 0 : Ht.crypto) || (Ht === null || Ht === void 0 ? void 0 : Ht.msCrypto) || {}
    }
    ...
    return vr.isBrowserCryptoAvailable = t,
    vr
}
var yr = {}, Ec;
function Sv() {
...
function Iv(r, e) {
    return typeof r > "u" ? wc(Of) : (typeof r == "string" && (r = Object.assign(Object.assign({}, wc(Va)), {
        message: r
    })),
...
let sr = class extends Pv {
    ...
    async request(e, t) {
        return this.requestStrict(Tr(e.method, e.params || [], e.id || Gr().toString()), t)
    }
    ...
    onPayload(e) {
        ...
        Sn(e) ? this.events.emit(`${e.id}`, e) : this.events.emit("message", {
            type: e.method,
            data: e.params
        })
    }
...
;
const Tv = r => JSON.stringify(r, (e, t) => typeof t == "bigint" ? t.toString() + "n" : t)
  , Rv = r => {
    const e = /([\[:])?(\d{17,}|(?:[9](?:[1-9]07199254740991|0[1-9]7199254740991|00[8-9]199254740991|007[2-9]99254740991|007199[3-9]54740991|0071992[6-9]4740991|00719925[5-9]740991|007199254[8-9]40991|0071992547[5-9]0991|00719925474[1-9]991|00719925474099[2-9])))([,\}\]])/g
      , t = r.replace(e, '$1"$2n"$3');
    return JSON.parse(t, (i, s) => typeof s == "string" && s.match(/^\d+n$/) ? BigInt(s.substring(0, s.length - 1)) : s)
...
const Fv = () => typeof WebSocket < "u" ? WebSocket : typeof Re < "u" && typeof Re.WebSocket < "u" ? Re.WebSocket : typeof window < "u" && typeof window.WebSocket < "u" ? window.WebSocket : typeof self < "u" && typeof self.WebSocket < "u" ? self.WebSocket : require("ws")
  , qv = () => typeof WebSocket < "u" || typeof Re < "u" && typeof Re.WebSocket < "u" || typeof window < "u" && typeof window.WebSocket < "u" || typeof self < "u" && typeof self.WebSocket < "u"
  , xc = r => r.split("?")[0]
  , Dc = 10
  , Lv = Fv();
let Uv = class {
    ...
    emitError(e) {
        const t = this.parseError(new Error((e == null ? void 0 : e.message) || `WebSocket connection failed for host: ${xc(this.url)}`));
...
(function(r, e) {
    ...
    V[o] = V[f] = V[M] = V[g] = V[c] = V[y] = V[E] = V[w] = V[$] = V[q] = V[C] = V[T] = V[R] = V[l] = V[Y] = !1;
    var ee = typeof Ht == "object" && Ht && Ht.Object === Object && Ht
      ...
      , me = X && X.isTypedArray;
    function fe(O, j) {
        for (var G = -1, te = O == null ? 0 : O.length, Xe = 0, Ie = []; ++G < te; ) {
            var it = O[G];
            j(it, G, O) && (Ie[Xe++] = it)
        }
        return Ie
    ...
    function ce(O, j) {
        for (var G = -1, te = j.length, Xe = O.length; ++G < te; )
            O[Xe + G] = j[G];
        return O
    }
    function qe(O, j) {
    ...
    function oe(O) {
        var j = -1
          , G = Array(O.size);
        return O.forEach(function(te, Xe) {
            G[++j] = [Xe, te]
        }),
        G
    }
    ...
    var se = Array.prototype
      ...
      , Fe = re.toString
      , de = RegExp("^" + Te.call(ie).replace(K, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$")
    ...
    function Di(O) {
        ...
        if (G < 0)
            return !1;
        var te = j.length - 1;
        return G == te ? j.pop() : Yt.call(j, G, 1),
        --this.size,
        !0
    }
    function Pi(O) {
    ...
    function xr(O) {
        var j = -1
          , G = O == null ? 0 : O.length;
        for (this.__data__ = new Xt; ++j < G; )
            this.add(O[j])
    }
    function Ni(O) {
        return this.__data__.set(O, i),
        this
    }
    function Fi(O) {
        return this.__data__.has(O)
    }
    xr.prototype.add = xr.prototype.push = Ni,
    xr.prototype.has = Fi;
    function Lt(O) {
    ...
    function fu(O, j) {
        var G = xs(O)
          ...
          , yt = ft.length;
        for (var et in O)
            ie.call(O, et) && !(it && (et == "length" || Xe && (et == "offset" || et == "parent") || Ie && (et == "buffer" || et == "byteLength" || et == "byteOffset") || wu(et, yt))) && ft.push(et);
        return ft
    }
    function Ss(O, j) {
    ...
    function ji(O) {
        return O == null ? O === void 0 ? H : z : Ue && Ue in Object(O) ? yu(O) : Iu(O)
    }
    function Qa(O) {
        return zi(O) && ji(O) == o
    }
    function Za(O, j, G, te, Xe) {
        return O === j ? !0 : O == null || j == null || !zi(O) && !zi(j) ? O !== O && j !== j : du(O, j, G, te, Za, Xe)
    }
    ...
    function gu(O) {
        ...
        for (var G in Object(O))
            ie.call(O, G) && G != "constructor" && j.push(G);
        return j
    }
    function eo(O, j, G, te, Xe, Ie) {
        ...
        Ie.set(j, O); ++$t < ft; ) {
            var Ut = O[$t]
              , jt = j[$t];
            if (te)
                var Pr = it ? te(jt, Ut, $t, j, O, Ie) : te(Ut, jt, $t, O, j, Ie);
            if (Pr !== void 0) {
                if (Pr)
                    continue;
                Qt = !1;
    ...
    function vu(O, j, G, te, Xe, Ie) {
        ...
        for (var Pr = it; ++Qt < yt; ) {
            ...
            var br = O[Et]
              , Lr = j[Et];
            if (te)
                var oo = it ? te(Lr, br, Et, j, O, Ie) : te(br, Lr, Et, O, j, Ie);
        ...
        if (jt && !Pr) {
            var Ds = O.constructor
              , Ps = j.constructor;
            Ds != Ps && "constructor"in O && "constructor"in j && !(typeof Ds == "function" && Ds instanceof Ds && typeof Ps == "function" && Ps instanceof Ps) && (jt = !1)
        }
        return Ie.delete(O),
        Ie.delete(j),
        jt
    ...
    function yu(O) {
        ...
        var Xe = Fe.call(O);
        return te && (j ? O[Ue] = G : delete O[Ue]),
        Xe
    }
    var mu = He ? function(O) {
    ...
    : Au
      , Dr = ji;
    (we && Dr(new we(new ArrayBuffer(1))) != c || Ye && Dr(new Ye) != $ || _e && Dr(_e.resolve()) != L || Ee && Dr(new Ee) != R || Ze && Dr(new Ze) != Y) && (Dr = function(O) {
        var j = ji(O)
    ...
    function wu(O, j) {
        return j = j ?? a,
        !!j && (typeof O == "number" || W.test(O)) && O > -1 && O % 1 == 0 && O < j
    }
    function _u(O) {
        var j = typeof O;
...
Qe.getLocalStorage = Qe.getLocalStorageOrThrow = Qe.getCrypto = Qe.getCryptoOrThrow = Qe.getLocation = Qe.getLocationOrThrow = Qe.getNavigator = Qe.getNavigatorOrThrow = qf = Qe.getDocument = Qe.getDocumentOrThrow = Qe.getFromWindowOrThrow = Qe.getFromWindow = void 0;
function ri(r) {
    let e;
    return typeof window < "u" && typeof window[r] < "u" && (e = window[r]),
    e
...
const In = ({name: r, prefix: e, encode: t, decode: i}) => new zy(r,e,t,i)
  ...
  , _t = ({name: r, prefix: e, bitsPerChar: t, alphabet: i}) => In({
    prefix: e,
    name: r,
    encode(s) {
        return ky(s, i, t)
...
const Kf = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂")
  , Em = Kf.reduce( (r, e, t) => (r[t] = e,
r), [])
  , Sm = Kf.reduce( (r, e, t) => (r[e.codePointAt(0)] = t,
r), []);
function Im(r) {
    return r.reduce( (e, t) => (e += Em[t],
    e), "")
}
function xm(r) {
    const e = [];
...
var $m = Math.pow(2, 7)
  ...
  , Bm = Math.pow(2, 63)
  , km = function(r) {
    return r < $m ? 1 : r < Nm ? 2 : r < Fm ? 3 : r < qm ? 4 : r < Lm ? 5 : r < Um ? 6 : r < jm ? 7 : r < zm ? 8 : r < Bm ? 9 : 10
}
  , Hm = {
    encode: Mm,
    decode: Tm,
  ...
  , Gf = Hm;
const Cc = (r, e, t=0) => (Gf.encode(r, e, t),
e)
...
class Vm {
    ...
    digest(e) {
        if (e instanceof Uint8Array) {
            ...
            return t instanceof Uint8Array ? ma(this.code, t) : t.then(i => ma(this.code, i))
        } else
            throw Error("Unknown type, must be binary type")
    }
}
...
const $c = Qf("utf8", "u", r => "u" + new TextDecoder("utf8").decode(r), r => new TextEncoder().encode(r.substring(1)))
  , kn = Qf("ascii", "a", r => {
    let e = "a";
    for (let t = 0; t < r.length; t++)
        e += String.fromCharCode(r[t]);
...
class i3 {
    constructor(e, t) {
        ...
        ,
        this.has = i => (this.isInitialized(),
        this.keychain.has(i)),
        this.set = async (i, s) => {
            this.isInitialized(),
            this.keychain.set(i, s),
            await this.persist()
        }
        ,
        this.get = i => {
...
let s3 = class {
    constructor(e, t, i) {
        ...
        ,
        this.hasKeys = s => (this.isInitialized(),
        this.keychain.has(s)),
        ...
        this.setSymKey = async (s, n) => {
            this.isInitialized();
            const a = n || Ls(s);
            return await this.keychain.set(a, s),
            a
        }
        ,
        ...
        this.encode = async (s, n, a) => {
            ...
            const o = mf(a)
              , f = Gb(n);
            if (Xo(o))
                return D1(f, a == null ? void 0 : a.encoding);
            if (Yo(o)) {
...
class a3 extends qb {
    constructor(e, t) {
        ...
        this.publish = async (i, s, n) => {
            ...
            try {
                for (; $ === void 0; ) {
                    if (Date.now() - S > this.publishTimeout)
                        throw new Error(w);
                    this.logger.trace({
                        id: y,
                        attempts: q
                    }, `publisher.publish - attempt ${q}`),
                    $ = await await gi(this.rpcPublish(i, s, o, f, h, g, y, n == null ? void 0 : n.attestation).catch(z => this.logger.warn(z)), this.publishTimeout, w),
                    q++,
                    $ || await new Promise(z => setTimeout(z, this.failedPublishTimeout))
                }
                ...
                this.logger.error(z),
                (a = n == null ? void 0 : n.internal) != null && a.throwOnFailedPublish)
                    throw z;
                this.queue.set(y, E)
            }
        }
    ...
    rpcPublish(e, t, i, s, n, a, o, f) {
        ...
        return Ot((h = w.params) == null ? void 0 : h.prompt) && ((g = w.params) == null || delete g.prompt),
        Ot((y = w.params) == null ? void 0 : y.tag) && ((E = w.params) == null || delete E.tag),
...
var c3 = Object.defineProperty
  ...
  , Wi = (r, e) => {
    for (var t in e || (e = {}))
        u3.call(e, t) && Fc(r, t, e[t]);
    if (Nc)
        for (var t of Nc(e))
            d3.call(e, t) && Fc(r, t, e[t]);
    return r
}
  , Hn = (r, e) => h3(r, f3(e));
class l3 extends jb {
    constructor(e, t) {
        ...
        this.subscribe = async (i, s) => {
            ...
            try {
                ...
                return typeof o == "string" && (this.onSubscribe(o, a),
        ...
        this.unsubscribe = async (i, s) => {
            ...
            this.isInitialized(),
            typeof (s == null ? void 0 : s.id) < "u" ? await this.unsubscribeById(i, s.id, s) : await this.unsubscribeByTopic(i, s)
        }
        ,
        this.isSubscribed = async i => {
            ...
            return await new Promise( (n, a) => {
                ...
                o.start(s);
                const f = setInterval( () => {
                    !this.pending.has(i) && this.topics.includes(i) && (clearInterval(f),
                    o.stop(s),
                    n(!0)),
                    o.elapsed(s) >= by && (clearInterval(f),
                    o.stop(s),
    ...
    async rpcSubscribe(e, t, i) {
        var s;
        (i == null ? void 0 : i.transportType) === Ve.relay && await this.restartToComplete();
        const n = {
            method: Yi(t.protocol).subscribe,
            params: {
                topic: e
            }
        };
        ...
        const a = (s = i == null ? void 0 : i.internal) == null ? void 0 : s.throwOnFailedPublish;
        try {
            ...
            if ((i == null ? void 0 : i.transportType) === Ve.link_mode)
                ...
                o;
            const f = await gi(this.relayer.request(n).catch(h => this.logger.warn(h)), this.subscribeTimeout, `Subscribing to ${e} failed, please try again`);
            if (!f && a)
    ...
    async rpcBatchSubscribe(e) {
        ...
        try {
            return await await gi(this.relayer.request(i).catch(s => this.logger.warn(s)), this.subscribeTimeout)
        } catch {
            this.relayer.events.emit(xt.connection_stalled)
        }
    }
    async rpcBatchFetchMessages(e) {
        ...
        let s;
        try {
            s = await await gi(this.relayer.request(i).catch(n => this.logger.warn(n)), this.subscribeTimeout)
        } catch {
            this.relayer.events.emit(xt.connection_stalled)
        }
        return s
    ...
    onSubscribe(e, t) {
        this.setSubscription(e, Hn(Wi({}, t), {
            id: e
        })),
    ...
    onBatchSubscribe(e) {
        e.length && e.forEach(t => {
            this.setSubscription(t.id, Wi({}, t)),
            this.pending.delete(t.topic)
        }
        )
    }
    ...
    deleteSubscription(e, t) {
        ...
        this.events.emit(fr.deleted, Hn(Wi({}, i), {
            reason: t
        }))
    }
    async persist() {
    ...
    async reset() {
        if (this.cached.length) {
            ...
            for (let t = 0; t < e; t++) {
                ...
                await this.batchFetchMessages(i),
    ...
    async batchSubscribe(e) {
        ...
        dr(t) && this.onBatchSubscribe(t.map( (i, s) => Hn(Wi({}, e[s]), {
            id: i
        })))
    }
    ...
    async checkPending() {
        ...
        this.pendingBatchMessages.length && (await this.relayer.handleBatchMessageEvents(this.pendingBatchMessages),
        this.pendingBatchMessages = [])
    }
    registerEventListeners() {
...
var p3 = Object.defineProperty
  ...
  , Uc = (r, e) => {
    for (var t in e || (e = {}))
        g3.call(e, t) && Lc(r, t, e[t]);
    if (qc)
        for (var t of qc(e))
            b3.call(e, t) && Lc(r, t, e[t]);
    return r
}
;
class v3 extends Lb {
    constructor(e) {
        ...
        this.heartBeatTimeout = Z.toMiliseconds(Z.THIRTY_SECONDS + Z.ONE_SECOND),
        this.request = async t => {
            ...
            try {
                ...
                const o = await new Promise(async (f, h) => {
                    ...
                    const y = await a;
                    this.provider.off(zt.disconnect, g),
                    f(y)
                }
                );
        ...
        ,
        this.core = e.core,
        this.logger = typeof e.logger < "u" && typeof e.logger != "string" ? Pt(e.logger, this.name) : ms(wn({
            level: e.logger || cy
        })),
    ...
    async subscribe(e, t) {
        var i, s, n;
        this.isInitialized(),
        (t == null ? void 0 : t.transportType) === "relay" && await this.toEstablishConnection();
        const a = typeof ((i = t == null ? void 0 : t.internal) == null ? void 0 : i.throwOnFailedPublish) > "u" ? !0 : (s = t == null ? void 0 : t.internal) == null ? void 0 : s.throwOnFailedPublish;
        let o = ((n = this.subscriber.topicMap.get(e)) == null ? void 0 : n[0]) || "", f;
        const h = g => {
            g.topic === e && (this.subscriber.off(fr.created, h),
            f())
        }
        ;
        return await Promise.all([new Promise(g => {
            f = g,
            this.subscriber.on(fr.created, h)
        }
        ), new Promise(async (g, y) => {
            o = await this.subscriber.subscribe(e, Uc({
                internal: {
    ...
    async transportDisconnect() {
        ...
        this.hasExperiencedNetworkDisruption || this.connected ? await gi(this.provider.disconnect(), 2e3, "provider.disconnect()").catch( () => this.onProviderDisconnect()) : this.onProviderDisconnect()
    }
    ...
    async transportOpen(e) {
        ...
        try {
            await new Promise(async (t, i) => {
                ...
                await gi(this.provider.connect(), Z.toMiliseconds(Z.ONE_MINUTE), `Socket stalled when trying to connect to ${this.relayUrl}`).catch(n => {
                    i(n)
                }
                ).finally( () => {
            ...
            this.logger.error(t);
            const i = t;
            if (this.hasExperiencedNetworkDisruption = !0,
    ...
    startPingTimeout() {
        ...
        if (Js())
            try {
                (t = (e = this.provider) == null ? void 0 : e.connection) != null && t.socket && ((n = (s = (i = this.provider) == null ? void 0 : i.connection) == null ? void 0 : s.socket) == null || n.once("ping", () => {
                    this.resetPingTimeout()
                }
                )),
                this.resetPingTimeout()
    ...
    async createProvider() {
        ...
        this.provider = new sr(new Uv(Kp({
            sdkVersion: va,
    ...
    async shouldIgnoreMessageEvent(e) {
        ...
        return s && this.logger.debug(`Ignoring duplicate message: ${i}`),
        s
    }
    async onProviderPayload(e) {
        ...
        Ga(e)) {
            ...
            Sn(e) && this.events.emit(xt.message_ack, e)
    }
    async onMessageEvent(e) {
        await this.shouldIgnoreMessageEvent(e) || (this.events.emit(xt.message, e),
        await this.recordMessageEvent(e))
    }
    ...
    async registerEventListeners() {
        ...
        Eg(async t => {
            e !== t && (e = t,
            t ? await this.restartTransport().catch(i => this.logger.error(i)) : (this.hasExperiencedNetworkDisruption = !0,
            await this.transportDisconnect(),
            this.transportExplicitlyClosed = !1))
        }
        )
    ...
    async onProviderDisconnect() {
        ...
        this.connectionAttemptInProgress = !1,
        !this.transportExplicitlyClosed && (this.reconnectTimeout || (this.reconnectTimeout = setTimeout(async () => {
    ...
    async toEstablishConnection() {
        await this.confirmOnlineStateOrThrow(),
        !this.connected && (this.connectionAttemptInProgress && await new Promise(e => {
            const t = setInterval( () => {
...
var y3 = Object.defineProperty
  ...
  , Bc = (r, e) => {
    for (var t in e || (e = {}))
        m3.call(e, t) && zc(r, t, e[t]);
    if (jc)
        for (var t of jc(e))
            w3.call(e, t) && zc(r, t, e[t]);
    return r
}
;
class ii extends Ub {
    constructor(e, t, i, s=lr, n=void 0) {
        ...
        this.init = async () => {
            ...
            this.cached.forEach(a => {
                this.getKey && a !== null && !Ot(a) ? this.map.set(this.getKey(a), a) : Z1(a) ? this.map.set(a.id, a) : eg(a) && this.map.set(a.topic, a)
            }
            ),
            this.cached = [],
            this.initialized = !0)
        ...
        this.set = async (a, o) => {
            this.isInitialized(),
            this.map.has(a) ? await this.update(a, o) : (this.logger.debug("Setting value"),
            this.logger.trace({
                type: "method",
                method: "set",
                key: a,
        ...
        this.getData(a)),
        this.getAll = a => (this.isInitialized(),
        a ? this.values.filter(o => Object.keys(a).every(f => zv(o[f], a[f]))) : this.values),
        ...
        this.delete = async (a, o) => {
            this.isInitialized(),
            this.map.has(a) && (this.logger.debug("Deleting value"),
            this.logger.trace({
                type: "method",
                method: "delete",
                key: a,
    ...
    getData(e) {
        ...
        if (!t) {
            if (this.recentlyDeleted.includes(e)) {
                const {message: s} = Q("MISSING_OR_INVALID", `Record was recently deleted - ${this.name}: ${e}`);
...
class _3 {
    constructor(e, t) {
        ...
        this.create = async i => {
            ...
            return this.events.emit(Kr.create, f),
        ...
        this.pair = async i => {
            ...
            i.activatePairing && await this.activate({
                topic: n
            }),
            this.events.emit(Kr.create, E),
            s.addTrace(cr.emit_inactive_pairing),
            this.core.crypto.keychain.has(n) || await this.core.crypto.setSymKey(a, n),
            ...
            try {
                ...
                throw s.setError(mr.subscribe_pairing_topic_failure),
                w
            }
            return s.addTrace(cr.subscribe_pairing_topic_success),
            E
        }
        ,
        ...
        this.disconnect = async i => {
            ...
            const {topic: s} = i;
            this.pairings.keys.includes(s) && (await this.sendRequest(s, "wc_pairingDelete", ke("USER_DISCONNECTED")),
        ...
        this.sendRequest = async (i, s, n) => {
            const a = Tr(s, n)
              ...
              , f = Vi[s].req;
            return this.core.history.set(i, a),
            this.core.relayer.publish(i, o, f),
            a.id
        }
        ,
        ...
        this.sendError = async (i, s, n) => {
            const a = En(i, n)
              , o = await this.core.crypto.encode(s, a)
              , f = await this.core.history.get(s, i)
              , h = Vi[f.request.method] ? Vi[f.request.method].res : Vi.unregistered_method.res;
            await this.core.relayer.publish(s, o, h),
            await this.core.history.resolve(a)
        }
        ,
        this.deletePairing = async (i, s) => {
            ...
            await Promise.all([this.pairings.delete(i, ke("USER_DISCONNECTED")), this.core.crypto.deleteSymKey(i), s ? Promise.resolve() : this.core.expirer.del(i)])
        }
        ,
        this.cleanup = async () => {
        ...
        this.onPairingPingRequest = async (i, s) => {
            ...
            try {
                ...
                this.events.emit(Kr.ping, {
                    id: n,
                    topic: i
                })
            } catch (a) {
                await this.sendError(n, i, a),
                this.logger.error(a)
            }
        }
        ,
        this.onPairingPingResponse = (i, s) => {
            const {id: n} = s;
            setTimeout( () => {
                hr(s) ? this.events.emit(Ne("pairing_ping", n), {}) : kt(s) && this.events.emit(Ne("pairing_ping", n), {
                    error: s.error
                })
            }
            , 500)
        ...
        this.isValidPair = (i, s) => {
            ...
            if (!Q1(i.uri)) {
                const {message: o} = Q("MISSING_OR_INVALID", `pair() uri: ${i.uri}`);
                throw s.setError(mr.malformed_pairing_uri),
                new Error(o)
            }
            const a = tc(i == null ? void 0 : i.uri);
            if (!((n = a == null ? void 0 : a.relay) != null && n.protocol)) {
                const {message: o} = Q("MISSING_OR_INVALID", "pair() uri#relay-protocol");
                throw s.setError(mr.malformed_pairing_uri),
                new Error(o)
            }
            if (!(a != null && a.symKey)) {
            ...
            if (a != null && a.expiryTimestamp && Z.toMiliseconds(a == null ? void 0 : a.expiryTimestamp) < Date.now()) {
                s.setError(mr.pairing_expired);
                const {message: o} = Q("EXPIRED", "pair() URI has expired. Please try again with a new connection URI.");
                throw new Error(o)
            }
        }
        ,
        ...
        this.isValidDisconnect = async i => {
            if (!At(i)) {
                const {message: n} = Q("MISSING_OR_INVALID", `disconnect() params: ${i}`);
                throw new Error(n)
            }
            const {topic: s} = i;
            await this.isValidPairingTopic(s)
        ...
        this.isValidPairingTopic = async i => {
            if (!ct(i, !1)) {
                const {message: s} = Q("MISSING_OR_INVALID", `pairing topic should be a string: ${i}`);
                throw new Error(s)
            }
            if (!this.pairings.keys.includes(i)) {
                const {message: s} = Q("NO_MATCHING_KEY", `pairing topic doesn't exist: ${i}`);
                throw new Error(s)
            }
        ...
        this.core = e,
        this.logger = Pt(t, this.name),
        this.pairings = new ii(this.core,this.logger,this.name,this.storagePrefix)
    }
    get context() {
        return Tt(this.logger)
    }
    ...
    registerRelayerEvents() {
        this.core.relayer.on(xt.message, async e => {
            ...
            if (!this.pairings.keys.includes(t) || s === Ve.link_mode || this.ignoredPayloadTypes.includes(this.core.crypto.getPayloadType(i)))
                return;
            const n = await this.core.crypto.decode(t, i);
            try {
                Ga(n) ? (this.core.history.set(t, n),
                this.onRelayEventRequest({
                    topic: t,
                    payload: n
                })) : Sn(n) && (await this.core.history.resolve(n),
...
class E3 extends Nb {
    constructor(e, t) {
        ...
        this.resolve = async i => {
            ...
            typeof s.response > "u" && (s.response = kt(i) ? {
                error: i.error
            } : {
                result: i.result
            },
        ...
        ,
        this.get = async (i, s) => (this.isInitialized(),
        ...
        ,
        this.exists = async (i, s) => (this.isInitialized(),
    ...
    cleanup() {
        try {
            ...
            this.records.forEach(t => {
                Z.toMiliseconds(t.expiry || 0) - Date.now() <= 0 && (this.logger.info(`Deleting expired history log: ${t.id}`),
...
class I3 extends Bb {
    constructor(e, t, i) {
        ...
        this.init = async () => {
            ...
            this.publicKey && Z.toMiliseconds((s = this.publicKey) == null ? void 0 : s.expiresAt) < Date.now() && (this.logger.debug("verify v2 public key expired"),
        ...
        this.register = async s => {
            ...
            try {
                ...
                return this.logger.debug("jwt attestation", y),
                y
            } catch (h) {
                this.logger.warn(h)
            }
        ...
        this.fetchAttestation = async (s, n) => {
            ...
            o.status === 200 ? await o.json() : void 0
        }
        ,
        this.getVerifyUrl = s => {
            let n = s || es;
            return Dy.includes(n) || (this.logger.info(`verify url: ${n}, not included in trusted list, assigning default: ${es}`),
            n = es),
            n
        }
        ,
        ...
        this.isValidJwtAttestation = async s => {
            ...
            try {
                if (a)
                    return this.validateAttestation(s, a)
            } catch (o) {
                this.logger.error(o),
                this.logger.warn("error validating attestation")
            }
        ...
        this.fetchAndPersistPublicKey = async () => {
            ...
            this.fetchPromise = new Promise(async n => {
                ...
                a && (await this.persistPublicKey(a),
                n(a))
            }
            );
        ...
        this.validateAttestation = (s, n) => {
            const a = R1(s, n.publicKey)
              , o = {
                hasExpired: Z.toMiliseconds(a.exp) < Date.now(),
                payload: a
            };
            if (o.hasExpired)
...
class x3 extends kb {
    constructor(e, t) {
        ...
        this.registerDeviceToken = async i => {
            const {clientId: s, token: n, notificationType: a, enableEncrypted: o=!1} = i
...
var D3 = Object.defineProperty
  ...
  , Ji = (r, e) => {
    for (var t in e || (e = {}))
        P3.call(e, t) && Hc(r, t, e[t]);
    if (kc)
        for (var t of kc(e))
            M3.call(e, t) && Hc(r, t, e[t]);
    return r
}
;
class A3 extends Hb {
    constructor(e, t, i=!0) {
                    ...
                    const s = {
                        ...
                        props: {
                            ...
                            properties: {
                                ...
                                user_agent: of(this.core.relayer.protocol, this.core.relayer.version, va)
                            }
                        }
                    };
        ...
        ,
        this.createEvent = s => {
            const {event: n="ERROR", type: a="", properties: {topic: o, trace: f}} = s
              , h = ko()
            ...
            return this.telemetryEnabled && (this.events.set(h, E),
        ...
        this.getEvent = s => {
            ...
            const o = Array.from(this.events.values()).find(f => f.props.properties.topic === a);
            if (o)
                return Ji(Ji({}, o), this.setMethods(o.eventId))
        }
        ,
        this.deleteEvent = s => {
            const {eventId: n} = s;
        ...
        this.setEventListeners = () => {
            this.core.heartbeat.on(Si.pulse, async () => {
                ...
                this.events.forEach(s => {
                    Z.fromMiliseconds(Date.now()) - Z.fromMiliseconds(s.timestamp) > Cy && (this.events.delete(s.eventId),
                    this.shouldPersist = !0)
                }
                )
            }
        ...
        this.addTrace = (s, n) => {
            ...
            a && (a.props.properties.trace.push(n),
            this.events.set(s, a),
            this.shouldPersist = !0)
        }
        ,
        ...
        this.restore = async () => {
            try {
                ...
                if (!s.length)
                    return;
                s.forEach(n => {
                    this.events.set(n.eventId, Ji(Ji({}, n), this.setMethods(n.eventId)))
                }
                )
            } catch (s) {
                this.logger.warn(s)
        ...
        this.submit = async () => {
            if (!this.telemetryEnabled || this.events.size === 0)
                return;
            const s = [];
            for (const [n,a] of this.events)
                a.props.type && s.push(a);
            if (s.length !== 0)
                try {
        ...
        this.sendEvent = async s => {
            ...
            return await fetch(`${Ty}?projectId=${this.core.projectId}&st=events_sdk&sv=js-${va}${n}`, {
                method: "POST",
...
var O3 = Object.defineProperty
  ...
  , Gc = (r, e) => {
    for (var t in e || (e = {}))
        C3.call(e, t) && Vc(r, t, e[t]);
    if (Kc)
        for (var t of Kc(e))
            T3.call(e, t) && Vc(r, t, e[t]);
    return r
}
;
class Ja extends $b {
    constructor(e) {
        ...
        const i = wn({
            level: typeof (e == null ? void 0 : e.logger) == "string" && e.logger ? e.logger : Qv.logger
        })
        ...
        (t = this.logChunkController) != null && t.downloadLogsBlobInBrowser && (window.downloadLogsBlobInBrowser = async () => {
            var a, o;
            (a = this.logChunkController) != null && a.downloadLogsBlobInBrowser && ((o = this.logChunkController) == null || o.downloadLogsBlobInBrowser({
        ...
        this.crypto = new s3(this,this.logger,e == null ? void 0 : e.keychain),
        this.history = new E3(this,this.logger),
        this.expirer = new S3(this,this.logger),
        this.storage = e != null && e.storage ? e.storage : new sb(Gc(Gc({}, Zv), e == null ? void 0 : e.storageOptions)),
        this.relayer = new v3({
            core: this,
            logger: this.logger,
            relayUrl: this.relayUrl,
        ...
        this.eventClient = new A3(this,this.logger,e == null ? void 0 : e.telemetryEnabled)
    }
    static async init(e) {
        const t = new Ja(e);
        await t.initialize();
        const i = await t.crypto.getClientId();
        return await t.storage.setItem(ly, i),
        t
    }
    get context() {
        return Tt(this.logger)
...
const Zf = "wc"
  ...
  , U3 = "request"
  , j3 = ["wc_sessionPropose", "wc_sessionRequest", "wc_authRequest", "wc_sessionAuthenticate"]
  , z3 = "wc"
  , B3 = "auth"
  , k3 = "authKeys"
  , H3 = "pairingTopics"
...
var V3 = Object.defineProperty
  ...
  , st = (r, e) => {
    for (var t in e || (e = {}))
        J3.call(e, t) && Yc(r, t, e[t]);
    if (Jc)
        for (var t of Jc(e))
            Y3.call(e, t) && Yc(r, t, e[t]);
    return r
}
  , tr = (r, e) => G3(r, W3(e));
class X3 extends N3 {
    constructor(e) {
        ...
        this.connect = async t => {
            ...
            const {pairingTopic: s, requiredNamespaces: n, optionalNamespaces: a, sessionProperties: o, relays: f} = i;
            let h = s, g, y = !1;
            try {
            ...
            if (!h) {
                const {message: A} = Q("NO_MATCHING_KEY", `connect() pairing topic: ${h}`);
                throw new Error(A)
            }
            ...
            this.events.once(Ne("session_connect"), async ({error: A, session: T}) => {
                if (A)
                    q(A);
                else if (T) {
                    T.self.publicKey = E;
                    ...
                    h && await this.client.core.pairing.updateMetadata({
                        topic: h,
            ...
            return await this.setProposal(L, st({
                id: L
            }, $)),
            {
                uri: g,
        ...
        this.approve = async t => {
            ...
            try {
                ...
                throw a.setError(Br.no_internet_connection),
                P
            }
            try {
            ...
            const {id: o, relayProtocol: f, namespaces: h, sessionProperties: g, sessionConfig: y} = t
              , E = this.client.proposal.get(o);
            this.client.core.eventClient.deleteEvent({
                eventId: a.eventId
            });
            const {pairingTopic: w, proposer: S, requiredNamespaces: $, optionalNamespaces: q} = E;
            let z = (s = this.client.core.eventClient) == null ? void 0 : s.getEvent({
                topic: w
            });
            z || (z = (n = this.client.core.eventClient) == null ? void 0 : n.createEvent({
            ...
            try {
                ...
                throw z.setError(Br.subscribe_session_topic_failure),
                P
            }
            ...
            try {
                ...
                await this.sendRequest({
                    ...
                    throw z == null || z.setError(Br.session_settle_publish_failure),
                    P
                }
                ),
                ...
                await this.sendResult({
                    ...
                    throw z == null || z.setError(Br.session_approve_publish_failure),
                    P
                }
                ),
                z.addTrace(er.session_approve_publish_success)
            } catch (P) {
                throw this.client.logger.error(P),
        ...
        this.update = async t => {
            ...
            return this.events.once(Ne("session_update", f), ({error: y}) => {
                y ? o(y) : a()
            }
            ),
        ...
        this.extend = async t => {
            ...
            const {topic: i} = t
              , s = Ar()
              , {done: n, resolve: a, reject: o} = Hr();
            return this.events.once(Ne("session_extend", s), ({error: f}) => {
                f ? o(f) : a()
            }
            ),
        ...
        this.request = async t => {
            ...
            const {chainId: i, request: s, topic: n, expiry: a=ut.wc_sessionRequest.req.ttl} = t
              , o = this.client.session.get(n);
            (o == null ? void 0 : o.transportType) === Ve.relay && await this.confirmOnlineStateOrThrow();
            const f = Ar()
              , h = Gr().toString()
              , {done: g, resolve: y, reject: E} = Hr(a, "Request expired. Please try again.");
            this.events.once(Ne("session_request", f), ({error: S, result: $}) => {
                S ? E(S) : y($)
            }
            );
            const w = this.getAppLinkIfEnabled(o.peer.metadata, o.transportType);
            return w ? (await this.sendRequest({
                clientRpcId: f,
                relayRpcId: h,
                topic: n,
            ...
            await g()) : await Promise.all([new Promise(async S => {
                await this.sendRequest({
                    clientRpcId: f,
                    relayRpcId: h,
                    topic: n,
        ...
        this.respond = async t => {
            ...
            hr(s) ? await this.sendResult({
                id: n,
                topic: i,
                result: s.result,
                throwOnFailedPublish: !0,
                appLink: o
            }) : kt(s) && await this.sendError({
                id: n,
                topic: i,
                error: s.error,
                appLink: o
        ...
        this.ping = async t => {
            ...
            if (this.client.session.keys.includes(i)) {
                ...
                this.client.core.pairing.pairings.keys.includes(i) && await this.client.core.pairing.ping({
                    topic: i
                })
        }
        ,
        ...
        this.disconnect = async t => {
            ...
            if (this.client.session.keys.includes(i))
                ...
                const {message: s} = Q("MISMATCHED_TOPIC", `Session or pairing topic not found: ${i}`);
                throw new Error(s)
            }
        }
        ,
        ...
        this.authenticate = async (t, i) => {
            ...
            const n = i && this.client.core.linkModeSupportedApps.includes(i) && ((s = this.client.metadata.redirect) == null ? void 0 : s.linkMode)
              , a = n ? Ve.link_mode : Ve.relay;
            a === Ve.relay && await this.confirmOnlineStateOrThrow();
            const {chains: o, statement: f="", uri: h, domain: g, nonce: y, type: E, exp: w, nbf: S, methods: $=[], expiry: q} = t
              , z = [...t.resources || []]
            ...
            const A = await this.client.core.crypto.generateKeyPair()
              , T = Ls(A);
            if (await Promise.all([this.client.auth.authKeys.set(zs, {
                responseTopic: T,
                publicKey: A
            ...
            const R = q && q > ut.wc_sessionAuthenticate.req.ttl ? q : ut.wc_sessionAuthenticate.req.ttl
              , l = {
                authPayload: {
                    type: E ?? "caip122",
                    chains: o,
              ...
              , v = async ({error: x, session: m}) => {
                if (this.events.off(Ne("session_request", b), d),
                x)
                    c(x);
                else if (m) {
                    m.self.publicKey = A,
              ...
              , d = async x => {
                ...
                x.error) {
                    ...
                    return x.error.code === B.code ? void 0 : (this.events.off(Ne("session_connect"), v),
                    c(x.error.message))
                }
                await this.deleteProposal(_),
                ...
                for (const B of K) {
                    ...
                    c(ke("SESSION_SETTLEMENT_FAILED", "Signature verification failed")));
                    const {p: F} = B
                      , p = qs(F.resources)
                      , N = [ha(F.iss)]
                      , J = Ys(F.iss);
                ...
                const ee = await this.client.core.crypto.generateSharedKey(A, k.publicKey);
                let U;
                W.length > 0 && (U = {
                    topic: ee,
                    acknowledged: !0,
                ...
                (m = this.client.metadata.redirect) != null && m.linkMode && (u = k.metadata.redirect) != null && u.linkMode && (I = k.metadata.redirect) != null && I.universal && i && (this.client.core.addLinkModeSupportedApp(k.metadata.redirect.universal),
            ...
            try {
                ...
                throw this.events.off(Ne("session_connect"), v),
                this.events.off(Ne("session_request", b), d),
                x
            }
            return await this.setProposal(_, st({
                id: _
            }, H)),
        ...
        this.approveSessionAuthenticate = async t => {
            ...
            try {
                ...
                throw n.setError(Gi.no_internet_connection),
                q
            }
            const a = this.getPendingAuthRequest(i);
            if (!a)
                throw n.setError(Gi.authenticated_session_pending_request_not_found),
            ...
            for (const q of s) {
                if (!await Vo({
                    ...
                    const T = ke("SESSION_SETTLEMENT_FAILED", "Signature verification failed");
            ...
            if ((E == null ? void 0 : E.length) > 0) {
                ...
                try {
                    ...
                    throw n.setError(Gi.subscribe_authenticated_session_topic_failure),
                    q
                }
            ...
            try {
                ...
                throw n.setError(Gi.authenticated_session_approve_publish_failure),
                q
            }
            return await this.client.auth.requests.delete(i, {
                message: "fulfilled",
                code: 0
            }),
            await this.client.core.pairing.activate({
        ...
        this.rejectSessionAuthenticate = async t => {
            ...
            n.transportType === Ve.relay && await this.confirmOnlineStateOrThrow();
                ...
                try {
                    const i = this.client.core.pairing.pairings.get(t.pairingTopic)
                      , s = this.client.core.pairing.pairings.getAll().filter(n => {
                        var a, o;
                        return ((a = n.peerMetadata) == null ? void 0 : a.url) && ((o = n.peerMetadata) == null ? void 0 : o.url) === t.peer.metadata.url && n.topic && n.topic !== i.topic
                    }
                    );
                    if (s.length === 0)
                        return;
                    this.client.logger.info(`Cleaning up ${s.length} duplicate pairing(s)`),
                    await Promise.all(s.map(n => this.client.core.pairing.disconnect({
                        topic: n.topic
                    }))),
        ...
        this.deleteSession = async t => {
            var i;
            const {topic: s, expirerHasDeleted: n=!1, emitEvent: a=!0, id: o=0} = t
            ...
            this.client.core.storage.removeItem(Wc).catch(h => this.client.logger.warn(h)),
            this.getPendingSessionRequests().forEach(h => {
                h.topic === s && this.deletePendingSessionRequest(h.id, ke("USER_DISCONNECTED"))
            }
            ),
            s === ((i = this.sessionRequestQueue.queue[0]) == null ? void 0 : i.topic) && (this.sessionRequestQueue.state = or.idle),
        ...
        this.deleteProposal = async (t, i) => {
            ...
            await Promise.all([this.client.proposal.delete(t, ke("USER_DISCONNECTED")), i ? Promise.resolve() : this.client.core.expirer.del(t)]),
        ...
        this.deletePendingSessionRequest = async (t, i, s=!1) => {
            ...
            s && (this.sessionRequestQueue.state = or.idle,
        ...
        this.sendRequest = async t => {
            const {topic: i, method: s, params: n, expiry: a, relayRpcId: o, clientRpcId: f, throwOnFailedPublish: h, appLink: g} = t
              , y = Tr(s, n, f);
            let E;
            const w = !!g;
            try {
                const q = w ? Hi : Cr;
                E = await this.client.core.crypto.encode(i, y, {
                    encoding: q
                })
            } catch (q) {
            ...
            if (j3.includes(s)) {
                const q = wr(JSON.stringify(y))
                  , z = wr(E);
                S = await this.client.core.verify.register({
                    id: z,
                    decryptedId: q
                })
            }
            ...
            w) {
                ...
                a && (q.ttl = a),
                o && (q.id = o),
                h ? (q.internal = tr(st({}, q.internal), {
                    throwOnFailedPublish: !0
                }),
                await this.client.core.relayer.publish(i, E, q)) : this.client.core.relayer.publish(i, E, q).catch(z => this.client.logger.error(z))
            }
            return y.id
        }
        ,
        this.sendResult = async t => {
            const {id: i, topic: s, result: n, throwOnFailedPublish: a, encodeOpts: o, appLink: f} = t
              , h = _n(i, n);
            let g;
            const y = f && typeof (Re == null ? void 0 : Re.Linking) < "u";
            try {
                const w = y ? Hi : Cr;
                g = await this.client.core.crypto.encode(s, h, tr(st({}, o || {}), {
                    encoding: w
                }))
            } catch (w) {
                throw await this.cleanup(),
            ...
            try {
                ...
                throw this.client.logger.error(`sendResult() -> history.get(${s}, ${i}) failed`),
                w
            }
            if (y) {
                const w = Ms(f, s, g);
                ...
                a ? (w.internal = tr(st({}, w.internal), {
                    throwOnFailedPublish: !0
                }),
                await this.client.core.relayer.publish(s, g, w)) : this.client.core.relayer.publish(s, g, w).catch(S => this.client.logger.error(S))
            }
            await this.client.core.history.resolve(h)
        }
        ,
        this.sendError = async t => {
            const {id: i, topic: s, error: n, encodeOpts: a, rpcOpts: o, appLink: f} = t
              , h = En(i, n);
            let g;
            const y = f && typeof (Re == null ? void 0 : Re.Linking) < "u";
            try {
                const w = y ? Hi : Cr;
                g = await this.client.core.crypto.encode(s, h, tr(st({}, a || {}), {
                    encoding: w
                }))
            } catch (w) {
                throw await this.cleanup(),
            ...
            try {
                ...
                throw this.client.logger.error(`sendError() -> history.get(${s}, ${i}) failed`),
                w
            }
            if (y) {
                const w = Ms(f, s, g);
        ...
        this.processRequest = async t => {
            const {topic: i, payload: s, attestation: n, transportType: a, encryptedId: o} = t
              , f = s.method;
        ...
        this.onRelayEventUnknownPayload = t => {
            const {topic: i} = t
              , {message: s} = Q("MISSING_OR_INVALID", `Decoded payload on topic ${i} is not identifiable as a JSON-RPC request or a response.`);
            throw new Error(s)
        }
        ,
        ...
        this.onSessionSettleRequest = async (t, i) => {
            ...
            try {
                ...
                const {relay: a, controller: o, expiry: f, namespaces: h, sessionProperties: g, sessionConfig: y} = i.params
                  , E = tr(st(st({
                    topic: t,
                    relay: a,
                    expiry: f,
        ...
        this.onSessionSettleResponse = async (t, i) => {
            const {id: s} = i;
            hr(i) ? (await this.client.session.update(t, {
                acknowledged: !0
            }),
            this.events.emit(Ne("session_approve", s), {})) : kt(i) && (await this.client.session.delete(t, ke("USER_DISCONNECTED")),
        ...
        ,
        this.isRequestOutOfSync = (t, i) => parseInt(i.toString().slice(0, -3)) <= parseInt(t.toString().slice(0, -3)),
        this.onSessionUpdateResponse = (t, i) => {
            ...
            hr(i) ? this.events.emit(Ne("session_update", s), {}) : kt(i) && this.events.emit(Ne("session_update", s), {
                error: i.error
            })
        }
        ,
        ...
        this.onSessionExtendResponse = (t, i) => {
            ...
            if (this.events.listenerCount(n) === 0)
                throw new Error(`emitting ${n} without any listeners`);
            hr(i) ? this.events.emit(Ne("session_extend", s), {}) : kt(i) && this.events.emit(Ne("session_extend", s), {
                error: i.error
            })
        }
        ,
        ...
        this.onSessionPingResponse = (t, i) => {
            ...
            if (this.events.listenerCount(n) === 0)
                throw new Error(`emitting ${n} without any listeners`);
            setTimeout( () => {
                hr(i) ? this.events.emit(Ne("session_ping", s), {}) : kt(i) && this.events.emit(Ne("session_ping", s), {
                    error: i.error
                })
            }
            , 500)
        ...
        this.onSessionRequest = async t => {
            var i, s, n;
            const {topic: a, payload: o, attestation: f, encryptedId: h, transportType: g} = t
              , {id: y, params: E} = o;
            try {
                await this.isValidRequest(st({
                    topic: a
                }, E));
                ...
                g === Ve.link_mode && (i = w.peer.metadata.redirect) != null && i.universal && this.client.core.addLinkModeSupportedApp((s = w.peer.metadata.redirect) == null ? void 0 : s.universal),
                (n = this.client.signConfig) != null && n.disableRequestQueue ? this.emitSessionRequest($) : (this.addSessionRequestToSessionRequestQueue($),
                this.processSessionRequestQueue())
            } catch (w) {
                await this.sendError({
                    id: y,
        ...
        this.onSessionRequestResponse = (t, i) => {
            ...
            if (this.events.listenerCount(n) === 0)
                throw new Error(`emitting ${n} without any listeners`);
            hr(i) ? this.events.emit(Ne("session_request", s), {
                result: i.result
            }) : kt(i) && this.events.emit(Ne("session_request", s), {
                error: i.error
            })
        }
        ,
        ...
        this.onSessionAuthenticateRequest = async t => {
            var i;
            const {topic: s, payload: n, attestation: a, encryptedId: o, transportType: f} = t;
            try {
                ...
                f === Ve.link_mode && (i = h.metadata.redirect) != null && i.universal && this.client.core.addLinkModeSupportedApp(h.metadata.redirect.universal),
        ...
        this.isValidConnect = async t => {
            if (!At(t)) {
                const {message: f} = Q("MISSING_OR_INVALID", `connect() params: ${JSON.stringify(t)}`);
                throw new Error(f)
            }
            const {pairingTopic: i, requiredNamespaces: s, optionalNamespaces: n, sessionProperties: a, relays: o} = t;
            if (Ot(i) || await this.isValidPairingTopic(i),
            !cg(o)) {
                const {message: f} = Q("MISSING_OR_INVALID", `connect() relays: ${o}`);
                throw new Error(f)
            }
            !Ot(s) && ns(s) !== 0 && this.validateNamespaces(s, "requiredNamespaces"),
            !Ot(n) && ns(n) !== 0 && this.validateNamespaces(n, "optionalNamespaces"),
        ...
        this.isValidApprove = async t => {
            ...
            const {id: i, namespaces: s, relayProtocol: n, sessionProperties: a} = t;
            ...
            if (!ct(n, !0)) {
                const {message: g} = Q("MISSING_OR_INVALID", `approve() relayProtocol: ${n}`);
                throw new Error(g)
            }
            Ot(a) || this.validateSessionProps(a, "sessionProperties")
        }
        ...
        this.isValidReject = async t => {
            if (!At(t)) {
                const {message: n} = Q("MISSING_OR_INVALID", `reject() params: ${t}`);
                throw new Error(n)
            }
            const {id: i, reason: s} = t;
            ...
            await this.isValidProposalId(i),
            !fg(s)) {
                const {message: n} = Q("MISSING_OR_INVALID", `reject() reason: ${JSON.stringify(s)}`);
                throw new Error(n)
            }
        }
        ,
        this.isValidSessionSettleRequest = t => {
            if (!At(t)) {
                const {message: h} = Q("MISSING_OR_INVALID", `onSessionSettleRequest() params: ${t}`);
                throw new Error(h)
            }
            const {relay: i, controller: s, namespaces: n, expiry: a} = t;
            if (!_f(i)) {
                const {message: h} = Q("MISSING_OR_INVALID", "onSessionSettleRequest() relay protocol should be a string");
                throw new Error(h)
            }
        ...
        this.isValidUpdate = async t => {
            if (!At(t)) {
                const {message: f} = Q("MISSING_OR_INVALID", `update() params: ${t}`);
                throw new Error(f)
            }
            const {topic: i, namespaces: s} = t;
            this.checkRecentlyDeleted(i),
        ...
        this.isValidExtend = async t => {
            if (!At(t)) {
                const {message: s} = Q("MISSING_OR_INVALID", `extend() params: ${t}`);
                throw new Error(s)
            }
            const {topic: i} = t;
            this.checkRecentlyDeleted(i),
        ...
        this.isValidRequest = async t => {
            if (!At(t)) {
                const {message: f} = Q("MISSING_OR_INVALID", `request() params: ${t}`);
                throw new Error(f)
            }
            ...
            if (!nc(o, n)) {
                const {message: f} = Q("MISSING_OR_INVALID", `request() chainId: ${n}`);
                throw new Error(f)
            }
            if (!ug(s)) {
                const {message: f} = Q("MISSING_OR_INVALID", `request() ${JSON.stringify(s)}`);
                throw new Error(f)
            }
            if (!pg(o, n, s.method)) {
                const {message: f} = Q("MISSING_OR_INVALID", `request() method: ${s.method}`);
                throw new Error(f)
            }
            if (a && !yg(a, Vn)) {
                const {message: f} = Q("MISSING_OR_INVALID", `request() expiry: ${a}. Expiry must be a number (in seconds) between ${Vn.min} and ${Vn.max}`);
                throw new Error(f)
            }
        }
        ,
        this.isValidRespond = async t => {
            var i;
            if (!At(t)) {
                const {message: a} = Q("MISSING_OR_INVALID", `respond() params: ${t}`);
                throw new Error(a)
            }
            ...
            try {
                ...
                throw (i = t == null ? void 0 : t.response) != null && i.id && this.cleanupAfterResponse(t),
                a
            }
            if (!dg(n)) {
                const {message: a} = Q("MISSING_OR_INVALID", `respond() response: ${JSON.stringify(n)}`);
                throw new Error(a)
            }
        }
        ,
        ...
        this.isValidEmit = async t => {
            ...
            if (!nc(a, n)) {
                const {message: o} = Q("MISSING_OR_INVALID", `emit() chainId: ${n}`);
                throw new Error(o)
            }
            if (!lg(s)) {
                const {message: o} = Q("MISSING_OR_INVALID", `emit() event: ${JSON.stringify(s)}`);
                throw new Error(o)
            }
            if (!gg(a, n, s.name)) {
                const {message: o} = Q("MISSING_OR_INVALID", `emit() event: ${JSON.stringify(s)}`);
        ...
        this.isValidDisconnect = async t => {
            if (!At(t)) {
                const {message: s} = Q("MISSING_OR_INVALID", `disconnect() params: ${t}`);
                throw new Error(s)
            }
            const {topic: i} = t;
            await this.isValidSessionOrPairingTopic(i)
        ...
        this.getVerifyContext = async t => {
            const {attestationId: i, hash: s, encryptedId: n, metadata: a, transportType: o} = t
              , f = {
                verified: {
            ...
            try {
                if (o === Ve.link_mode) {
                    ...
                    return f.verified.validation = g && new URL(g).origin === new URL(a.url).origin ? "VALID" : "INVALID",
                    f
                }
                ...
                h && (f.verified.origin = h.origin,
                f.verified.isScam = h.isScam,
                f.verified.validation = h.origin === new URL(a.url).origin ? "VALID" : "INVALID")
            } catch (h) {
                this.client.logger.warn(h)
            }
            return this.client.logger.debug(`Verify context: ${JSON.stringify(f)}`),
            f
        }
        ,
        this.validateSessionProps = (t, i) => {
            Object.values(t).forEach(s => {
                if (!ct(s, !1)) {
                    const {message: n} = Q("MISSING_OR_INVALID", `${i} must be in Record<string, string> format. Received: ${JSON.stringify(s)}`);
                    throw new Error(n)
                }
            }
            )
        ...
        this.checkRecentlyDeleted = t => {
            ...
            if (i) {
                const {message: s} = Q("MISSING_OR_INVALID", `Record was recently deleted - ${i}: ${t}`);
                throw new Error(s)
            }
        }
        ,
        this.isLinkModeEnabled = (t, i) => {
            ...
            return !t || i !== Ve.link_mode ? !1 : ((n = (s = this.client.metadata) == null ? void 0 : s.redirect) == null ? void 0 : n.linkMode) === !0 && ((o = (a = this.client.metadata) == null ? void 0 : a.redirect) == null ? void 0 : o.universal) !== void 0 && ((h = (f = this.client.metadata) == null ? void 0 : f.redirect) == null ? void 0 : h.universal) !== "" && ((g = t == null ? void 0 : t.redirect) == null ? void 0 : g.universal) !== void 0 && ((y = t == null ? void 0 : t.redirect) == null ? void 0 : y.universal) !== "" && ((E = t == null ? void 0 : t.redirect) == null ? void 0 : E.linkMode) === !0 && this.client.core.linkModeSupportedApps.includes(t.redirect.universal) && typeof (Re == null ? void 0 : Re.Linking) < "u"
        }
        ,
        ...
        this.registerLinkModeListeners = async () => {
            var t;
            if (ja() || _i() && (t = this.client.metadata.redirect) != null && t.linkMode) {
    ...
    async onRelayMessage(e) {
        const {topic: t, message: i, attestation: s, transportType: n} = e
          , {publicKey: a} = this.client.auth.authKeys.keys.includes(zs) ? this.client.auth.authKeys.get(zs) : {
        ...
        try {
            Ga(o) ? (this.client.core.history.set(t, o),
            this.onRelayEventRequest({
                topic: t,
                payload: o,
                attestation: s,
                transportType: n,
                encryptedId: wr(i)
            })) : Sn(o) ? (await this.client.core.history.resolve(o),
            await this.onRelayEventResponse({
                topic: t,
                payload: o,
                transportType: n
    ...
    registerPairingEvents() {
        this.client.core.pairing.events.on(Kr.create, e => this.onPairingCreated(e)),
    ...
    isValidPairingTopic(e) {
        if (!ct(e, !1)) {
            const {message: t} = Q("MISSING_OR_INVALID", `pairing topic should be a string: ${e}`);
            throw new Error(t)
        }
        if (!this.client.core.pairing.pairings.keys.includes(e)) {
            const {message: t} = Q("NO_MATCHING_KEY", `pairing topic doesn't exist: ${e}`);
            throw new Error(t)
        }
    ...
    async isValidSessionTopic(e) {
        if (!ct(e, !1)) {
            const {message: t} = Q("MISSING_OR_INVALID", `session topic should be a string: ${e}`);
            throw new Error(t)
        }
        if (this.checkRecentlyDeleted(e),
        !this.client.session.keys.includes(e)) {
            const {message: t} = Q("NO_MATCHING_KEY", `session topic doesn't exist: ${e}`);
            throw new Error(t)
        }
        ...
        if (!this.client.core.crypto.keychain.has(e)) {
            const {message: t} = Q("MISSING_OR_INVALID", `session topic does not exist in keychain: ${e}`);
    ...
    async isValidSessionOrPairingTopic(e) {
        ...
        this.client.session.keys.includes(e))
            ...
            const {message: t} = Q("NO_MATCHING_KEY", `session or pairing topic doesn't exist: ${e}`);
            throw new Error(t)
        } else {
            const {message: t} = Q("MISSING_OR_INVALID", `session or pairing topic should be a string: ${e}`);
            throw new Error(t)
        }
    }
    async isValidProposalId(e) {
        if (!hg(e)) {
            const {message: t} = Q("MISSING_OR_INVALID", `proposal id should be a number: ${e}`);
            throw new Error(t)
        }
        if (!this.client.proposal.keys.includes(e)) {
            const {message: t} = Q("NO_MATCHING_KEY", `proposal id doesn't exist: ${e}`);
            throw new Error(t)
        }
...
class Xa extends $3 {
    constructor(e) {
        ...
        const t = typeof (e == null ? void 0 : e.logger) < "u" && typeof (e == null ? void 0 : e.logger) != "string" ? e.logger : ms(wn({
            level: (e == null ? void 0 : e.logger) || Kn.logger
        }));
        ...
        (function(a) {
            ...
            if (o.arrayBuffer)
                var h = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"]
                  , g = ArrayBuffer.isView || function(d) {
            ...
            function S(d) {
                this.map = {},
                d instanceof S ? d.forEach(function(b, _) {
                    this.append(_, b)
                }, this) : Array.isArray(d) ? d.forEach(function(b) {
                    this.append(b[0], b[1])
                }, this) : d && Object.getOwnPropertyNames(d).forEach(function(b) {
                    this.append(b, d[b])
                }, this)
            }
            ...
            function z(d) {
                var b = new FileReader
                  , _ = q(b);
                return b.readAsArrayBuffer(d),
                _
            }
            function C(d) {
                var b = new FileReader
                  , _ = q(b);
                return b.readAsText(d),
                _
            }
            function L(d) {
                for (var b = new Uint8Array(d), _ = new Array(b.length), D = 0; D < b.length; D++)
            ...
            function T() {
                ...
                this._initBody = function(d) {
                    this._bodyInit = d,
                    d ? typeof d == "string" ? this._bodyText = d : o.blob && Blob.prototype.isPrototypeOf(d) ? this._bodyBlob = d : o.formData && FormData.prototype.isPrototypeOf(d) ? this._bodyFormData = d : o.searchParams && URLSearchParams.prototype.isPrototypeOf(d) ? this._bodyText = d.toString() : o.arrayBuffer && o.blob && f(d) ? (this._bodyArrayBuffer = A(d.buffer),
                    this._bodyInit = new Blob([this._bodyArrayBuffer])) : o.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(d) || g(d)) ? this._bodyArrayBuffer = A(d) : this._bodyText = d = Object.prototype.toString.call(d) : this._bodyText = "",
                ...
                this.arrayBuffer = function() {
                    return this._bodyArrayBuffer ? $(this) || Promise.resolve(this._bodyArrayBuffer) : this.blob().then(z)
                }
                ),
                this.text = function() {
                    var d = $(this);
            ...
            function P(d, b) {
                ...
                if (d instanceof P) {
                    ...
                    !_ && d._bodyInit != null && (_ = d._bodyInit,
                    d.bodyUsed = !0)
                } else
                    this.url = String(d);
                if (this.credentials = b.credentials || this.credentials || "same-origin",
            ...
            function v(d, b) {
                return new Promise(function(_, D) {
                    ...
                    m.onload = function() {
                        ...
                        I.url = "responseURL"in m ? m.responseURL : I.headers.get("X-Request-URL");
                    ...
                    x.credentials === "include" ? m.withCredentials = !0 : x.credentials === "omit" && (m.withCredentials = !1),
                    "responseType"in m && o.blob && (m.responseType = "blob"),
                    x.headers.forEach(function(I, K) {
                        m.setRequestHeader(K, I)
                    }),
                    x.signal && (x.signal.addEventListener("abort", u),
...
var n6 = wa.exports;
const Xc = xa(n6)
  , a6 = r => JSON.stringify(r, (e, t) => typeof t == "bigint" ? t.toString() + "n" : t)
  , o6 = r => {
    const e = /([\[:])?(\d{17,}|(?:[9](?:[1-9]07199254740991|0[1-9]7199254740991|00[8-9]199254740991|007[2-9]99254740991|007199[3-9]54740991|0071992[6-9]4740991|00719925[5-9]740991|007199254[8-9]40991|0071992547[5-9]0991|00719925474[1-9]991|00719925474099[2-9])))([,\}\]])/g
      , t = r.replace(e, '$1"$2n"$3');
    return JSON.parse(t, (i, s) => typeof s == "string" && s.match(/^\d+n$/) ? BigInt(s.substring(0, s.length - 1)) : s)
...
var h6 = Object.defineProperty
  ...
  , th = (r, e) => {
    for (var t in e || (e = {}))
        d6.call(e, t) && eh(r, t, e[t]);
    if (Zc)
        for (var t of Zc(e))
            l6.call(e, t) && eh(r, t, e[t]);
    return r
}
  , rh = (r, e) => f6(r, u6(e));
const p6 = {
...
let gr = class {
    ...
    async send(e) {
        ...
        try {
            const t = Qc(e)
              , i = await (await Xc(this.url, rh(th({}, ih), {
                body: t
            }))).json();
            this.onPayload({
                data: i
    ...
    async register(e=this.url) {
        ...
        try {
            ...
            const i = this.parseError(t);
            throw this.events.emit("register_error", i),
            this.onClose(),
            i
        }
    }
...
var w6 = Object.defineProperty
  ...
  , Ts = (r, e) => {
    for (var t in e || (e = {}))
        S6.call(e, t) && ch(r, t, e[t]);
    if (oh)
        for (var t of oh(e))
            I6.call(e, t) && ch(r, t, e[t]);
    return r
}
  , x6 = (r, e) => _6(r, E6(e));
function ir(r, e, t) {
    var i;
    const s = pi(r);
    return ((i = e.rpcMap) == null ? void 0 : i[s.reference]) || `${iu}?chainId=${s.namespace}:${s.reference}&projectId=${t}`
}
function si(r) {
...
function Wn(r) {
    return typeof r == "number" ? r : r.includes("0x") ? parseInt(r, 16) : (r = r.includes(":") ? r.split(":")[1] : r,
...
var A6 = Object.defineProperty
  ...
  , lh = (r, e) => {
    for (var t in e || (e = {}))
        T6.call(e, t) && dh(r, t, e[t]);
    if (uh)
        for (var t of uh(e))
            R6.call(e, t) && dh(r, t, e[t]);
    return r
}
  , ph = (r, e) => O6(r, C6(e));
class $6 {
    ...
    createHttpProvider(e, t) {
        const i = t || ir(`${this.name}:${e}`, this.namespace, this.client.core.projectId);
        if (!i)
            throw new Error(`No RPC url provided for chainId: ${e}`);
        return new sr(new gr(i,Be("disableProviderPing")))
    }
    ...
    async getCapabilities(e) {
        ...
        const a = this.client.session.get(e.topic)
          , o = ((s = a == null ? void 0 : a.sessionProperties) == null ? void 0 : s.capabilities) || {};
        if (o != null && o[n])
    ...
    async getUserOperationReceipt(e, t) {
        ...
        const s = new URL(e)
          , n = await fetch(s, {
            ...
            body: JSON.stringify(Tr("eth_getUserOperationReceipt", [(i = t.request.params) == null ? void 0 : i[0]]))
        });
        if (!n.ok)
...
class q6 {
    ...
    createHttpProvider(e, t) {
        const i = t || ir(e, this.namespace, this.client.core.projectId);
        return typeof i > "u" ? void 0 : new sr(new gr(i,Be("disableProviderPing")))
    }
}
class L6 {
    constructor(e) {
...
var k6 = Object.defineProperty
  ...
  , Rs = (r, e) => {
    for (var t in e || (e = {}))
        V6.call(e, t) && bh(r, t, e[t]);
    if (gh)
        for (var t of gh(e))
            G6.call(e, t) && bh(r, t, e[t]);
    return r
}
  , Yn = (r, e) => H6(r, K6(e));
let W6 = class au {
    constructor(e) {
        ...
        this.providerOpts = e,
        this.logger = typeof (e == null ? void 0 : e.logger) < "u" && typeof (e == null ? void 0 : e.logger) != "string" ? e.logger : ms(wn({
            level: (e == null ? void 0 : e.logger) || nh
        })),
    ...
    sendAsync(e, t, i, s) {
        ...
        this.request(e, i, s).then(a => t(null, _n(n, a))).catch(a => t(a, void 0))
    }
    async enable() {
        if (!this.client)
    ...
    setDefaultChain(e, t) {
        try {
            ...
            n.name === ui ? n.setDefaultChain(`${i}:${s}`, t) : n.setDefaultChain(s, t)
        } catch (i) {
    ...
    async createClient() {
        this.client = this.providerOpts.client || await Xa.init({
    ...
    createProviders() {
        ...
        const e = [...new Set(Object.keys(this.session.namespaces).map(t => Xi(t)))];
        ...
        e.forEach(t => {
            ...
            switch (t) {
            case "eip155":
                this.rpcProviders[t] = new $6({
                    namespace: a
                });
                break;
            case "algorand":
                this.rpcProviders[t] = new q6({
                    namespace: a
                });
                break;
            case "solana":
                this.rpcProviders[t] = new N6({
                    namespace: a
                });
                break;
            case "cosmos":
                this.rpcProviders[t] = new F6({
                    namespace: a
                });
                break;
            case "polkadot":
                this.rpcProviders[t] = new M6({
                    namespace: a
                });
                break;
            case "cip34":
                this.rpcProviders[t] = new L6({
                    namespace: a
                });
                break;
            case "elrond":
                this.rpcProviders[t] = new U6({
                    namespace: a
                });
                break;
            case "multiversx":
                this.rpcProviders[t] = new j6({
                    namespace: a
                });
                break;
            case "near":
                this.rpcProviders[t] = new z6({
                    namespace: a
                });
                break;
            default:
                this.rpcProviders[ui] ? this.rpcProviders[ui].updateNamespace(a) : this.rpcProviders[ui] = new B6({
                    namespace: a
                })
            }
        }
    ...
    registerEventListeners() {
        ...
        this.client.on("session_delete", async e => {
            ...
            this.events.emit("disconnect", Yn(Rs({}, ke("USER_DISCONNECTED")), {
                data: e.topic
            }))
        }
        ),
    ...
    validateChain(e) {
        ...
        if (!this.namespaces || !Object.keys(this.namespaces).length)
            return [t, i];
        if (t && !Object.keys(this.namespaces || {}).map(a => Xi(a)).includes(t))
    ...
    onChainChanged(e, t=!1) {
        if (!this.namespaces)
            return;
        const [i,s] = this.validateChain(e);
        s && (t || this.getProvider(i).setDefaultChain(s),
        this.namespaces[i] ? this.namespaces[i].defaultChain = s : this.namespaces[`${i}:${s}`] ? this.namespaces[`${i}:${s}`].defaultChain = s : this.namespaces[`${i}:${s}`] = {
            defaultChain: s
        },
        this.persist("namespaces", this.namespaces),
...
const J6 = W6
  ...
  , e2 = ["eth_accounts", "eth_requestAccounts", "eth_sendRawTransaction", "eth_sign", "eth_signTransaction", "eth_signTypedData", "eth_signTypedData_v3", "eth_signTypedData_v4", "eth_sendTransaction", "personal_sign", "wallet_switchEthereumChain", "wallet_addEthereumChain", "wallet_getPermissions", "wallet_requestPermissions", "wallet_registerOnboarding", "wallet_watchAsset", "wallet_scanQRCode", "wallet_sendCalls", "wallet_getCapabilities", "wallet_getCallsStatus", "wallet_showCallsStatus"]
...
var r2 = Object.defineProperty
  ...
  , di = (r, e) => {
    for (var t in e || (e = {}))
        n2.call(e, t) && yh(r, t, e[t]);
    if (vh)
        for (var t of vh(e))
            a2.call(e, t) && yh(r, t, e[t]);
    return r
}
  , Xn = (r, e) => i2(r, s2(e));
function tn(r) {
...
function o2(r) {
    const {chains: e, optionalChains: t, methods: i, optionalMethods: s, events: n, optionalEvents: a, rpcMap: o} = r;
    if (!dr(e))
    ...
    if (!t && !a && !s && !(h != null && h.length) && !(g != null && g.length))
        return {
            required: e.length ? f : void 0
        };
    const y = (h == null ? void 0 : h.length) && (g == null ? void 0 : g.length) || !t
      , E = {
...
class ou {
    ...
    async connect(e) {
        ...
        try {
            const s = await new Promise(async (a, o) => {
                var f;
                this.rpc.showQrModal && ((f = this.modal) == null || f.subscribeModal(h => {
                    !h.open && !this.signer.session && (this.signer.abortPairingAttempt(),
                    o(new Error("Connection request reset. Please try again.")))
                }
                )),
                await this.signer.connect(Xn(di({
                    namespaces: di({}, t && {
                        [this.namespace]: t
                    })
                }, i && {
    ...
    async authenticate(e, t) {
        ...
        try {
            const i = await new Promise(async (n, a) => {
                var o;
                this.rpc.showQrModal && ((o = this.modal) == null || o.subscribeModal(f => {
                    !f.open && !this.signer.session && (this.signer.abortPairingAttempt(),
                    a(new Error("Connection request reset. Please try again.")))
                }
                )),
                await this.signer.authenticate(Xn(di({}, e), {
    ...
    registerEventListeners() {
        ...
        this.signer.on("session_delete", e => {
            this.reset(),
            this.events.emit("session_delete", e),
            this.events.emit("disconnect", Xn(di({}, ke("USER_DISCONNECTED")), {
                data: e.topic,
    ...
    async initialize(e) {
        ...
        this.chainId = this.rpc.chains.length ? tn(this.rpc.chains) : tn(this.rpc.optionalChains),
        ...
        this.rpc.showQrModal) {
            let t;
            try {
                const {WalletConnectModal: i} = await Fu( () => import("./index-BurEAbzY.js").then(s => s.i), __vite__mapDeps([0, 1, 2]));
                t = i
            } catch {
    ...
    loadConnectOpts(e) {
        ...
        t && dr(t) && (this.rpc.chains = t.map(n => this.formatChainId(n)),
        t.forEach(n => {
            this.rpc.rpcMap[n] = (s == null ? void 0 : s[n]) || this.getRpcUrl(n)
        }
        )),
        i && dr(i) && (this.rpc.optionalChains = [],
    ...
    getRpcUrl(e, t) {
        var i;
        return ((i = this.rpc.rpcMap) == null ? void 0 : i[e]) || `${Z6}?chainId=eip155:${e}&projectId=${t || this.rpc.projectId}`
    }
...
export {t2 as OPTIONAL_EVENTS, e2 as OPTIONAL_METHODS, Ea as REQUIRED_EVENTS, _a as REQUIRED_METHODS, ou as default};
