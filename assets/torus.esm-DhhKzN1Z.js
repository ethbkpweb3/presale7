...
import {l as si, a as go, _ as I, r as dt, s as yo, p as St, d as ve, o as _o, e as Gn, b as wo, i as mo, c as So} from "./index-CVIP3emZ.js";
...
function vo(e) {
    fn.info(`Response: ${e.status} ${e.statusText}`),
    fn.info(`Url: ${e.url}`)
}
...
(function(e) {
    ...
    : function(b) {
      ...
      , p = (g, b) => {
        if (g !== void 0 && (g === null || typeof g != "object" || !("aborted"in g)))
    ...
    e.exports = {
        ...
        format(g, ...b) {
            return g.replace(/%([sdifj])/g, function(...[A,y]) {
                const E = b.shift();
                return y === "f" ? E.toFixed(6) : y === "j" ? JSON.stringify(E) : y === "s" && typeof E == "object" ? `${E.constructor !== Object ? E.constructor.name : ""} {}`.trim() : E.toString()
            })
        },
        inspect(g) {
            switch (typeof g) {
        ...
        addAbortListener: Qe.addAbortListener || function(b, A) {
            if (b === void 0)
                throw new ERR_INVALID_ARG_TYPE("signal","AbortSignal",b);
            p(b, "signal"),
            f(A, "listener");
            let y;
            return b.aborted ? queueMicrotask( () => A()) : (b.addEventListener("abort", A, {
                __proto__: null,
                once: !0,
                [n]: !0
            }),
...
const {format: Co, inspect: Et, AggregateError: Oo} = se
  ...
  , No = ["string", "function", "number", "object", "Function", "Object", "boolean", "bigint", "symbol"]
  , Lo = /^([A-Z][a-z0-9]*)+$/
  , ko = "__node_internal_"
  , It = {};
function $e(e, t) {
    if (!e)
        throw new It.ERR_INTERNAL_ASSERTION(t)
}
function Xn(e) {
    let t = ""
      , n = e.length;
...
function Uo(e, t, n) {
    if (typeof t == "function")
        return $e(t.length <= n.length, `Code: ${e}; The provided arguments length (${n.length}) does not match the required ones (${t.length}).`),
        t(...n);
    const r = (t.match(/%[dfijoOs]/g) || []).length;
    return $e(r === n.length, `Code: ${e}; The provided arguments length (${n.length}) does not match the required ones (${r}).`),
    n.length === 0 ? t : Co(t, ...n)
}
function ne(e, t, n) {
    n || (n = Error);
...
ne("ERR_INVALID_ARG_TYPE", (e, t, n) => {
    ...
    const i = []
      ...
      , l = [];
    for (const h of t)
        $e(typeof h == "string", "All expected entries have to be of type string"),
        No.includes(h) ? i.push(h.toLowerCase()) : Lo.test(h) ? s.push(h) : ($e(h !== "object", 'The value "object" should be written as "Object"'),
        l.push(h));
    if (s.length > 0) {
...
, TypeError);
ne("ERR_MISSING_ARGS", (...e) => {
    $e(e.length > 0, "At least one arg needs to be specified");
    let t;
    const n = e.length;
    switch (e = (Array.isArray(e) ? e : [e]).map(r => `"${r}"`).join(" or "),
    n) {
    case 1:
        t += `The ${e[0]} argument`;
        break;
...
, TypeError);
ne("ERR_OUT_OF_RANGE", (e, t, n) => {
    $e(t, 'Missing "range" argument');
    let r;
    return Number.isInteger(n) && Math.abs(n) > 2 ** 32 ? r = Xn(String(n)) : typeof n == "bigint" ? (r = String(n),
...
ne("ERR_STREAM_ALREADY_FINISHED", "Cannot call %s after a stream was finished", Error);
ne("ERR_STREAM_CANNOT_PIPE", "Cannot pipe, not readable", Error);
ne("ERR_STREAM_DESTROYED", "Cannot call %s after a stream was destroyed", Error);
...
ne("ERR_STREAM_UNSHIFT_AFTER_END_EVENT", "stream.unshift() after end event", Error);
...
const {ArrayIsArray: Tn, ArrayPrototypeIncludes: ui, ArrayPrototypeJoin: fi, ArrayPrototypeMap: xo, NumberIsInteger: In, NumberIsNaN: Bo, NumberMAX_SAFE_INTEGER: jo, NumberMIN_SAFE_INTEGER: Ho, NumberParseInt: Fo, ObjectPrototypeHasOwnProperty: Vo, RegExpPrototypeExec: ci, String: Ko, StringPrototypeToUpperCase: Go, StringPrototypeTrim: qo} = z
  , {hideStackFrames: ce, codes: {ERR_SOCKET_BAD_PORT: Yo, ERR_INVALID_ARG_TYPE: ie, ERR_INVALID_ARG_VALUE: et, ERR_OUT_OF_RANGE: xe, ERR_UNKNOWN_SIGNAL: Zn}} = ue
...
const rs = ce( (e, t, n=Ho, r=jo) => {
    if (typeof e != "number")
        throw new ie(t,"number",e);
    if (!In(e))
        throw new xe(t,"an integer",e);
    if (e < n || e > r)
        throw new xe(t,`>= ${n} && <= ${r}`,e)
}
)
  ...
  , hi = ce( (e, t, n=!1) => {
    ...
    const r = n ? 1 : 0
      , i = 4294967295;
    if (e < r || e > i)
        throw new xe(t,`>= ${r} && <= ${i}`,e)
}
);
function Dn(e, t) {
    if (typeof e != "string")
        throw new ie(t,"string",e)
}
function os(e, t, n=void 0, r) {
    if (typeof e != "number")
        throw new ie(t,"number",e);
    if (n != null && e < n || r != null && e > r || (n != null || r != null) && Bo(e))
        throw new xe(t,`${n != null ? `>= ${n}` : ""}${n != null && r != null ? " && " : ""}${r != null ? `<= ${r}` : ""}`,e)
}
const ss = ce( (e, t, n) => {
    if (!ui(n, e)) {
        const i = "must be one of: " + fi(xo(n, s => typeof s == "string" ? `'${s}'` : Ko(s)), ", ");
        throw new et(t,e,i)
    }
}
);
...
const as = ce( (e, t, n=null) => {
    ...
    if (!Gt(n, "nullable", !1) && e === null || !r && Tn(e) || typeof e != "object" && (!i || typeof e != "function"))
...
function cs(e, t="signal") {
    if (Dn(e, t),
    Jn[e] === void 0)
        throw Jn[Go(e)] !== void 0 ? new Zn(e + " (signals must use all capital letters)") : new Zn(e)
}
const hs = ce( (e, t="buffer") => {
    if (!Zo(e))
        throw new ie(t,["Buffer", "TypedArray", "DataView"],e)
}
);
function ps(e, t) {
    const n = Xo(t)
...
function bs(e, t="Port", n=!0) {
    if (typeof e != "number" && typeof e != "string" || typeof e == "string" && qo(e).length === 0 || +e !== +e >>> 0 || e > 65535 || e === 0 && !n)
        throw new Yo(t,e,n);
    return e | 0
}
const bi = ce( (e, t) => {
  ...
  , gs = ce( (e, t) => {
    if (typeof e != "function")
        throw new ie(t,"Function",e)
}
)
  , ys = ce( (e, t) => {
    if (typeof e != "function" || zo(e))
        throw new ie(t,"Function",e)
}
)
  , _s = ce( (e, t) => {
    if (e !== void 0)
        throw new ie(t,"undefined",e)
}
);
function ws(e, t, n) {
    if (!ui(n, e))
        throw new ie(t,`('${fi(n, "|")}')`,e)
}
const ms = /^(?:<[^>]*>)(?:\s*;\s*[^;"\s]+(?:=(")?[^;"\s]*\1)?)*$/;
function Qn(e, t) {
...
function wi(e) {
    return !!(e && !_e(e) && typeof e.pipeThrough == "function" && typeof e.getReader == "function" && typeof e.cancel == "function")
}
function mi(e) {
    return !!(e && !_e(e) && typeof e.getWriter == "function" && typeof e.abort == "function")
}
function Si(e) {
    return !!(e && !_e(e) && typeof e.readable == "object" && typeof e.writable == "object")
}
function Ts(e) {
    return wi(e) || mi(e) || Si(e)
}
function Is(e, t) {
    return e == null ? !1 : t === !0 ? typeof e[er] == "function" : t === !1 ? typeof e[tr] == "function" : typeof e[er] == "function" || typeof e[tr] == "function"
}
function Ot(e) {
    if (!_e(e))
        return null;
...
function Ri(e) {
    return e && e[hn] != null ? e[hn] : typeof (e == null ? void 0 : e.readable) != "boolean" ? null : Ot(e) ? !1 : vt(e) && e.readable && !Ei(e)
}
function Ti(e) {
    return e && e[pn] != null ? e[pn] : typeof (e == null ? void 0 : e.writable) != "boolean" ? null : Ot(e) ? !1 : Ct(e) && e.writable && !Ai(e)
}
function Cs(e, t) {
    return _e(e) ? Ot(e) ? !0 : !((t == null ? void 0 : t.readable) !== !1 && Ri(e) || (t == null ? void 0 : t.writable) !== !1 && Ti(e)) : null
}
function Os(e) {
    var t, n;
    return _e(e) ? e.writableErrored ? e.writableErrored : (t = (n = e._writableState) === null || n === void 0 ? void 0 : n.errored) !== null && t !== void 0 ? t : null : null
}
function Ps(e) {
    var t, n;
    return _e(e) ? e.readableErrored ? e.readableErrored : (t = (n = e._readableState) === null || n === void 0 ? void 0 : n.errored) !== null && t !== void 0 ? t : null : null
}
function Ms(e) {
    if (!_e(e))
        return null;
    ...
    const t = e._writableState
      , n = e._readableState;
    return typeof (t == null ? void 0 : t.closed) == "boolean" || typeof (n == null ? void 0 : n.closed) == "boolean" ? (t == null ? void 0 : t.closed) || (n == null ? void 0 : n.closed) : typeof e._closed == "boolean" && Ii(e) ? e._closed : null
}
function Ii(e) {
...
function Ls(e) {
    ...
    const t = e._writableState
      , n = e._readableState
      , r = t || n;
    return !r && Di(e) || !!(r && r.autoDestroy && r.emitClose && r.closed === !1)
}
function ks(e) {
    var t;
    return !!(e && ((t = e[_i]) !== null && t !== void 0 ? t : e.readableDidRead || e.readableAborted))
}
function Us(e) {
    var t, n, r, i, s, l, c, h, p, f;
    return !!(e && ((t = (n = (r = (i = (s = (l = e[yi]) !== null && l !== void 0 ? l : e.readableErrored) !== null && s !== void 0 ? s : e.writableErrored) !== null && i !== void 0 ? i : (c = e._readableState) === null || c === void 0 ? void 0 : c.errorEmitted) !== null && r !== void 0 ? r : (h = e._writableState) === null || h === void 0 ? void 0 : h.errorEmitted) !== null && n !== void 0 ? n : (p = e._readableState) === null || p === void 0 ? void 0 : p.errored) !== null && t !== void 0 ? t : !((f = e._writableState) === null || f === void 0) && f.errored))
}
var Te = {
    isDestroyed: Ot,
    kIsDestroyed: gi,
...
const De = je()
  ...
  , {validateAbortSignal: xs, validateFunction: Bs, validateObject: js, validateBoolean: Hs} = ut
  , {Promise: Fs, PromisePrototypeThen: Vs, SymbolDispose: Ci} = z
  , {isClosed: Ks, isReadable: rr, isReadableNodeStream: qt, isReadableStream: Gs, isReadableFinished: ir, isReadableErrored: or, isWritable: sr, isWritableNodeStream: ar, isWritableStream: qs, isWritableFinished: lr, isWritableErrored: dr, isNodeStream: Ys, willEmitClose: Xs, kIsClosedPromise: zs} = Te;
let Ze;
function Zs(e) {
...
function Oi(e, t, n) {
    ...
    const O = () => {
        ...
        if (L && typeof L != "boolean")
            return n.call(e, L);
        if (s && !b && qt(e, !0) && !ir(e, !1))
            return n.call(e, new nr);
        if (l && !S && !lr(e, !1))
            return n.call(e, new nr);
        n.call(e)
    }
    ...
    ;
    Zs(e) ? (e.on("complete", g),
    f || e.on("abort", O),
    e.req ? w() : e.on("request", w)) : l && !c && (e.on("end", p),
    e.on("close", p)),
    ...
    e.on("close", O),
    E ? De.nextTick(O) : c != null && c.errorEmitted || h != null && h.errorEmitted ? f || De.nextTick(P) : (!s && (!f || rr(e)) && (S || sr(e) === !1) || !l && (!f || sr(e)) && (b || rr(e) === !1) || h && e.req && e.aborted) && De.nextTick(P);
    const x = () => {
        n = yn,
...
function Qs(e, t) {
    ...
    let r = !1;
    return t === null && (t = bn),
    (n = t) !== null && n !== void 0 && n.cleanup && (Hs(t.cleanup, "cleanup"),
    r = t.cleanup),
    new Fs( (i, s) => {
        const l = Oi(e, t, c => {
            r && l(),
...
var Ce = vn.exports;
const ge = je()
  , {aggregateTwoErrors: ea, codes: {ERR_MULTIPLE_CALLBACK: ta}, AbortError: na} = ue
  , {Symbol: Pi} = z
  , {kIsDestroyed: ra, isDestroyed: ia, isFinished: oa, isServerRequest: sa} = Te
  , Mi = Pi("kDestroy")
  , _n = Pi("kConstruct");
function Ni(e, t, n) {
    e && (e.stack,
...
function aa(e, t) {
    const n = this._readableState
      ...
      , i = r || n;
    return r != null && r.destroyed || n != null && n.destroyed ? (typeof t == "function" && t(),
    this) : (Ni(e, r, n),
    r && (r.destroyed = !0),
    n && (n.destroyed = !0),
    i.constructed ? ur(this, e, t) : this.once(Mi, function(s) {
        ur(this, ea(s, e), t)
    }),
    this)
}
...
function wn(e, t) {
    const n = e._readableState
      , r = e._writableState;
    r != null && r.errorEmitted || n != null && n.errorEmitted || (r && (r.errorEmitted = !0),
    n && (n.errorEmitted = !0),
    e.emit("error", t))
}
function da() {
...
function mn(e, t, n) {
    ...
    if (i != null && i.destroyed || r != null && r.destroyed)
        return this;
    r != null && r.autoDestroy || i != null && i.autoDestroy ? e.destroy(t) : t && (t.stack,
...
function pa(e, t) {
    !e || ia(e) || (!t && !oa(e) && (t = new na),
    sa(e) ? (e.socket = null,
    e.destroy(t)) : fr(e) ? e.abort() : fr(e.req) ? e.req.abort() : typeof e.destroy == "function" ? e.destroy(t) : typeof e.close == "function" ? e.close() : t ? ge.nextTick(ha, e, t) : ge.nextTick(ki, e),
    e.destroyed || (e[ra] = !0))
}
var tt = {
    construct: ua,
...
Mt.prototype.pipe = function(e, t) {
    ...
    e.on("drain", i),
    !e._isStdio && (!t || t.end !== !1) && (n.on("end", l),
    n.on("close", c));
    let s = !1;
    function l() {
        s || (s = !0,
    ...
    function h(f) {
        p(),
        Pt.listenerCount(this, "error") === 0 && this.emit("error", f)
    }
    Sn(n, "error", h),
    Sn(e, "error", h);
    function p() {
...
function Sn(e, t, n) {
    ...
    !e._events || !e._events[t] ? e.on(t, n) : ba(e._events[t]) ? e._events[t].unshift(n) : e._events[t] = [n, e._events[t]]
}
var Cn = {
    Stream: Mt,
    prependListener: Sn
...
var Nt = Wi.exports;
const {StringPrototypeSlice: cr, SymbolIterator: ga, TypedArrayPrototypeSet: gt, Uint8Array: ya} = z
  , {Buffer: Yt} = Be
  , {inspect: _a} = se;
var wa = class {
    constructor() {
    ...
    consume(t, n) {
        ...
        if (t < r.length) {
            const i = r.slice(0, t);
            return this.head.data = r.slice(t),
            i
        }
    ...
    _getString(t) {
        ...
        do {
            ...
            if (t > s.length)
                ...
                t === s.length ? (n += s,
                ++i,
                r.next ? this.head = r.next : this.head = this.tail = null) : (n += cr(s, 0, t),
                this.head = r,
                r.data = cr(s, t));
                break
            }
    ...
    _getBuffer(t) {
        ...
        do {
            ...
            if (t > l.length)
                ...
                t === l.length ? (gt(n, l, r - t),
                ++s,
                i.next ? this.head = i.next : this.head = this.tail = null) : (gt(n, new ya(l.buffer,l.byteOffset,t), r - t),
                this.head = i,
                i.data = l.slice(t));
                break
            }
...
function Pa(e, t, n) {
    ...
    if (t && t[pr])
        ...
        throw new Ca("iterable",["Iterable"],t);
    const s = new e({
        objectMode: !0,
        highWaterMark: 1,
        ...n
    ...
    s._destroy = function(p, f) {
        Da(c(p), () => hr.nextTick(f, p), S => hr.nextTick(f, S || p))
    }
    ;
    async function c(p) {
        const f = p != null
...
function kt() {
    ...
    gr = 1;
    const e = je()
      , {ArrayPrototypeIndexOf: t, NumberIsInteger: n, NumberIsNaN: r, NumberParseInt: i, ObjectDefineProperties: s, ObjectKeys: l, ObjectSetPrototypeOf: c, Promise: h, SafeSet: p, SymbolAsyncDispose: f, SymbolAsyncIterator: S, Symbol: g} = z;
    Xt = N,
    N.ReadableState = me;
    ...
    const x = wa
      ...
      , {aggregateTwoErrors: j, codes: {ERR_INVALID_ARG_TYPE: Z, ERR_METHOD_NOT_IMPLEMENTED: le, ERR_OUT_OF_RANGE: de, ERR_STREAM_PUSH_AFTER_EOF: W, ERR_STREAM_UNSHIFT_AFTER_END_EVENT: m}, AbortError: H} = ue
      , {validateObject: k} = ut
      , U = g("kPaused")
      , {StringDecoder: J} = yo
      , Q = ji;
    c(N.prototype, A.prototype),
    c(N, A);
    const Y = () => {}
      , {errorOrDestroy: ee} = L
      , F = 1
    ...
    function me(o, a, R) {
        ...
        this.highWaterMark = o ? q(this, o, "readableHighWaterMark", R) : ae(!1),
        this.buffer = new x,
        this.length = 0,
        this.pipes = [],
        this.flowing = null,
        ...
        this.decoder = null,
        this.encoding = null,
        o && o.encoding && (this.decoder = new J(o.encoding),
    ...
    function N(o) {
        ...
        o && (typeof o.read == "function" && (this._read = o.read),
    ...
    N.prototype[f] = function() {
        let o;
        return this.destroyed || (o = this.readableEnded ? null : new H,
        this.destroy(o)),
    ...
    function Ie(o, a, R, T) {
        ...
        let re;
        if (D.state & F || (typeof a == "string" ? (R = R || D.defaultEncoding,
        D.encoding !== R && (T && D.encoding ? a = E.from(a, R).toString(D.encoding) : (a = E.from(a, R),
        R = ""))) : a instanceof E ? R = "" : A._isUint8Array(a) ? (a = A._uint8ArrayToBuffer(a),
        R = "") : a != null && (re = new Z("chunk",["string", "Buffer", "Uint8Array"],a))),
        re)
            ee(o, re);
        else if (a === null)
            D.state &= ~te,
            ...
            if (T)
                ...
                if (D.destroyed || D.errored)
                    return !1;
                D.state &= ~te,
                D.decoder && !R ? (a = D.decoder.write(a),
                D.objectMode || a.length !== 0 ? xt(o, D, a, !1) : bt(o, D)) : xt(o, D, a, !1)
            }
        else
            T || (D.state &= ~te,
            bt(o, D));
    ...
    function xt(o, a, R, T) {
        a.flowing && a.length === 0 && !a.sync && o.listenerCount("data") > 0 ? (a.state & C ? a.awaitDrainWriters.clear() : a.awaitDrainWriters = null,
        a.dataEmitted = !0,
        o.emit("data", R)) : (a.length += a.objectMode ? 1 : R.length,
    ...
    function kn(o, a) {
        return o <= 0 || a.length === 0 && a.ended ? 0 : a.state & F ? 1 : r(o) ? a.flowing && a.length ? a.buffer.first().length : a.length : o <= a.length ? o : a.ended ? a.length : 0
    }
    N.prototype.read = function(o) {
        w("read", o),
        o === void 0 ? o = NaN : n(o) || (o = i(o, 10));
        const a = this._readableState
          , R = o;
        if (o > a.highWaterMark && (a.highWaterMark = ro(o)),
        o !== 0 && (a.state &= ~qe),
        o === 0 && a.needReadable && ((a.highWaterMark !== 0 ? a.length >= a.highWaterMark : a.length > 0) || a.ended))
            return w("read: emitReadable", a.length, a.ended),
            a.length === 0 && a.ended ? Bt(this) : pt(this),
            null;
        if (o = kn(o, a),
        o === 0 && a.ended)
            return a.length === 0 && Bt(this),
            null;
        let T = (a.state & Ge) !== 0;
        if (w("need readable", T),
        (a.length === 0 || a.length - o < a.highWaterMark) && (T = !0,
        w("length less than watermark", T)),
        a.ended || a.reading || a.destroyed || a.errored || !a.constructed)
            T = !1,
            w("reading, ended or constructing", T);
        else if (T) {
            w("do read"),
            a.state |= te | Ke,
            a.length === 0 && (a.state |= Ge);
            try {
        ...
        let D;
        return o > 0 ? D = Bn(o, a) : D = null,
        D === null ? (a.needReadable = a.length <= a.highWaterMark,
        o = 0) : (a.length -= o,
        a.multiAwaitDrain ? a.awaitDrainWriters.clear() : a.awaitDrainWriters = null),
        a.length === 0 && (a.ended || (a.needReadable = !0),
        R !== o && a.ended && Bt(this)),
        D !== null && !a.errorEmitted && !a.closeEmitted && (a.dataEmitted = !0,
        this.emit("data", D)),
        D
    }
    ;
    function io(o, a) {
        ...
        !a.ended) {
            if (a.decoder) {
                ...
                R && R.length && (a.buffer.push(R),
                a.length += a.objectMode ? 1 : R.length)
            }
            a.ended = !0,
            a.sync ? pt(o) : (a.needReadable = !1,
            a.emittedReadable = !0,
            Un(o))
        }
    }
    function pt(o) {
        ...
        a.needReadable = !1,
        a.emittedReadable || (w("emitReadable", a.flowing),
        a.emittedReadable = !0,
        e.nextTick(Un, o))
    }
    function Un(o) {
        ...
        !a.destroyed && !a.errored && (a.length || a.ended) && (o.emit("readable"),
        a.emittedReadable = !1),
        a.needReadable = !a.flowing && !a.ended && a.length <= a.highWaterMark,
        $n(o)
    }
    function bt(o, a) {
        !a.readingMore && a.constructed && (a.readingMore = !0,
        e.nextTick(oo, o, a))
    }
    function oo(o, a) {
    ...
    N.prototype.pipe = function(o, a) {
        ...
        T.pipes.length === 1 && (T.multiAwaitDrain || (T.multiAwaitDrain = !0,
        T.awaitDrainWriters = new p(T.awaitDrainWriters ? [T.awaitDrainWriters] : []))),
        T.pipes.push(o),
        w("pipe count=%d opts=%j", T.pipes.length, a);
        const re = (!a || a.end !== !1) && o !== e.stdout && o !== e.stderr ? Hn : it;
        T.endEmitted ? e.nextTick(re) : R.once("end", re),
        o.on("unpipe", fe);
        function fe(Pe, Se) {
            w("onunpipe"),
            Pe === R && Se && Se.hasUnpiped === !1 && (Se.hasUnpiped = !0,
            po())
        }
        function Hn() {
            w("onend"),
        ...
        function po() {
            ...
            Fn = !0,
            Oe && T.awaitDrainWriters && (!o._writableState || o._writableState.needDrain) && Oe()
        }
        function Vn() {
            Fn || (T.pipes.length === 1 && T.pipes[0] === o ? (w("false write response, pause", 0),
            T.awaitDrainWriters = o,
            T.multiAwaitDrain = !1) : T.pipes.length > 1 && T.pipes.includes(o) && (w("false write response, pause", T.awaitDrainWriters.size),
        ...
        return o.emit("pipe", R),
        o.writableNeedDrain === !0 ? Vn() : T.flowing || (w("pipe resume"),
        R.resume()),
        o
    }
    ;
    function so(o, a) {
        return function() {
            ...
            T.awaitDrainWriters === a ? (w("pipeOnDrain", 1),
            T.awaitDrainWriters = null) : T.multiAwaitDrain && (w("pipeOnDrain", T.awaitDrainWriters.size),
            T.awaitDrainWriters.delete(a)),
            (!T.awaitDrainWriters || T.awaitDrainWriters.size === 0) && o.listenerCount("data") && o.resume()
        }
    }
    N.prototype.unpipe = function(o) {
        ...
        if (!o) {
            ...
            for (let re = 0; re < D.length; re++)
                D[re].emit("unpipe", this, {
                    hasUnpiped: !1
                });
            return this
        }
        const T = t(a.pipes, o);
        return T === -1 ? this : (a.pipes.splice(T, 1),
    ...
    N.prototype.on = function(o, a) {
        const R = A.prototype.on.call(this, o, a)
          , T = this._readableState;
        return o === "data" ? (T.readableListening = this.listenerCount("readable") > 0,
        T.flowing !== !1 && this.resume()) : o === "readable" && !T.endEmitted && !T.readableListening && (T.readableListening = T.needReadable = !0,
        T.flowing = !1,
        T.emittedReadable = !1,
    ...
    N.prototype.removeListener = function(o, a) {
        ...
        return o === "readable" && e.nextTick(Wn, this),
        R
    }
    ,
    ...
    N.prototype.removeAllListeners = function(o) {
        ...
        return (o === "readable" || o === void 0) && e.nextTick(Wn, this),
        a
    }
    ;
    function Wn(o) {
        ...
        a.resumeScheduled && a[U] === !1 ? a.flowing = !0 : o.listenerCount("data") > 0 ? o.resume() : a.readableListening || (a.flowing = null)
    }
    function ao(o) {
    ...
    ;
    function lo(o, a) {
        a.resumeScheduled || (a.resumeScheduled = !0,
        e.nextTick(uo, o, a))
    }
    function uo(o, a) {
        w("resume", a.reading),
    ...
    N.prototype.pause = function() {
        ...
        this._readableState.flowing !== !1 && (w("pause"),
    ...
    N.prototype.iterator = function(o) {
        return o !== void 0 && k(o, "options"),
        xn(this, o)
    }
    ;
    function xn(o, a) {
        typeof o.read != "function" && (o = N.wrap(o, {
            objectMode: !0
        }));
        const R = fo(o, a);
        return R.stream = o,
    ...
    async function *fo(o, a) {
        ...
        try {
            ...
            (D || (a == null ? void 0 : a.destroyOnReturn) !== !1) && (D === void 0 || o._readableState.autoDestroy) ? L.destroyer(o, null) : (o.off("readable", T),
            re())
        }
    }
    s(N.prototype, {
    ...
    function Bn(o, a) {
        if (a.length === 0)
            return null;
        let R;
        return a.objectMode ? R = a.buffer.shift() : !o || o >= a.length ? (a.decoder ? R = a.buffer.join("") : a.buffer.length === 1 ? R = a.buffer.first() : R = a.buffer.concat(a.length),
        a.buffer.clear()) : R = a.buffer.consume(o, a.decoder),
        R
    }
    function Bt(o) {
        const a = o._readableState;
        w("endReadable", a.endEmitted),
        a.endEmitted || (a.ended = !0,
        e.nextTick(co, a, o))
    }
    function co(o, a) {
        if (w("endReadableNT", o.endEmitted, o.length),
        !o.errored && !o.closeEmitted && !o.endEmitted && o.length === 0) {
            ...
            a.writable && a.allowHalfOpen === !1)
                ...
                (!R || R.autoDestroy && (R.finished || R.writable === !1)) && a.destroy()
            }
        }
    }
    function ho(o) {
    ...
    N.wrap = function(o, a) {
        var R, T;
        return new N({
            objectMode: (R = (T = o.readableObjectMode) !== null && T !== void 0 ? T : o.objectMode) !== null && R !== void 0 ? R : !0,
            ...a,
            destroy(D, re) {
                L.destroyer(o, D),
                re(D)
...
function On() {
    ...
    yr = 1;
    const e = je()
      , {ArrayPrototypeSlice: t, Error: n, FunctionPrototypeSymbolHasInstance: r, ObjectDefineProperty: i, ObjectDefineProperties: s, ObjectSetPrototypeOf: l, StringPrototypeToLowerCase: c, Symbol: h, SymbolHasInstance: p} = z;
    zt = k,
    k.WritableState = m;
    const {EventEmitter: f} = Qe
      ...
      , {ERR_INVALID_ARG_TYPE: O, ERR_METHOD_NOT_IMPLEMENTED: P, ERR_MULTIPLE_CALLBACK: w, ERR_STREAM_CANNOT_PIPE: x, ERR_STREAM_DESTROYED: L, ERR_STREAM_ALREADY_FINISHED: q, ERR_STREAM_NULL_VALUES: ae, ERR_STREAM_WRITE_AFTER_END: j, ERR_UNKNOWN_ENCODING: Z} = ue.codes
      , {errorOrDestroy: le} = b;
    l(k.prototype, S.prototype),
    l(k, S);
    function de() {}
    ...
    function k(d) {
        ...
        d && (typeof d.write == "function" && (this._write = d.write),
    ...
    i(k, p, {
        __proto__: null,
        value: function(d) {
            return r(this, d) ? !0 : this !== k ? !1 : d && d._writableState instanceof m
        }
    }),
    ...
    function U(d, u, _, v) {
        ...
        if (typeof _ == "function")
            ...
            if (!_)
                _ = C.defaultEncoding;
            else if (_ !== "buffer" && !g.isEncoding(_))
                throw new Z(_);
        ...
        if (!C.objectMode)
            if (typeof u == "string")
                C.decodeStrings !== !1 && (u = g.from(u, _),
                _ = "buffer");
            else if (u instanceof g)
                _ = "buffer";
            else if (S._isUint8Array(u))
                u = S._uint8ArrayToBuffer(u),
                _ = "buffer";
            else
                throw new O("chunk",["string", "Buffer", "Uint8Array"],u);
        let K;
        return C.ending ? K = new j : C.destroyed && (K = new L("write")),
        K ? (e.nextTick(v, K),
        le(d, K, !0),
        K) : (C.pendingcb++,
        J(d, C, u, _, v))
    ...
    k.prototype.setDefaultEncoding = function(u) {
        if (typeof u == "string" && (u = c(u)),
        !g.isEncoding(u))
            throw new Z(u);
        return this._writableState.defaultEncoding = u,
        this
    }
    ;
    function J(d, u, _, v, C) {
        ...
        return G || (u.needDrain = !0),
        u.writing || u.corked || u.errored || !u.constructed ? (u.buffered.push({
            chunk: _,
            encoding: v,
            callback: C
        }),
        u.allBuffers && v !== "buffer" && (u.allBuffers = !1),
        u.allNoop && C !== de && (u.allNoop = !1)) : (u.writelen = K,
        u.writecb = C,
        u.writing = !0,
        u.sync = !0,
    ...
    function Q(d, u, _, v, C, K, G) {
        ...
        u.writing = !0,
        u.sync = !0,
        u.destroyed ? u.onwrite(new L("write")) : _ ? d._writev(C, u.onwrite) : d._write(C, K, u.onwrite),
        u.sync = !1
    }
    function Y(d, u, _, v) {
        --u.pendingcb,
    ...
    function ee(d, u) {
        ...
        d._readableState && !d._readableState.errored && (d._readableState.errored = u),
        v ? e.nextTick(Y, d, _, u, C) : Y(d, _, u, C)) : (_.buffered.length > _.bufferedIndex && te(d, _),
        v ? _.afterWriteTickInfo !== null && _.afterWriteTickInfo.cb === C ? _.afterWriteTickInfo.count++ : (_.afterWriteTickInfo = {
            count: 1,
            cb: C,
            stream: d,
            state: _
        },
        e.nextTick(F, _.afterWriteTickInfo)) : we(d, _, 1, C))
    }
    function F({stream: d, state: u, count: _, cb: v}) {
        return u.afterWriteTickInfo = null,
        we(d, u, _, v)
    }
    function we(d, u, _, v) {
        for (!u.ending && !d.destroyed && u.length === 0 && u.needDrain && (u.needDrain = !1,
        d.emit("drain")); _-- > 0; )
            u.pendingcb--,
            v();
        u.destroyed && M(u),
    ...
    function te(d, u) {
        ...
        if (!K)
            return;
        let G = v;
        if (u.bufferProcessing = !0,
        K > 1 && d._writev) {
            u.pendingcb -= K - 1;
            const V = u.allNoop ? de : N => {
                for (let Ie = G; Ie < _.length; ++Ie)
                    _[Ie].callback(N)
            }
              , me = u.allNoop && G === 0 ? _ : t(_, G);
            me.allBuffers = u.allBuffers,
            Q(d, u, !0, u.length, me, "", V),
            H(u)
        } else {
            do {
            ...
            G === _.length ? H(u) : G > 256 ? (_.splice(0, G),
            u.bufferedIndex = 0) : u.bufferedIndex = G
        }
    ...
    k.prototype.end = function(d, u, _) {
        ...
        return v.corked && (v.corked = 1,
        this.uncork()),
        C || (!v.errored && !v.ending ? (v.ending = !0,
        qe(this, v, !0),
        v.ended = !0) : v.finished ? C = new q("end") : v.destroyed && (C = new L("end"))),
        typeof _ == "function" && (C || v.finished ? e.nextTick(_, C) : v[W].push(_)),
        this
    }
    ;
    function he(d) {
    ...
    function Ge(d, u) {
        !u.prefinished && !u.finalCalled && (typeof d._final == "function" && !u.destroyed ? (u.finalCalled = !0,
        Ke(d, u)) : (u.prefinished = !0,
        d.emit("prefinish")))
    }
    function qe(d, u, _) {
        he(u) && (Ge(d, u),
        u.pendingcb === 0 && (_ ? (u.pendingcb++,
        e.nextTick( (v, C) => {
            he(C) ? nt(v, C) : C.pendingcb--
        }
        , d, u)) : he(u) && (u.pendingcb++,
        nt(d, u))))
    }
    function nt(d, u) {
        u.pendingcb--,
        ...
        u.autoDestroy) {
            ...
            (!v || v.autoDestroy && (v.endEmitted || v.readable === !1)) && d.destroy()
        }
    }
    s(k.prototype, {
        closed: {
    ...
    k.prototype.destroy = function(d, u) {
        const _ = this._writableState;
        return !_.destroyed && (_.bufferedIndex < _.buffered.length || _[W].length) && e.nextTick(M, _),
        $t.call(this, d, u),
        this
    }
    ,
...
function Ma() {
    ...
    const e = je()
      , t = Be
      , {isReadable: n, isWritable: r, isIterable: i, isNodeStream: s, isReadableNodeStream: l, isWritableNodeStream: c, isDuplexNodeStream: h, isReadableStream: p, isWritableStream: f} = Te
      , S = Ce
      , {AbortError: g, codes: {ERR_INVALID_ARG_TYPE: b, ERR_INVALID_RETURN_VALUE: A}} = ue
      , {destroyer: y} = tt
      , E = Ee()
      , O = kt()
      , P = On()
    ...
    class Z extends E {
        constructor(m) {
            super(m),
            (m == null ? void 0 : m.readable) === !1 && (this._readableState.readable = !1,
            this._readableState.ended = !0,
            this._readableState.endEmitted = !0),
            (m == null ? void 0 : m.writable) === !1 && (this._writableState.writable = !1,
    ...
    Zt = function W(m, H) {
        ...
        if (p(m))
            return de({
                readable: O.fromWeb(m)
            });
        if (f(m))
            return de({
                writable: P.fromWeb(m)
            });
        ...
        if (q(m))
            return W(m.arrayBuffer());
        if (i(m))
            return x(Z, m, {
                objectMode: !0,
                writable: !1
            });
        if (p(m == null ? void 0 : m.readable) && f(m == null ? void 0 : m.writable))
            return Z.fromWeb(m);
        if (typeof (m == null ? void 0 : m.writable) == "object" || typeof (m == null ? void 0 : m.readable) == "object") {
            const U = m != null && m.readable ? l(m == null ? void 0 : m.readable) ? m == null ? void 0 : m.readable : W(m.readable) : void 0
              , J = m != null && m.writable ? c(m == null ? void 0 : m.writable) ? m == null ? void 0 : m.writable : W(m.writable) : void 0;
            return de({
                readable: U,
                writable: J
            })
        ...
        throw new b(H,["Blob", "ReadableStream", "WritableStream", "Stream", "Iterable", "AsyncIterable", "Function", "{ readable, writable } pair", "Promise"],m)
    }
    ;
    function le(W) {
    ...
    function de(W) {
        const m = W.readable && typeof W.readable.read != "function" ? O.wrap(W.readable) : W.readable
          , H = W.writable;
        let k = !!n(m), U = !!r(H), J, Q, Y, ee, F;
        function we(M) {
            const te = ee;
            ee = null,
            te ? te(M) : M && F.destroy(M)
        }
        return F = new Z({
...
function Ee() {
    if (wr)
        return Jt;
    wr = 1;
    const {ObjectDefineProperties: e, ObjectGetOwnPropertyDescriptor: t, ObjectKeys: n, ObjectSetPrototypeOf: r} = z;
    Jt = l;
    const i = kt()
      , s = On();
    r(l.prototype, i.prototype),
    r(l, i);
    {
    ...
    function l(f) {
        ...
        i.call(this, f),
        s.call(this, f),
        f ? (this.allowHalfOpen = f.allowHalfOpen !== !1,
    ...
    e(l.prototype, {
        ...
        destroyed: {
            ...
            set(f) {
                this._readableState && this._writableState && (this._readableState.destroyed = f,
...
Re.prototype._write = function(e, t, n) {
    ...
    this._transform(e, t, (l, c) => {
        ...
        c != null && this.push(c),
        i.ended || s === r.length || r.length < r.highWaterMark ? n() : this[lt] = n
    }
    )
}
;
...
;
const at = je()
  , {ArrayIsArray: Wa, Promise: $a, SymbolAsyncIterator: xa, SymbolDispose: Ba} = z
  , Rt = Ce
  , {once: ja} = se
  , Ha = tt
  , mr = Ee()
  , {aggregateTwoErrors: Fa, codes: {ERR_INVALID_ARG_TYPE: En, ERR_INVALID_RETURN_VALUE: Qt, ERR_MISSING_ARGS: Va, ERR_STREAM_DESTROYED: Ka, ERR_STREAM_PREMATURE_CLOSE: Ga}, AbortError: qa} = ue
  , {validateFunction: Ya, validateAbortSignal: Xa} = ut
  , {isIterable: ke, isReadable: en, isReadableNodeStream: At, isNodeStream: Sr, isTransformStream: ze, isWebStream: za, isReadableStream: tn, isReadableFinished: Za} = Te
...
function Qa(e) {
    return Ya(e[e.length - 1], "streams[stream.length - 1]"),
    e.pop()
}
function sn(e) {
    if (ke(e))
...
function Gi(e, t, n) {
    ...
    function A(P, w) {
        var x;
        if (P && (!p || p.code === "ERR_STREAM_PREMATURE_CLOSE") && (p = P),
        !(!p && !w)) {
            for (; S.length; )
                S.shift()(p);
    ...
    for (let P = 0; P < e.length; P++) {
        ...
        if (Sr(w)) {
            let j = function(Z) {
                Z && Z.name !== "AbortError" && Z.code !== "ERR_STREAM_PREMATURE_CLOSE" && b(Z)
            };
            if (q) {
        ...
        if (P === 0)
            if (typeof w == "function") {
                ...
                ke(w) || At(w) || ze(w) ? y = w : y = mr.from(w);
            ...
            x) {
                if (!ke(y, !0))
                    throw new Qt("AsyncIterable",`transform[${P - 1}]`,y)
            } else {
                var O;
                nn || (nn = Ki);
                const j = new nn({
                ...
                if (typeof Z == "function")
                    ...
                    throw new Qt("AsyncIterable or Promise","destination",y);
                y = j;
            ...
            if (At(y)) {
                ...
                throw new En("val",["Readable", "Iterable", "AsyncIterable", "ReadableStream", "TransformStream"],y);
            y = w
        } else if (za(w)) {
            if (At(y))
                g++,
    ...
    return (i != null && i.aborted || s != null && s.aborted) && at.nextTick(c),
    y
}
function nl(e, t, n, {end: r}) {
    ...
    return Rt(e, {
        ...
        const l = e._readableState;
        s && s.code === "ERR_STREAM_PREMATURE_CLOSE" && l && l.ended && !l.errored && !l.errorEmitted ? e.once("end", n).once("error", n) : n(s)
    }
    ),
    Rt(t, {
        readable: !1,
...
const {pipeline: rl} = Nn
  , _t = Ee()
  , {destroyer: il} = tt
  , {isNodeStream: wt, isReadable: Er, isWritable: Rr, isWebStream: ln, isTransformStream: Me, isWritableStream: Tr, isReadableStream: Ir} = Te
  , {AbortError: ol, codes: {ERR_INVALID_ARG_VALUE: Dr, ERR_MISSING_ARGS: sl}} = ue
  , al = Ce;
var qi = function(...t) {
    if (t.length === 0)
        throw new sl("streams");
    if (t.length === 1)
        return _t.from(t[0]);
    const n = [...t];
    if (typeof t[0] == "function" && (t[0] = _t.from(t[0])),
    ...
    function h(b) {
        const A = l;
        l = null,
        A ? A(b) : b ? c.destroy(b) : !g && !S && c.destroy()
    }
    const p = t[0]
      , f = rl(t, h)
      , S = !!(Rr(p) || Tr(p) || Me(p))
    ...
    return c._destroy = function(b, A) {
        !b && l !== null && (b = new ol),
        s = null,
        r = null,
        i = null,
...
const ll = globalThis.AbortController || dt().AbortController
  , {codes: {ERR_INVALID_ARG_VALUE: dl, ERR_INVALID_ARG_TYPE: ft, ERR_MISSING_ARGS: ul, ERR_OUT_OF_RANGE: fl}, AbortError: ye} = ue
  ...
  , {deprecate: wl} = se
  , {ArrayPrototypePush: ml, Boolean: Sl, MathFloor: Cr, Number: Al, NumberIsNaN: El, Promise: Or, PromiseReject: Pr, PromiseResolve: Rl, PromisePrototypeThen: Mr, Symbol: Yi} = z
  , Tt = Yi("kEmpty")
  , Nr = Yi("kEof");
function Tl(e, t) {
    if (t != null && Ve(t, "options"),
    (t == null ? void 0 : t.signal) != null && Fe(t.signal, "options.signal"),
    _l(e) && !yl(e))
        throw new dl("stream",e,"must be writable");
    const n = bl(this, e);
    return t != null && t.signal && gl(t.signal, n),
    n
}
function Ut(e, t) {
    if (typeof e != "function")
    ...
    let r = n - 1;
    return (t == null ? void 0 : t.highWaterMark) != null && (r = Cr(t.highWaterMark)),
        ...
        async function E() {
            try {
                for await(let O of l) {
                    ...
                    p && (p(),
                    p = null),
                    !S && (c.length >= r || g >= n) && await new Or(P => {
                        f = P
                    }
                    )
                }
...
async function Xi(e, t=void 0) {
    for await(const n of Ln.call(this, e, t))
        return !0;
    return !1
}
...
async function Pl(e, t, n) {
    ...
    if (n != null && (r = n.signal) !== null && r !== void 0 && r.aborted) {
        const p = new ye(void 0,{
            cause: n.signal.reason
        });
        throw this.once("error", () => {}
        ),
        await pl(this.destroy(p)),
        p
    }
    const s = new ll
      , l = s.signal;
...
function zi(e) {
    ...
    El(e))
        return 0;
    if (e < 0)
        throw new fl("number",">= 0",e);
    return e
}
function Ll(e, t=void 0) {
    return t != null && Ve(t, "options"),
    (t == null ? void 0 : t.signal) != null && Fe(t.signal, "options.signal"),
    e = zi(e),
    (async function*() {
        var r;
...
Rn.streamReturningOperators = {
    asIndexedPairs: wl(Il, "readable.asIndexedPairs will be removed in a future version."),
    drop: Ll,
    filter: Ln,
    flatMap: Nl,
    map: Ut,
...
class $r extends ct.Duplex {
    constructor(t) {
        let {name: n, target: r, targetWindow: i=window, targetOrigin: s="*"} = t;
        if (super({
            objectMode: !0
        }),
        I(this, "_init", void 0),
    ...
    _handShake() {
        this._write(Ur, null, mt),
        this.cork()
    }
    _onData(t) {
        if (!this._init)
            t === Ur ? (this._haveSyn = !0,
            this._write(un, null, mt)) : t === un && (this._init = !0,
    ...
    onMessage(t) {
        const n = t.data;
        this._targetOrigin !== "*" && t.origin !== this._targetOrigin || t.source !== this._targetWindow || typeof n != "object" || n.target !== this._name || !n.data || this._onData(n.data)
    }
    _read() {}
    _write(t, n, r) {
        this._postMessage(t),
...
function Wl() {
    ...
    function r(h) {
        const p = e[h.id];
        if (!p)
            throw new Error(`StreamMiddleware - Unknown response id "${h.id}"`);
        delete e[h.id],
        Object.assign(p.res, h),
        setTimeout(p.end)
    }
    function i(h) {
...
class Ae extends ht {
    ...
    static async _runAllMiddleware(t, n, r) {
        ...
        let s = null
          , l = !1;
        for (const c of r)
            if ([s,l] = await Ae._runMiddleware(t, n, c, i),
            l)
                break;
    ...
    static _runMiddleware(t, n, r, i) {
        return new Promise(s => {
            const l = h => {
                const p = h || n.error;
                p && (n.error = ve.serializeError(p)),
                s([p, !0])
            }
              , c = h => {
                n.error ? l(n.error) : (h && (typeof h != "function" && l(new ot({
                    code: -32603,
    ...
    asMiddleware() {
        return async (t, n, r, i) => {
            try {
                ...
                return l ? (await Ae._runReturnHandlers(c),
                i(s)) : r(async h => {
                    try {
    ...
    async _handle(t, n) {
        ...
        i.error || (i.error = ve.serializeError(s))),
        n(s, i)
    }
    async _processRequest(t, n) {
        const [r,i,s] = await Ae._runAllMiddleware(t, n, this._middleware);
        if (Ae._checkForCompletion(t, n, i),
        await Ae._runReturnHandlers(s),
        r)
            throw r
    }
}
...
class Qi extends ct.Duplex {
    ...
    _write(t, n, r) {
        ...
        if (!i)
            return window.console.warn(`ObjectMultiplex - malformed chunk without name "${t}"`),
            r();
        const l = this._substreams[i];
        return l ? (l !== Fr && l.push(s),
        r()) : (window.console.warn(`ObjectMultiplex - orphaned data for stream "${i}"`),
        r())
    }
}
function jl(e, t) {
...
const Ue = {
  ...
  , Vl = ["ETH", "USDT", "USDC", "TUSD", "EOSDT", "USD", "DAI", "GUSD", "DKKT", "PAX", "ILS", "RUB", "BYN", "EUR", "GBP", "JPY", "KRW", "PLN", "MXN", "AUD", "BRL", "CAD", "CHF", "KPW", "LAK", "LBP", "LKR", "XOF", "CNHT", "DOGE", "UAH", "TRY", "HKD", "XJP", "SGD", "USC", "NZD", "NGN", "RUR", "COP", "GHS", "EGP", "IDR", "BHD", "CRC", "PEN", "AED", "DOP", "PKR", "HUF", "VND", "XAR", "LTC", "RON", "OMR", "MYR", "DKK", "UGX", "ZMW", "SAR", "SEK", "GEL", "RWF", "IRR", "TZS", "CNY", "VEF", "BDT", "HRK", "CLP", "THB", "XAF", "ARS", "UYU", "SZL", "KZT", "NOK", "KES", "PAB", "INR", "CZK", "MAD", "TWD", "PHP", "ZAR", "BOB", "CDF", "DASH", "VES", "ISK", "MWK", "BAM", "TTD", "XRP", "JOD", "RSD", "HNL", "BGN", "GTQ", "BWP", "XMR", "MMK", "QAR", "AOA", "KWD", "MUR", "WUSD", "WEUR", "WAVES", "WTRY", "LRD", "LSL", "LYD", "AWG", "MDL", "BTO", "EURS", "CHFT", "MKD", "MNT", "MOP", "MRO", "MVR", "VOLLAR", "CKUSD", "KHR", "VUV", "BITCNY", "QC", "BBD", "NAD", "NPR", "PGK", "PYG", "BIF", "BMD", "BND", "XLM", "BNB", "SCR", "BAT", "CRO", "HT", "KCS", "LEO", "LINK", "MKR", "NPXS", "OMG", "REP", "ZB", "ZIL", "ZRX", "BCH", "BZD", "CUP", "CVE", "DJF", "DZD", "ERN", "ETB", "FJD", "FKP", "BUSD", "ANCT", "ALL", "AMD", "ANG", "CNYX", "IQD", "UZS", "TND", "GGP", "XAU", "KGS", "GIP", "JMD", "ZEC", "USDP", "BSV", "EMC2", "SNT", "GTO", "POWR", "EUSD", "EURT", "BCY", "BTS", "ATM", "BLOCKPAY", "ARDR", "AMP", "B2X", "BITGOLD", "BITEUR", "ATB", "BITUSD", "AGRS", "DFXT", "HIKEN", "BIX", "KNC", "EOS", "COB", "COSS", "BMH", "NANO", "BDG", "BNT", "XVG", "LKK1Y", "LKK", "USDK", "EURN", "NZDT", "JSE", "GMD", "GNF", "GYD", "YER", "XPF", "HTG", "SLL", "SOS", "WST", "SVC", "SYP", "NEO", "KMF", "JUMP", "AYA", "BLAST", "WGR", "BCN", "BTG", "URALS", "INN", "USDQ", "CNH", "HUSD", "BKRW", "NZDX", "EURX", "CADX", "USDEX", "JPYX", "AUDX", "VNDC", "EON", "GBPX", "CHFX", "USDJ", "IDRT", "USDS", "USDN", "BIDR", "IDK", "BSD", "BTN", "KYD", "NIO", "SBD", "SDG", "SHP", "TOP", "XCD", "XCHF", "CNYT", "GYEN", "ZUSD", "GOLD", "TRX", "TRYB", "PLATC", "STRAX", "UST", "GLM", "VAI", "BRZ", "DDRST", "XAUT", "MIM"]
  , Kl = {
    [X.MOONPAY]: ["AUD", "BGN", "BRL", "CAD", "CHF", "CNY", "COP", "CZK", "DKK", "DOP", "EGP", "EUR", "GBP", "HKD", "HRK", "IDR", "ILS", "JPY", "JOD", "KES", "KRW", "KWD", "LKR", "MAD", "MXN", "MYR", "NGN", "NOK", "NZD", "OMR", "PEN", "PKR", "PLN", "RON", "RUB", "SEK", "SGD", "THB", "TRY", "TWD", "USD", "VND", "ZAR"],
    [X.WYRE]: ["USD", "EUR", "GBP", "AUD", "CAD", "NZD", "CNY", "ARS", "BRL", "CHF", "CLP", "COP", "CZK", "DKK", "HKD", "ILS", "INR", "ISK", "JPY", "KRW", "MXN", "MYR", "NOK", "PHP", "PLN", "SEK", "SGD", "THB", "VND", "ZAR"],
    [X.RAMPNETWORK]: ["USD", "EUR", "GBP", "BMD", "BAM", "BWP", "BRL", "BGN", "COP", "CRC", "CZK", "DKK", "DOP", "GEL", "GTQ", "HNL", "HUF", "ISK", "INR", "ILS", "KZT", "KES", "KWD", "LAK", "MKD", "MYR", "MXN", "MDL", "MZN", "NZD", "NGN", "PYG", "PEN", "PLN", "RON", "RSD", "SGD", "ZAR", "LKR", "SEK", "CHF", "TJS", "THB", "UYU"],
    [X.XANPOOL]: ["SGD", "HKD", "THB", "PHP", "INR", "IDR", "MYR", "AUD", "NZD", "KRW"],
    [X.MERCURYO]: ["EUR", "USD", "GBP", "TRY", "JPY", "BRL", "NGN", "VND", "MXN", "KRW", "PLN", "SEK", "CHF", "CAD", "CZK", "DKK", "BGN", "HKD", "AUD", "INR"],
    [X.TRANSAK]: ["ARS", "AUD", "BBD", "BGN", "BMD", "BRL", "CAD", "CHF", "CLP", "CRC", "CZK", "DKK", "DOP", "EUR", "FJD", "FKP", "GBP", "GIP", "HRK", "HUF", "IDR", "ILS", "ISK", "JMD", "JPY", "KES", "KRW", "MDL", "MXN", "MYR", "NOK", "NZD", "PEN", "PHP", "PLN", "PYG", "RON", "SEK", "SGD", "THB", "TRY", "TZS", "USD", "ZAR"],
    [X.BANXA]: ["AUD", "CAD", "CZK", "DKK", "EUR", "GBP", "HKD", "JPY", "NOK", "NZD", "NZD", "PLN", "RUB", "SEK", "SGD", "TRY", "USD"]
}
  , Gl = new Set(Vl);
function Ne(e) {
...
const {paymentProviders: Xr} = be
  , Jl = (e, t) => {
    ...
    if (e && !Xr[e])
        return n.provider = "Invalid Provider",
        {
            errors: n,
    ...
    if (i.fiatValue) {
        ...
        s < r.minOrderValue && (n.fiatValue = "Requested amount is lower than supported"),
        s > r.maxOrderValue && r.enforceMax && (n.fiatValue = "Requested amount is higher than supported")
    }
    if (i.selectedCurrency && !r.validCurrencies.includes(i.selectedCurrency) && (n.selectedCurrency = "Unsupported currency"),
    i.selectedCryptoCurrency) {
        const s = Object.values(r.validCryptoCurrenciesByChain).flat().map(c => c.value)
          , l = e === X.MOONPAY ? i.selectedCryptoCurrency.toLowerCase() : i.selectedCryptoCurrency;
        s && !s.includes(l) && (n.selectedCryptoCurrency = "Unsupported cryptoCurrency")
    }
    return {
        errors: n,
        isValid: Object.keys(n).length === 0
...
function Ql() {
    return (e, t, n) => {
        (typeof e.method != "string" || !e.method) && (t.error = ve.rpcErrors.invalidRequest({
        ...
        n(r => {
            const {error: i} = t;
            return i && B.error(`MetaMask - RPC Error: ${i.message}`, i),
            r()
        }
        )
    }
...
const We = () => Math.random().toString(36).slice(2)
  , eo = async (e, t) => {
    ...
    try {
        if ((e === "binance" || e === "production") && !t.version) {
            let l;
            be.prodTorusUrl ? l = {
                data: be.prodTorusUrl
            } : l = await ai(`${be.api}/latestversion?name=@toruslabs/torus-embed&version=${i}`, {}, {
                useAPIKey: !0
            }),
            s = l.data,
    ...
    switch (B.info("version used: ", s),
    e) {
    case "binance":
        n = `https://binance.tor.us/v${s}`,
        r = "info";
        break;
    case "testing":
    ...
    case "development":
        ...
        break;
    case "alpha":
        n = "https://alpha.tor.us",
        r = "debug";
        break;
    default:
        n = `https://app.tor.us/v${s}`,
        r = "error";
        break
    }
    return {
  ...
  , Zr = () => {
    ...
    const t = e.split("-");
    return e = Object.prototype.hasOwnProperty.call(be.translations, t[0]) ? t[0] : "en",
    e
}
  , ed = ["eth_subscription"]
  , to = () => {}
  , Jr = "directories=0,titlebar=0,toolbar=0,status=0,location=0,menubar=0,height=660,width=375"
  , td = "directories=0,titlebar=0,toolbar=0,status=0,location=0,menubar=0,height=740,width=1315"
  , Qr = "directories=0,titlebar=0,toolbar=0,status=0,location=0,menubar=0,height=700,width=450";
function nd() {
    ...
    return `titlebar=0,toolbar=0,status=0,location=0,menubar=0,height=${r / l},width=${n / l},top=${h},left=${c}`
}
function ei(e, t) {
    var n = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
...
const ti = function(e, t) {
    ...
    return (r, i) => r || i.error ? t(r || i.error) : !n || Array.isArray(i) ? e(i) : e(i.result)
};
class Wt extends ht {
    constructor(t) {
        let {maxEventListeners: n=100, shouldSendMetadata: r=!0, jsonRpcStreamName: i="provider"} = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        if (super(),
        ...
        this._publicConfigStore = new Xl({
            storageKey: "Metamask-Config"
        }),
        St(s.createStream("publicConfig"), Zl(this._publicConfigStore), zr.bind(this, "MetaMask PublicConfigStore")),
        ...
        const l = Wl();
        St(l.stream, s.createStream(i), l.stream, this._handleStreamDisconnect.bind(this, "MetaMask RpcProvider"));
        const c = new Ae;
        c.push($l()),
        c.push(Ql()),
        c.push(l.middleware),
        ...
        l.events.on("notification", h => {
            ...
            p === "wallet_accountsChanged" ? this._handleAccountsChanged(f) : p === "wallet_unlockStateChanged" ? this._handleUnlockStateChanged(f) : p === "wallet_chainChanged" ? this._handleChainChanged(f) : ed.includes(h.method) && (this.emit("data", h),
    ...
    get publicConfigStore() {
        return this._sentWarnings.publicConfigStore || (B.warn(oe.warnings.publicConfigStore),
    ...
    addListener(t, n) {
        return this._warnOfDeprecation(t),
        super.addListener(t, n)
    }
    on(t, n) {
        return this._warnOfDeprecation(t),
        super.on(t, n)
    ...
    prependListener(t, n) {
        return this._warnOfDeprecation(t),
        super.prependListener(t, n)
    }
    prependOnceListener(t, n) {
        return this._warnOfDeprecation(t),
        super.prependOnceListener(t, n)
    }
    async _initializeState() {
        try {
            const {accounts: t, chainId: n, isUnlocked: r, networkVersion: i} = await this.request({
            ...
            B.error("MetaMask: Failed to get initial state. Please report this bug.", t)
        } finally {
    ...
    _rpcRequest(t, n) {
        ...
        const s = t;
        if (!Array.isArray(s)) {
            if (s.jsonrpc || (s.jsonrpc = "2.0"),
            s.method === "eth_accounts" || s.method === "eth_requestAccounts")
                i = (l, c) => {
                    this._handleAccountsChanged(c.result || [], s.method === "eth_accounts", r),
                    n(l, c)
                }
                ;
    ...
    send(t, n) {
        return this._sentWarnings.send || (B.warn(oe.warnings.sendDeprecation),
        this._sentWarnings.send = !0),
        typeof t == "string" && (!n || Array.isArray(n)) ? new Promise( (r, i) => {
            try {
                this._rpcRequest({
                    method: t,
                    params: n
        ...
        ) : t && typeof t == "object" && typeof n == "function" ? this._rpcRequest(t, n) : this._sendSync(t)
    }
    _sendSync(t) {
        let n;
        switch (t.method) {
    ...
    _handleDisconnect(t, n) {
        if (this._state.isConnected || !this._state.isPermanentlyDisconnected && !t) {
            ...
            let r;
            t ? (r = new ve.EthereumProviderError(1013,n || oe.errors.disconnected()),
            B.debug(r)) : (r = new ve.EthereumProviderError(1011,n || oe.errors.permanentlyDisconnected()),
            B.error(r),
            this.chainId = null,
    ...
    _handleStreamDisconnect(t, n) {
        zr(t, n, this),
        this._handleDisconnect(!1, n ? n.message : void 0)
    }
    _handleAccountsChanged(t) {
        let n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1
          , r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1
          , i = t;
        Array.isArray(i) || (B.error("MetaMask: Received non-array accounts parameter. Please report this bug.", i),
        i = []);
        for (const s of t)
            if (typeof s != "string") {
                B.error("MetaMask: Received non-string account. Please report this bug.", t),
                i = [];
                break
            }
        So(this._state.accounts, i) || (n && Array.isArray(this._state.accounts) && this._state.accounts.length > 0 && !r && B.error('MetaMask: "eth_accounts" unexpectedly updated accounts. Please report this bug.', i),
        this._state.accounts = i,
        this.emit("accountsChanged", i)),
        this.selectedAddress !== i[0] && (this.selectedAddress = i[0] || null)
    }
    _handleChainChanged() {
        let {chainId: t, networkVersion: n} = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        if (!t || !n) {
            B.error("MetaMask: Received invalid network parameters. Please report this bug.", {
                chainId: t,
                networkVersion: n
            });
            return
        }
        n === "loading" ? this._handleDisconnect(!0) : (this._handleConnect(t),
        t !== this.chainId && (this.chainId = t,
        this._state.initialized && this.emit("chainChanged", this.chainId)))
    }
    _handleUnlockStateChanged() {
        let {accounts: t, isUnlocked: n} = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        if (typeof n != "boolean") {
            B.error("MetaMask: Received invalid isUnlocked parameter. Please report this bug.", {
                isUnlocked: n
            });
            return
        }
        n !== this._state.isUnlocked && (this._state.isUnlocked = n,
        this._handleAccountsChanged(t || []))
    }
    _warnOfDeprecation(t) {
        this._sentWarnings.events[t] === !1 && (B.warn(oe.warnings.events[t]),
...
class ni extends Qe.EventEmitter {
    ...
    _setupTimer() {
        this.windowTimer = Number(setInterval( () => {
            this.window && this.window.closed && (clearInterval(this.windowTimer),
    ...
    open() {
        ...
        (t = this.window) !== null && t !== void 0 && t.focus && this.window.focus()
    }
    close() {
...
async function id(e) {
    ...
    return n && await ri(n.href) || (n = Array.from(t.querySelectorAll('head > link[rel="icon"]')).find(r => !!r.href),
    n && await ri(n.href)) ? n.href : null
}
const od = async () => ({
    name: rd(window),
    icon: await id(window)
});
async function sd(e) {
    try {
        const t = await od();
...
const dd = ["eth_sendTransaction", "eth_signTypedData", "eth_signTypedData_v3", "eth_signTypedData_v4", "personal_sign", "eth_getEncryptionPublicKey", "eth_decrypt", "wallet_addEthereumChain", "wallet_switchEthereumChain"];
(async function() {
    try {
        if (typeof document > "u")
            return;
        const t = document.createElement("link")
          , {torusUrl: n} = await eo("production", {
            version: ""
        });
        t.href = `${n}/popup`,
        ...
        t.type = "text/html",
        t.rel = "prefetch",
        t.relList && t.relList.supports && t.relList.supports("prefetch") && document.head.appendChild(t)
    } catch (t) {
        B.warn(t)
    }
}
...
class bd {
    constructor() {
        let {buttonPosition: t=Xe.BOTTOM_LEFT, buttonSize: n=56, modalZIndex: r=99999, apiKey: i="torus-default"} = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    ...
    async init() {
        let {buildEnv: t=Fl.PRODUCTION, enableLogging: n=!1, network: r={
            host: "mainnet",
            chainId: null,
            networkName: "",
            blockExplorer: "",
            ticker: "",
            tickerName: ""
        }, loginConfig: i={}, showTorusButton: s=!0, integrity: l={
            version: ""
        }, whiteLabel: c, useWalletConnect: h=!1, mfaLevel: p="default"} = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        ...
        this.isCustomLogin = !!(i && Object.keys(i).length > 0) || !!(c && Object.keys(c).length > 0),
        B.setDefaultLevel(S),
        n ? B.enableAll() : B.disableAll(),
        this.torusWidgetVisibility = s;
        const g = new URL(f);
        g.pathname.endsWith("/") ? g.pathname += "popup" : g.pathname += "/popup",
      ...
      ></iframe>`),
        ...
        this.styleLink = b;
        const {defaultLanguage: A=Zr(), customTranslations: y={}} = this.whiteLabel || {}
          , O = oi(be.translations, y)[A] || be.translations[Zr()];
        return this.embedTranslations = O.embed,
        new Promise( (P, w) => {
            this.torusIframe.onload = async () => {
                ...
                x.on("data", L => {
                    ...
                    q === "init_complete" && ae.success ? (this.isInitialized = !0,
                    this._displayIframe(this.isIframeFullScreen),
                    P(void 0)) : j && w(new Error(j))
                }
                ),
                x.write({
                    name: "init_stream",
    ...
    login() {
        let {verifier: t="", login_hint: n=""} = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
        if (!this.isInitialized)
            throw new Error("Call init() first");
        return this.requestedVerifier = t,
        this.loginHint = n,
    ...
    logout() {
        return new Promise( (t, n) => {
            ...
            pe(i, "data", l => {
                l.loggedIn ? n(new Error("Some Error Occured")) : (this.isLoggedIn = !1,
                this.currentVerifier = "",
                this.requestedVerifier = "",
                t())
            }
    ...
    async cleanUp() {
        this.isLoggedIn && await this.logout(),
        this.clearInit()
    }
    clearInit() {
        function t(n) {
        ...
        t(this.styleLink) && window.document.body.contains(this.styleLink) && (this.styleLink.remove(),
        this.styleLink = void 0),
        t(this.torusIframe) && window.document.body.contains(this.torusIframe) && (this.torusIframe.remove(),
        this.torusIframe = void 0),
        t(this.torusAlertContainer) && window.document.body.contains(this.torusAlertContainer) && (this.torusAlert = void 0,
    ...
    setProvider(t) {
        ...
        return new Promise( (l, c) => {
            ...
            pe(h, "data", S => {
                ...
                B.info(S),
                g ? c(g) : b ? l() : c(new Error("some error occurred"))
            }
            );
            const f = We();
            this._handleWindow(f, {
                target: "_blank",
                features: Jr
            }),
            h.write({
    ...
    async getPublicAddress(t) {
        ...
        return c.searchParams.append("verifier", l),
    ...
    getUserInfo(t) {
        return new Promise( (n, r) => {
            if (this.isLoggedIn) {
                ...
                pe(i, "data", l => {
                    const {name: c, data: {approved: h, payload: p, rejected: f, newRequest: S}} = l;
                    if (c === "user_info_access_response") {
                        if (h)
                            ...
                            pe(g, "data", y => {
                                y.name === "user_info_response" && (y.data.approved ? n(y.data.payload) : r(new Error("User rejected the request")))
                            }
                            );
                            const A = We();
                ...
                r(new Error("User has not logged in yet"))
        }
        )
    }
    initiateTopup(t, n) {
        return new Promise( (r, i) => {
            if (this.isInitialized) {
                ...
                pe(c, "data", f => {
                    f.name === "topup_response" && (f.data.success ? r(f.data.success) : i(new Error(f.data.error)))
                }
                );
                const p = We();
                ...
                i(new Error("Torus is not initialized yet"))
        }
        )
    }
        ...
        return new Promise( (i, s) => {
            if (this.isInitialized) {
                if (bo.from(n, "hex").length !== 32) {
                    s(new Error("Invalid private key, Please provide a 32 byte valid secp25k1 private key"));
                    return
                }
                const l = this.communicationMux.getStream("login_with_private_key");
                pe(l, "data", h => {
                    h.name === "login_with_private_key_response" && (h.data.success ? i(h.data.success) : s(new Error(h.data.error)))
                }
                ),
                l.write({
                ...
                s(new Error("Torus is not initialized yet"))
        }
        )
    }
    async showWalletConnectScanner() {
        ...
        return new Promise( (t, n) => {
            if (this.isLoggedIn) {
                ...
                pe(r, "data", s => {
                    s.name === "wallet_connect_stream_res" && (s.data.success ? t(s.data.success) : n(new Error(s.data.error)),
                    this._displayIframe())
                }
                ),
                r.write({
    ...
    _handleWindow(t) {
        let {url: n, target: r, features: i} = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        if (t) {
            const s = this.communicationMux.getStream("window")
              , l = new URL(n || `${this.torusUrl}/redirect?preopenInstanceId=${t}`);
            l.hash ? l.hash += `&isCustomLogin=${this.isCustomLogin}` : l.hash = `#isCustomLogin=${this.isCustomLogin}`;
            const c = new ni({
                url: l,
                target: r,
                features: i
    ...
    _getLogoUrl() {
        ...
        if ((t = this.whiteLabel) !== null && t !== void 0 && (n = t.theme) !== null && n !== void 0 && n.isDark) {
            var i;
            r = ((i = this.whiteLabel) === null || i === void 0 ? void 0 : i.logoLight) || r
        } else {
            var s;
            r = ((s = this.whiteLabel) === null || s === void 0 ? void 0 : s.logoDark) || r
        }
        return r
    }
    ...
    _displayIframe() {
        ...
        if (t)
            ...
            switch (n.display = this.torusWidgetVisibility ? "block" : "none",
            n.height = `${r}px`,
            n.width = `${r}px`,
            this.buttonPosition) {
            case Xe.TOP_LEFT:
        ...
        Object.assign(this.torusIframe.style, n),
        this.isIframeFullScreen = t
    }
    _setupWeb3() {
        ...
        const t = new $r({
          ...
          , i = f => {
            const S = r[f];
            r[f] = function(b) {
                if (b && b === "eth_requestAccounts")
                    return r.enable();
                for (var A = arguments.length, y = new Array(A > 1 ? A - 1 : 0), E = 1; E < A; E++)
                    y[E - 1] = arguments[E];
        ...
        l.getStream("window").on("data", f => {
            f.name === "create_window" && this._createPopupBlockAlert(f.data.preopenInstanceId, f.data.url)
        }
        ),
        ...
        l.getStream("status").on("data", f => {
            f.loggedIn ? (this.isLoggedIn = f.loggedIn,
            this.currentVerifier = f.verifier) : this._displayIframe(),
            this.isLoginCallback && (this.isLoginCallback(),
    ...
    _createPopupBlockAlert(t, n) {
        const r = this._getLogoUrl()
          , i = st(`<div id="torusAlert" class="torus-alert--v2"><div id="torusAlert__logo"><img src="${r}" /></div><div><h1 id="torusAlert__title">${this.embedTranslations.actionRequired}</h1><p id="torusAlert__desc">${this.embedTranslations.pendingAction}</p></div></div>`)
          , s = st(`<div><a id="torusAlert__btn">${this.embedTranslations.continue}</a></div>`)
        ...
        s.addEventListener("click", () => {
            ...
            i.remove(),
            this.torusAlertContainer.children.length === 0 && (this.torusAlertContainer.style.display = "none")
        }
        )
    }
}
export {Xe as BUTTON_POSITION, X as PAYMENT_PROVIDER, $ as SUPPORTED_PAYMENT_NETWORK, Fl as TORUS_BUILD_ENV, Wt as TorusInpageProvider, Vr as WALLET_OPENLOGIN_VERIFIER_MAP, Ue as WALLET_VERIFIERS, bd as default};
